...
#define SIPP_ISP_PIPE_BUFFER_WIDTH             1920
#define SIPP_ISP_PIPE_BUFFER_HEIGHT            1080
#define SIPP_ISP_PIPE_BUFFER_INPUT_NUM_PLANES  1
#define SIPP_ISP_PIPE_BUFFER_OUTPUT_NUM_PLANES 3
...
#define ISPC_RAW_GAIN_R     1148    // 16 bits
#define ISPC_RAW_GAIN_GR    988 // 16 bits
#define ISPC_RAW_GAIN_GB    988 // 16 bits
#define ISPC_RAW_GAIN_B     2273    // 16 bits
...
#define CHROMA_DNS_THRESH0     (ISPC_CHROMA_DNS_TH_R | (ISPC_CHROMA_DNS_TH_R << 16) | (ISPC_CHROMA_DNS_TH_G << 8) | (ISPC_CHROMA_DNS_TH_G << 24))
#define CHROMA_DNS_THRESH1     (ISPC_CHROMA_DNS_TH_B | (ISPC_CHROMA_DNS_TH_B << 16))
