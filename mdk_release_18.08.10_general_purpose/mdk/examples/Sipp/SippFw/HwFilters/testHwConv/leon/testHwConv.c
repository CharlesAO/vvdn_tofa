...
UInt8      DDR_DATA TestHwConv_dmaIn0_buffer [SIPP_HW_CONV_BUFFER_WIDTH* SIPP_HW_CONV_BUFFER_HEIGHT* SIPP_HW_CONV_BUFFER_NUM_PLANES]ALIGNED(8);
UInt8      DDR_DATA TestHwConv_dmaOut0_buffer[SIPP_HW_CONV_BUFFER_WIDTH* SIPP_HW_CONV_BUFFER_HEIGHT* SIPP_HW_CONV_BUFFER_NUM_PLANES]ALIGNED(8);
	
///
void readTestHwConvInput(TestHwConv *pPl)
{
   sippRdFileU8((UInt8*)TestHwConv_dmaIn0_buffer,SIPP_HW_CONV_BUFFER_WIDTH * SIPP_HW_CONV_BUFFER_HEIGHT * SIPP_HW_CONV_BUFFER_NUM_PLANES* sizeof(UInt8),"../../../../../../../resources/testIMG_1296x972_P400.rgb");
...
{
   sippWrFileU8((UInt8*)TestHwConv_dmaOut0_buffer,SIPP_HW_CONV_BUFFER_WIDTH * SIPP_HW_CONV_BUFFER_HEIGHT * SIPP_HW_CONV_BUFFER_NUM_PLANES* sizeof(UInt8),"unitTestOut.raw");
   //Ensure parameter is used to avoid compiler warning
   (void)(pPl);
...
void configTestHwConv(TestHwConv *pPl)
{
  ...
  // fields as defined in the filter property window
   ...
   dmaIn0Cfg->ddrAddr   = (UInt32)&TestHwConv_dmaIn0_buffer;
   dmaOut0Cfg->ddrAddr  = (UInt32)&TestHwConv_dmaOut0_buffer;
