...
{
        { //GASTEMP
            .auxClockEnableMask     = 0xffffffff & (~AUX_CLK_MASK_DDR_CORE_CTRL) & (~AUX_CLK_MASK_DDR_REF),
...
static tySocClockConfig clocksConfig =
{
    ...
    .upaClockEnableMask      = APP_UPA_CLOCKS,      /* UPA clocks enabled */
    .pAuxClkCfg              = auxClk,
};
...
int initClocksAndMemory(void)
{
    ...
    DrvCprSysDeviceAction(SIPP_DOMAIN, ASSERT_RESET, DEV_SIPP_MIPI | DEV_SIPP_MIPI_RX1);
