...
Overview
====================
This is a simple SIPP pipeline to test the RAW hardware accelerator
...
Also a selection of files are generated, containing the statistics produced by the RAW accelerator
  BAYER_Ae.stat
  BAYER_B-hist.stat
  BAYER_G-hist.stat
  BAYER_lumaHist.stat
