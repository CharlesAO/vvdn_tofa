...
Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer,
to test the average block linked with a negative block from one of the input images.
...
2. Expected output file: An image consisiting of two combined input images, one of them being a negative, is dumped to a file,
