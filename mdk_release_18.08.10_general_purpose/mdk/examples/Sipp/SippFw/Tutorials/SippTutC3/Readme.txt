...
Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer, to test the linked erode and dilate blocks.
...
2. Expected output file: A eroded and then dilated image is dumped to a file,
