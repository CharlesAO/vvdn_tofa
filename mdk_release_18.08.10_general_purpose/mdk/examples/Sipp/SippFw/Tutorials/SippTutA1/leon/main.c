...
#include <DrvDdr.h>
#include <swcCrc.h>
#define EXP_CRC_VALUE 0xe1d868f9
#endif
...
int main(int argc, char *argv[])
{
   ...
   configSippTutA1Model(&myPl);

   // change pipeline config/parameters manually if needed
   //myPl->

   readSippTutA1ModelInput(&myPl);
   ...
   writeSippTutA1ModelOutput(&myPl);

#if defined(SIPP_VCS)
   crc = swcCalcCrc32(SippTutA1Model_dmaOut0_buffer, 512 * 512, 0);
