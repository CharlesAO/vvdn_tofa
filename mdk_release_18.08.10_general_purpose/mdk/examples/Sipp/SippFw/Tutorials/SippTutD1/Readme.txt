...
Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer, to perfom a 1/2 downscale on the input image.
...
2. Expected output file: A downscaled image is dumped to a file,
View with movImageCompare, Irfanview or pyuv; The resolution is 256x256, YUV, P400
