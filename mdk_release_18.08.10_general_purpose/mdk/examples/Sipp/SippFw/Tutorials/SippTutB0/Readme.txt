...
Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer, to test the average block.
...
2. Expected output file: An image consisiting of two combined input images is dumped to a file,
