...
UInt8      DDR_DATA SippTutC2Model_dmaIn0_buffer[512      * 512     * 1  ]ALIGNED(8);
UInt8      DDR_DATA SippTutC2Model_dmaOut1_buffer[512      * 512     * 1  ]ALIGNED(8);
	
///
void readSippTutC2ModelInput(SippTutC2Model *pPl)
{
   sippRdFileU8((UInt8*)SippTutC2Model_dmaIn0_buffer,512        * 512     * 1 * sizeof(UInt8),"../../../../../../../resources/lena_512x512_luma.raw");
...
{
   sippWrFileU8((UInt8*)SippTutC2Model_dmaOut1_buffer,512        * 512     * 1 * sizeof(UInt8),"output.raw");
   //Ensure parameter is used to avoid compiler warning
   (void)(pPl);
...
void buildSippTutC2Model(SippTutC2Model *pPl)
{
   ...
   // link filters
   sippLinkFilter(pPl->dilate5x53,    pPl->dmaIn0,        5,5                 );
   sippLinkFilter(pPl->erode5x52,     pPl->dilate5x53,    5,5                 );
...
void configSippTutC2Model(SippTutC2Model *pPl)
{
  ...
  // fields as defined in the filter property window
   ...
   dmaIn0Cfg->ddrAddr   = (UInt32)&SippTutC2Model_dmaIn0_buffer;
   dmaOut1Cfg->ddrAddr  = (UInt32)&SippTutC2Model_dmaOut1_buffer;
