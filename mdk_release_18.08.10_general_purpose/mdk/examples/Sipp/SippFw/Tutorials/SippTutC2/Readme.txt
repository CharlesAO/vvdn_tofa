...
Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer, to test the linked dilate and erode blocks.
...
2. Expected output file: A dilated and then eroded image is dumped to a file,
