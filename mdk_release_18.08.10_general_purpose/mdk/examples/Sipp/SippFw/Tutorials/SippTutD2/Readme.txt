...
Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer, to perfom an RGB to Luma conversion.
...
2. Expected output file: The converted image is dumped to a file,
