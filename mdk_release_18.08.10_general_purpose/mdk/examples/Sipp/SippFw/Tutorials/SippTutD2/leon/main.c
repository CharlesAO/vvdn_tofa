...
#include <DrvDdr.h>
#include "swcCrc.h"
#define EXP_CRC_VALUE 0x09B34D9B
#endif
...
int main(int argc, char *argv[])
{
   ...
   configSippTutD2Model(&myPl);

   // change pipeline config/parameters manually if needed
   //myPl->

   readSippTutD2ModelInput(&myPl);
   ...
   writeSippTutD2ModelOutput(&myPl);

#if defined(SIPP_VCS)
   crc = swcCalcCrc32(SippTutD2Model_dmaOut1_buffer, 512 * 512, 0);
