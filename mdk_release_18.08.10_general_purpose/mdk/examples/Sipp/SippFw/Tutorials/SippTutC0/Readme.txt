...
Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer, to test the dilate block.
...
2. Expected output file: A dilated image is dumped to a file,
