...
Supported Platform
===================
Myriad2 - This example works on MV0182 and MV212 board.

Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer, to test two linked 5x5 convolution blocks.
Each one of them is connected to a separate output.
...
2. Expected output file: One blurred image and one image with a stronger blur are dumped to a file,
