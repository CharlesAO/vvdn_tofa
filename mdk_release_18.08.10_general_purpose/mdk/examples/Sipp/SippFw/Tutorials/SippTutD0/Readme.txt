...
Overview
==========
This is a simple SIPP pipeline example, built with the SIPP Designer, to perfom a pseudo-unsharp effect.
...
2. Expected output file: A sharpened image is dumped to a file,
