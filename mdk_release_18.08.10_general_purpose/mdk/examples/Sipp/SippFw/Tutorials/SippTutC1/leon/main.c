...
#include <DrvDdr.h>
#include "swcCrc.h"
#define EXP_CRC_VALUE 0x0ABC6CE0
#endif
...
int main(int argc, char *argv[])
{
   ...
   configSippTutC1Model(&myPl);

   // change pipeline config/parameters manually if needed
   //myPl->

   readSippTutC1ModelInput(&myPl);
   ...
   writeSippTutC1ModelOutput(&myPl);

#if defined(SIPP_VCS)
   crc = swcCalcCrc32(SippTutC1Model_dmaOut1_buffer, 512 * 512, 0);
