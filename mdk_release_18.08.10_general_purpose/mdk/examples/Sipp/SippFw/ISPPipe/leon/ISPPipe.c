...
UInt8      DDR_DATA ISPPipe_dmaOut0_buffer   [SIPP_ISP_PIPE_BUFFER_WIDTH* SIPP_ISP_PIPE_BUFFER_HEIGHT* 3  ]ALIGNED(8);
	
///
void readISPPipeInput(ISPPipe *pPl)
{
   sippRdFileU8((UInt8*)ISPPipe_dmaIn0_buffer,SIPP_ISP_PIPE_BUFFER_WIDTH * SIPP_ISP_PIPE_BUFFER_HEIGHT * SIPP_ISP_PIPE_BUFFER_INPUT_NUM_PLANES* sizeof(UInt16),"../../../../../../resources/lowLight_512x128.raw");
...
{
   sippWrFileU8((UInt8*)ISPPipe_dmaOut0_buffer,SIPP_ISP_PIPE_BUFFER_WIDTH * SIPP_ISP_PIPE_BUFFER_HEIGHT * 3 * sizeof(UInt8),"out_p444.yuv");
   //Ensure parameter is used to avoid compiler warning
   (void)(pPl);
...
void buildISPPipe(ISPPipe *pPl)
{
   ...
   pPl->debayerMa2x5x0  =  sippCreateFilter(pPl->pl, 0x0,        SIPP_ISP_PIPE_BUFFER_WIDTH, SIPP_ISP_PIPE_BUFFER_HEIGHT, N_PL(3),  SZ(UInt16), SIPP_AUTO,          (FnSvuRun)SIPP_DBYR_ID,       0);
   ...
   pPl->chromaGenMa2x5x0 =  sippCreateFilter(pPl->pl, SIPP_RESIZE, ISPC_CHROMA_PIPE_WIDTH, ISPC_CHROMA_PIPE_HEIGHT, N_PL(3),  SZ(UInt8), SIPP_AUTO,          (FnSvuRun)SIPP_CGEN_ID,       0);
   pPl->medianMa2x5x0   =  sippCreateFilter(pPl->pl, 0x0,        ISPC_CHROMA_PIPE_WIDTH, ISPC_CHROMA_PIPE_HEIGHT, N_PL(3),  SZ(UInt8), SIPP_AUTO,          (FnSvuRun)SIPP_MED_ID,        0);
   pPl->chromadnsMa2x5x0 =  sippCreateFilter(pPl->pl, 0x0,        ISPC_CHROMA_PIPE_WIDTH, ISPC_CHROMA_PIPE_HEIGHT, N_PL(3),  SZ(UInt8), SIPP_AUTO,          (FnSvuRun)SIPP_CHROMA_ID,     0);
   pPl->colorcombMa2x5x0 =  sippCreateFilter(pPl->pl, 0x0,        SIPP_ISP_PIPE_BUFFER_WIDTH, SIPP_ISP_PIPE_BUFFER_HEIGHT, N_PL(3),  SZ(UInt16), SIPP_AUTO,          (FnSvuRun)SIPP_CC_ID,         0);
   pPl->lutMa2x5x0      =  sippCreateFilter(pPl->pl, 0x0,        SIPP_ISP_PIPE_BUFFER_WIDTH, SIPP_ISP_PIPE_BUFFER_HEIGHT, N_PL(3),  SZ(UInt8), SIPP_AUTO,          (FnSvuRun)SIPP_LUT_ID,        0);
