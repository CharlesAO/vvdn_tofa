...
#define CONFIGURE_MAXIMUM_SEMAPHORES            4 // 2 minim needed by IPC
...
BSP_SET_CLOCK(12000, 266000, 1, 1, DEFAULT_RTEMS_CSS_LOS_CLOCKS, DEFAULT_RTEMS_MSS_LRT_CLOCKS, 0, 0, 0);
