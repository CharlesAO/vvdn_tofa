...
Overview
==========
This example requires multiple Myriad boards of the same type in order to function.
...
This includes code for the pc application that does the following:
    ...
    5. Get the part of the buffer to send and sends it
    6. Reads the message from the USB
    7. Compare the recd message to the data in the correct part of the buffer
    8. Store the pass/fail value
    9. Release the message received
    10. Resets PC application and the remote (myriad)
...
This includes leon code for LeonOS. The steps in this application are:
    ...
    3. Opens a named stream
    4. Receives and returns NUM_MESSAGES messages
