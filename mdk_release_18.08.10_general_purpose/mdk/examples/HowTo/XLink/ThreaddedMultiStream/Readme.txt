XLink threadded multi-stream application
...
Overview
==========
Sends random messages from PC to the Myriad over multiple streams. The Myriad receives messages from PC and sends them back.
...
This includes code for the pc application that does the following:
    ...
    3. Opens a few named streams
    4. Starts a thread for receiving back messages for each stream. This does the following:
    ...
    5. Starts NUM_THREADS_PER_STREAM threads for each stream for sending messages. This does the following NUM_MESSAGES times:
...
This includes leon code for LeonOS. The steps in this application are:
    ...
    3. Opens a few named streams
    4. A thread that receives and returns NUM_MESSAGES messages is started for each stream:
...
Reading back data... Reading back data... Sending some data...
Stream 0: SENDING0
Data sent
Data read
Stream 0: READING msg 0
Reading back data... Sending some data...
Stream 0: SENDING1
Data sent
Data read
Stream 0: READING msg 1
Reading back data... Sending some data...
Stream 0: SENDING3
Data sent
Data read
Stream 0: READING msg 3
Reading back data... Sending some data...
Stream 1: SENDING1
Data sent
Data read
...
Stream 0: READING msg 97
Reading back data... Sending some data...
Stream 1: SENDING92
Data sent
Data read
Stream 1: READING msg 92
Reading back data... Sending some data...
Stream 0: SENDING99
Data sent
Data read
Stream 0: READING msg 99
Sending some data...
Stream 1: SENDING94
Data sent
Data read
Stream 1: READING msg 94
Reading back data... Sending some data...
Stream 1: SENDING96
Data sent
Data read
Stream 1: READING msg 96
Reading back data... Sending some data...
Stream 1: SENDING98
Data sent
Data read
Stream 1: READING msg 98
TEST PASSED! :)
