...
BSP_SET_CLOCK(12000, 480000, 1, 1, DEFAULT_RTEMS_CSS_LOS_CLOCKS, DEFAULT_RTEMS_MSS_LRT_CLOCKS | EXTRACLOCKS | DEV_CSS_LOS_DSU|DEV_CSS_LOS_TIM|DEV_CSS_MSS_MAS, APP_UPA_CLOCKS, 0, 0);
