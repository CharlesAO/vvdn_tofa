   ...
   tyAuxClkDividerCfg auxClkAllOn[] =
    {
        ...
        {0,(tyCprClockSrc)0,0,0}, // Null Terminated List
    };
    ...
    sc = OsDrvShaveL2CacheInit((osDrvShaveL2CacheModes_t)SHAVE_L2CACHE_NORMAL_MODE);
    if(sc)
       return sc;
    ...
    for (int i = 0; i < SHAVES_USED; i++)
    {
        ...
        OsDrvShaveL2CSetNonWindowedPartition((shaveId_t)i, 0, NON_WINDOWED_INSTRUCTIONS_PARTITION);
    }
