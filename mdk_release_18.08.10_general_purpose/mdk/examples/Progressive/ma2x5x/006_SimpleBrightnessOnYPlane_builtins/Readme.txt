SimpleBrightnessOnYPlane_builtins
...
Overview
==========
This is a simple example that shows the usage of some of the built-in functions.
Starts RTEMS, Loads input image and applies Brightness effect on it.

Software description
=======================

This application uses the Leon code.
Basically, these are the few steps made during the application:
    1. Configure the system.
    2. An image[DunLoghaire_80x60.yuv] is imported and it is used as an object. The variable that manages frames is directed to that image. It is called inBuffer.
    3. Another variable is allocated. It is called outBuffer.
    4. Using the shave code, the user copies the input frame into the desired output. We have to notice that the image is a yuv.
    ...
    5. On this step, the setup is complete. The desired message can now be printed.
