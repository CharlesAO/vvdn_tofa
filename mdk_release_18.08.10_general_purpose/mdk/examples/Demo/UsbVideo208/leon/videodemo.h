...
#define PROBE_DEFAULT_dwMaxVideoFrameSize         (CAM_WINDOW_WIDTH * CAM_WINDOW_HEIGHT * 2 + PAYLOAD_HEADER_SIZE)
#define PROBE_DEFAULT_dwMaxPayloadTransferSize    (CAM_WINDOW_WIDTH * CAM_WINDOW_HEIGHT * 2 + PAYLOAD_HEADER_SIZE)
