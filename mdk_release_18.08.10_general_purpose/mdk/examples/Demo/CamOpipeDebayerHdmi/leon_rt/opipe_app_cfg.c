...
void appSetParamsMFPipe(Opipe *p, int sensor)
{
  //Global stuff
  ...
  //Luma-plane resize
     ...
     if(sensor==1)
     {
     updnCfg0.vN      = N; updnCfg0.vD = D_IMX214;
     updnCfg0.hN      = N; updnCfg0.hD = D_IMX214;
     }
     else
     {
     updnCfg0.vN      = N; updnCfg0.vD = D_IMX378;
     updnCfg0.hN      = N; updnCfg0.hD = D_IMX378;
     }
     updnCfg0.kerSz   = 7;
  ...
  //U/V resize as for 420 (same factors as Y, but double Denominator)
     ...
     if(sensor==1)
     {
     updnCfg12.vN      = N; updnCfg12.vD = (D_IMX214<<1);
     updnCfg12.hN      = N; updnCfg12.hD = (D_IMX214<<1);
     }
     else
     {
     updnCfg12.vN      = N; updnCfg12.vD = (D_IMX378<<1);
     updnCfg12.hN      = N; updnCfg12.hD = (D_IMX378<<1);
