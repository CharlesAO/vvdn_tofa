...
#define CONFIGURE_TICKS_PER_TIMESLICE           50      /* 10 milliseconds */
...
BSP_SET_CLOCK(SYS_CLK_KHZ, 360000, 1, 1,DEFAULT_CORE_CSS_DSS_CLOCKS, APP_MSS_CLOCKS, APP_UPA_CLOCKS, APP_SIPP_CLOCKS, 0x0);
