...
#define PU_HUE_AUTO_CONTROL_DEF 		0x01
...
#define PROBE_DEFAULT_dwFrameInterval   0x0007A120
...
#define PROBE_DEFAULT_dwMaxVideoFrameSize	0x9600C
#define PROBE_DEFAULT_dwMaxPayloadTransferSize	0x9600C
