...
///
/// @brief     Wrapping function for video protocol APIs
///
        ...
        )
{
    ...
    TTUSB_OBJPRINTF((
                ...
                UsbPumpVideo_GetStatusName(VideoStatusCode)
                ));
    if (VideoStatusCode == UPROTO_VIDEO_STATUS_ATTACH)
    {
        deviceAttached = 1;
    }
    else if (VideoStatusCode == UPROTO_VIDEO_STATUS_DETACH)
    {
        ...
        )
{
    ...
    pRequest = &pVideoDemoCtx->ControlRequest;
        ...
        )
{
    ...
    pRequest = &pVideoDemoCtx->StreamRequest;
    pRequest->Hdr.bAcceptRequest = TRUE;
    switch (pRequest->Hdr.bControlSelector)
    {
        ...
        case USBVIDEO_bControlSelector_VS_STILL_IMAGE_TRIGGER_CONTROL:
            ...
            {
                case USB_bRequest_Video_GET_CUR:
                    pRequest->StillImage.bTrigger =
                        pVideoDemoCtx->bStillTrigger;
                    break;
                case USB_bRequest_Video_SET_CUR:
                    // Still Image Capture
