...
/// @defgroup scResMgr scResMgr Driver
/// @{
/// @brief     Resource Manager SHAVE driver API
///
...
#ifndef _RESMGR_SC_H_
#define _RESMGR_SC_H_
...
#define SC_RESMGR_REQ_ID_ANY SGL_RESMGR_REQ_ID_ANY

typedef SglResMgrType ScResMgrType;
#define SC_RESMGR_SHAVE SGL_RESMGR_SHAVE
#define SC_RESMGR_HW_FILTER SGL_RESMGR_HW_FILTER
#define SC_RESMGR_AHB_DMA_CHAN SGL_RESMGR_AHB_DMA_CHAN
#define SC_RESMGR_CMX_DMA_CHAN SGL_RESMGR_CMX_DMA_CHAN
#define SC_RESMGR_LCD  SGL_RESMGR_LCD
#define SC_RESMGR_MIPI_TX SGL_RESMGR_MIPI_TX
#define SC_RESMGR_I2C SGL_RESMGR_I2C
#define SC_RESMGR_I2S SGL_RESMGR_I2S
#define SC_RESMGR_SPI SGL_RESMGR_SPI
#define SC_RESMGR_SDIO SGL_RESMGR_SDIO
#define SC_RESMGR_UART SGL_RESMGR_UART
#define SC_RESMGR_GPIO SGL_RESMGR_GPIO
#define SC_RESMGR_GPIO_IRQ SGL_RESMGR_GPIO_IRQ
#define SC_RESMGR_SHAVE_L2_CACHE SGL_RESMGR_SHAVE_L2_CACHE
#define SC_RESMGR_MUTEX SGL_RESMGR_MUTEX

typedef SglResMgrClk ScResMgrClk;
#define SC_RESMGR_OSC1 SGL_RESMGR_OSC1
#define SC_RESMGR_OSC2 SGL_RESMGR_OSC2
#define SC_RESMGR_PLL1 SGL_RESMGR_PLL1
#define SC_RESMGR_PLL2 SGL_RESMGR_PLL2
#define SC_RESMGR_SYSCLK SGL_RESMGR_SYSCLK

typedef SglResMgrInfoClockEntry ScResMgrInfoClockEntry;

typedef SglResMgrHandler ScResMgrHandler;

typedef SglResMgrRequest ScResMgrRequest;
...
///
/// @param[out] info - structure containing clocks configuration.
///
/// @return
...
///
/// @return
///     - SGL_SUCCESS - resource allocated successfully. If atomic is not
...
///
/// @return
///     - SGL_SUCCESS - protected function was successfully executed.
///     - SGL_ERR_PARAM - the input parameter is not specified correctly or
///       there is a parameter corruption.
///
