...
#include "registersMyriad.h"  // not present in 1
#include "mv_types.h"
#include "DrvCommon.h"
...
#define DRV_AHB_DMA_CHANNEL_NO      (8)
#define DRV_AHB_MAX_BLOCK_SIZE      ((1 << 12) - 1)
#define DRV_AHB_MAX_CH_PRIO         (7)

#define DRV_AHB_DMA_CTL_DST_TR_WIDTH_POS   (1)
#define DRV_AHB_DMA_CTL_SRC_TR_WIDTH_POS   (4)
#define DRV_AHB_DMA_CTL_DINC_INC_POS       (7)
#define DRV_AHB_DMA_CTL_SINC_INC_POS       (9)
#define DRV_AHB_DMA_CTL_DST_MSIZE_POS     (11)
#define DRV_AHB_DMA_CTL_SRC_MSIZE_POS     (14)
#define DRV_AHB_DMA_CTL_TT_FC_POS         (20)

#define DRV_AHB_DMA_CFG_CH_PRIOR_POS       (5)
#define DRV_AHB_DMA_CFG_HS_SEL_DST_POS    (10)
#define DRV_AHB_DMA_CFG_HS_SEL_SRC_POS    (11)
#define DRV_AHB_DMA_CFG_RELOAD_POS        (30)

#define DRV_AHB_DMA_CFG_DST_PER_MASK (0xf << DRV_AHB_DMA_CFG_DEST_PER_POS)
#define DRV_AHB_DMA_CFG_SRC_PER_MASK (0xf << DRV_AHB_DMA_CFG_SRC_PER_POS)
#define DRV_AHB_DMA_CFG_HS_SEL_DST_MASK (1 << DRV_AHB_DMA_CFG_HS_SEL_DST_POS)
#define DRV_AHB_DMA_CFG_HS_SEL_SRC_MASK (1 << DRV_AHB_DMA_CFG_HS_SEL_SRC_POS)

#define AHB_DMA_DEFAULT_INT_PRIO 9
#define AHB_DMA_DEFAULT_CHANEL_PRIO 5

#define AHB_DMA_WE_AND_CHANNEL_BIT_MASK    (0x101)

#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_0  IRQ_DYNAMIC_0
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_1  IRQ_DYNAMIC_1
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_2  IRQ_DYNAMIC_2
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_3  IRQ_DYNAMIC_3
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_4  IRQ_DYNAMIC_4
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_5  IRQ_DYNAMIC_5
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_6  IRQ_DYNAMIC_6
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_7  IRQ_DYNAMIC_7
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_8  IRQ_DYNAMIC_8
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_9  IRQ_DYNAMIC_9
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_10 IRQ_DYNAMIC_10
#define AHB_DMA_ROUTE_TO_LRT_IRQ_DYN_11 IRQ_DYNAMIC_11
#define AHB_DMA_NO_LRT_ROUTING          IRQ_AHB_DMA

#define AHB_DMA_DEFAULT_IRQ_LEVEL  10

typedef enum {
    AHB_DMA_CHANNEL_SUCCESS = 0,
    AHB_DMA_CHANNEL_ERROR,
} ahbDmaChannelStatus_t;

typedef enum {
    AHB_DMA_DRV_SUCCESS = MYR_DRV_SUCCESS,
    AHB_DMA_DRV_ERROR = MYR_DRV_ERROR,    
    AHB_DMA_DRV_NOT_INITIALIZED = MYR_DRV_NOT_INITIALIZED,
    AHB_DMA_DRV_ALREADY_INITIALIZED = MYR_DRV_ALREADY_INITIALIZED,
    AHB_DMA_DRV_BUSY = MYR_DRV_CUSTOM_CODE_START_OFFSET
} ahbDmaDrvStatus_t;

typedef enum {
    DRV_AHB_DMA_STAT_UNINITIALIZED = 0, /*< Driver status not initialized */
    DRV_AHB_DMA_STAT_INITIALIZED, /*< Driver initialized */
    DRV_AHB_DMA_STAT_OPENED /*< Driver opened, ready to be used */
} ahbDmaStatus_t;


typedef void (ahbDmaTransferDoneCallback_t)(u32 channel, ahbDmaChannelStatus_t status);

typedef enum {
    AHB_DMA_SINGLE_BLOCK,
    AHB_DMA_MULTI_BLOCK
}transferType_t;
...
typedef enum {
    AHB_DMA_CTL_TR_WIDTH_8 = 0,
    AHB_DMA_CTL_TR_WIDTH_16,
    AHB_DMA_CTL_TR_WIDTH_32
} drvAhbDmaTrWidth_t;
...
typedef enum {
    AHB_DMA_CTL_MSIZE_1 = 0,
    AHB_DMA_CTL_MSIZE_4,
    AHB_DMA_CTL_MSIZE_8,
    AHB_DMA_CTL_MSIZE_16,
    AHB_DMA_CTL_MSIZE_32,
} drvAhbDmaBurstSize_t;

typedef enum {
    AHB_DMA_CTL_TT_FC_D_M2M = 0,
    AHB_DMA_CTL_TT_FC_D_M2P,
    AHB_DMA_CTL_TT_FC_D_P2M,
    AHB_DMA_CTL_TT_FC_D_P2P,
    AHB_DMA_CTL_TT_FC_P_P2M,
    AHB_DMA_CTL_TT_FC_SP_P2P,
    AHB_DMA_CTL_TT_FC_P_M2P,
    AHB_DMA_CTL_TT_FC_DP_P2P
} drvAhbDmaCtlTransferType_t;

typedef enum {
    AHB_DMA_CFG_RELOAD_NONE = 0,
    AHB_DMA_CFG_RELOAD_SRC,
    AHB_DMA_CFG_RELOAD_DST,
    AHB_DMA_CFG_RELOAD_BOTH
} ahbDmaAutoreload_t;

typedef enum {
    AHB_DMA_CFG_HS_SEL_HW = 0,
    AHB_DMA_CFG_HS_SEL_SW
}ahbDmaHsSel_t;
