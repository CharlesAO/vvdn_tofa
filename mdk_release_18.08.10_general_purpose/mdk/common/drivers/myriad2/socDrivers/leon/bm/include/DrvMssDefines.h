...
#define D_DRV_MSS_MIPI_CFG_EN_ALL (D_DRV_MSS_MIPI_CFG_EN_0 | \
                                   D_DRV_MSS_MIPI_CFG_EN_1 | \
                                   D_DRV_MSS_MIPI_CFG_EN_2 | \
                                   D_DRV_MSS_MIPI_CFG_EN_3 | \
                                   D_DRV_MSS_MIPI_CFG_EN_4 | \
                                   D_DRV_MSS_MIPI_CFG_EN_5)
...
// &
// MSS_RSTN_CTRL_ADR                      ================================================================
#define D_DRV_MSS_CLK_APB_SLAVE              (1<<0)
...
typedef enum drvMssDeviceE { DRV_MSS_CIF = 0, DRV_MSS_SIPP_RX, DRV_MSS_SIPP_TX, DRV_MSS_LCD} drvMssDeviceType;
