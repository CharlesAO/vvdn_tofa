...
CIF config
@param
     config - uses sDrvMipiCifConfig defined in DrvCifDefines 
...
@param
    cifBase     - registers start  address for CIF1 or CIF2 (CIF1_BASE_ADR or CIF2_BASE_ADR)
@param
    dmaId       - identifier of the updated DMA
@param
    dataBufAdr  - new address to be set in the DMA register
*************************************************************************/
void DrvCifDmaUpdate(u32 cifBase, tyCIFDmaDevice dmaId, u32 dataBufAdr);

/************************************************************************
CIF window reset - function used to reset some internals of CIF when desynchronized
