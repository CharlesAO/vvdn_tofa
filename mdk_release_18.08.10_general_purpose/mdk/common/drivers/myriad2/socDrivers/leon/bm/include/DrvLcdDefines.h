...
#define D_LCD_CTRL_BPORCH_ENABLE         (0x00200000)
// = bit 22 VSYNC FRONT PORCH LEVEL
#define D_LCD_CTRL_FPORCH_ENABLE         (0x00400000)
// = bit 28 enable pipelined (outstanding) DMA reads
#define D_LCD_CTRL_PIPELINE_DMA         (0x10000000)
...
// --- bit 17
#define D_LCD_OUTF_USE_INTERNAL_CLK     (0 << 17)   //
#define D_LCD_OUTF_USE_EXTERNAL_CLK     (1 << 17)   //
// --- bit 18
#define D_LCD_OUTF_MIPI_RGB             (1 << 18)   //
#define D_LCD_OUTF_INTERLEAVE_MODE      (0 << 18)   //
...
#define D_LCD_LAYER_FORMAT_NV12         (0x3800)
// --- bit 14
