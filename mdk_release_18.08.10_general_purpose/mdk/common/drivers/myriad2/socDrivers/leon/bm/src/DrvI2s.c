...
// 4: Static Local Data 
// ----------------------------------------------------------------------------
static ahbDmaHandler_t dmaHandler1;
static ahbDmaHandler_t dmaHandler2;
...
// ----------------------------------------------------------------------------
#define AHB_DMA_CH_PRIOR    5
#define AHB_DMA_IRQ_PRIO   10
...
{
      u32 i2sModule;
      DrvAhbDmaInit(AHB_DMA_IRQ_PRIO, AHB_DMA_NO_LRT_ROUTING);
      ...
      if (txNotRx)  // set channels for tx
      {
           ...
           DrvAhbDmaOpenChannel(&dmaHandler1, dmaCh, NULL);
           DrvAhbDmaChannelConfig(&dmaHandler1, AHB_DMA_CTL_TR_WIDTH_16, AHB_DMA_CTL_TR_WIDTH_16,
                                  AHB_DMA_CTL_NO_INC, AHB_DMA_CTL_INC,
                                  AHB_DMA_CTL_MSIZE_1, AHB_DMA_CTL_MSIZE_1,
                                  AHB_DMA_CTL_TT_FC_D_M2P, AHB_DMA_CH_PRIOR);
           DrvAhbDmaSingleBlockTransfer(&dmaHandler1, (void*)dmaAddr, (void*)(base + I2S_TXDMA), dmaL * 2);
      ...
      else            // set channel for rx
      {
           ...
           DrvAhbDmaOpenChannel(&dmaHandler2, dmaCh, NULL);
           DrvAhbDmaChannelConfig(&dmaHandler2, AHB_DMA_CTL_TR_WIDTH_16, AHB_DMA_CTL_TR_WIDTH_16,
                                             AHB_DMA_CTL_INC, AHB_DMA_CTL_NO_INC,
                                             AHB_DMA_CTL_MSIZE_1, AHB_DMA_CTL_MSIZE_1,
                                             AHB_DMA_CTL_TT_FC_D_M2M, AHB_DMA_CH_PRIOR);

           //DrvAhbDmaSingleBlockTransfer(&dmaHandler2, (void*)(base + I2S_RXDMA), (void*)dmaAddr, dmaL * 2); 
      }
...
void DrvI2sTxTransferBlock(u32 base, u32 dmaAddr, u32 dmaL)
{
   // dmaHandler1 is assigned to TX
   DrvAhbDmaSingleBlockTransfer(&dmaHandler1, (void*)(base + I2S_TXDMA), (void*)dmaAddr, dmaL * 2); 
}

void DrvI2sRxTransferBlock(u32 base, u32 dmaAddr, u32 dmaL)
{
   // dmaHandler2 is assigned to RX
   DrvAhbDmaSingleBlockTransfer(&dmaHandler2, (void*)(base + I2S_RXDMA), (void*)dmaAddr, dmaL * 2); 
}
