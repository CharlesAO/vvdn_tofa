...
//Historical MDK default CMX SHAVE code size (may be overwritten as per needs of course)
#define DEFAULT_CMX_CODE_SIZE (32*1024)
...
#define SHAVE_LOCAL  0x0ff00000
#define WINDOW_A_NO  0
#define WINDOW_B_NO  1
#define WINDOW_C_NO  2
#define WINDOW_D_NO  3
#define POL  6
#define SOL  7
...
#define SVU_PC2        0x844       // Performance Counter 2
#define SVU_PCC2       0x848       // Performance Counter 2 Control Register
#define SVU_PC3        0x84c       // Performance Counter 3
#define SVU_PCC3       0x850       // Performance Counter 3 Control Register
...
// Bitfields for the DCU ISR interrupt status register
#define DCU_ISR_FPE        (0)      //Floating-point exception
#define DCU_ISR_IE         (1)      //Integer exception
#define DCU_ISR_IO         (2)      //Invalid opcode (IDC cannot correctly decode an instruction)
#define DCU_ISR_PEU_RMO    (3)      //PEU reserved mnemonic opcode
#define DCU_ISR_BRU_RMO    (4)      //BRU reserved mnemonic opcode
#define DCU_ISR_LSU0_RMO   (5)      //LSU0 reserved mnemonic opcode
#define DCU_ISR_LSU1_RMO   (6)      //LSU1 reserved mnemonic opcode
#define DCU_ISR_VAU_RMO    (7)      //VAU reserved mnemonic opcode
#define DCU_ISR_SAU_RMO    (8)      //SAU reserved mnemonic opcode
#define DCU_ISR_IAU_RMO    (9)      //IAU reserved mnemonic opcode
#define DCU_ISR_CMU_RMO    (10)     //CMU reserved mnemonic opcode
#define DCU_ISR_DWI        (11)     //Discontinuity warning interrupt
#define DCU_ISR_SGI        (12)     //Software generated interrupt (SWIH/SWIC)
#define DCU_ISR_SGITV      (13)     //Software generated interrupt (SWIH/SWIC) tag value

// Bitfields for the DCU IRR interrupt clear register
#define DCU_IRR_FPEIC      (0)      //Floating-point exception interrupt clear
#define DCU_IRR_IEIC       (1)      //Integer exception interrupt clear
#define DCU_IRR_IOIC       (2)      //Invalid opcode interrupt clear
#define DCU_IRR_RMOIC      (3)      //Reserved mnemonic opcode interrupt clear
#define DCU_IRR_DWIIC      (4)      //Discontinuity warning interrupt clear
#define DCU_IRR_SGIIC      (5)      //Software generated interrupt (SWIH/SWIC) interrupt clear

#define DCU_ISR_FPE_MASK        ((u32)(1 << DCU_ISR_FPE))
#define DCU_ISR_IE_MASK         ((u32)(1 << DCU_ISR_IE))
#define DCU_ISR_IO_MASK         ((u32)(1 << DCU_ISR_IO))
#define DCU_ISR_PEU_RMO_MASK    ((u32)(1 << DCU_ISR_PEU_RMO))
#define DCU_ISR_BRU_RMO_MASK    ((u32)(1 << DCU_ISR_BRU_RMO))
#define DCU_ISR_LSU0_RMO_MASK   ((u32)(1 << DCU_ISR_LSU0_RMO))
#define DCU_ISR_LSU1_RMO_MASK   ((u32)(1 << DCU_ISR_LSU1_RMO))
#define DCU_ISR_VAU_RMO_MASK    ((u32)(1 << DCU_ISR_VAU_RMO))
#define DCU_ISR_SAU_RMO_MASK    ((u32)(1 << DCU_ISR_SAU_RMO))
#define DCU_ISR_IAU_RMO_MASK    ((u32)(1 << DCU_ISR_IAU_RMO))
#define DCU_ISR_CMU_RMO_MASK    ((u32)(1 << DCU_ISR_CMU_RMO))
#define DCU_ISR_DWI_MASK        ((u32)(1 << DCU_ISR_DWI))
#define DCU_ISR_SGI_MASK        ((u32)(1 << DCU_ISR_SGI))

#define DCU_IRR_FPEIC_MASK      ((u32)(1 << DCU_IRR_FPEIC))
#define DCU_IRR_IEIC_MASK       ((u32)(1 << DCU_IRR_IEIC))
#define DCU_IRR_IOIC_MASK       ((u32)(1 << DCU_IRR_IOIC))
#define DCU_IRR_RMOIC_MASK      ((u32)(1 << DCU_IRR_RMOIC))
#define DCU_IRR_DWIIC_MASK      ((u32)(1 << DCU_IRR_DWIIC))
#define DCU_IRR_SGIIC_MASK      ((u32)(1 << DCU_IRR_SGIIC))

#define GET_DCU_ISR_SGITV_WORD(x)          ((u32)(0x0000001F & (x >> DCU_ISR_SGITV)))  //Returns Software generated interrupt tag value

#define IS_DCU_ISR_FPE_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_IE_TRIGGERED(x)     (x | DCU_ISR_IE_MASK)
#define IS_DCU_ISR_IO_TRIGGERED(x)     (x | DCU_ISR_IO_MASK)
#define IS_DCU_ISR_RMO_TRIGGERED(x)    (x | (DCU_ISR_PEU_RMO_MASK | DCU_ISR_BRU_RMO_MASK | DCU_ISR_LSU0_RMO_MASK | DCU_ISR_LSU1_RMO_MASK | DCU_ISR_VAU_RMO_MASK | DCU_ISR_SAU_RMO_MASK | DCU_ISR_IAU_RMO_MASK | DCU_ISR_CMU_RMO_MASK))
#define IS_DCU_ISR_DWI_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_SGI_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)

#define IS_DCU_ISR_PEU_RMO_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_BRU_RMO_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_LSU0_RMO_TRIGGERED(x)   (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_LSU1_RMO_TRIGGERED(x)   (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_VAU_RMO_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_SAU_RMO_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_IAU_RMO_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)
#define IS_DCU_ISR_CMU_RMO_TRIGGERED(x)    (x | DCU_ISR_FPE_MASK)
...
// SHAVE_DBG bit fields
#define L1C_CACHE_DBG       0x4
#define L1C_CACHE_STAT_EN   0x8

#define ASYNC_CONTINUE  (0x0)
#define SW_BP_INST      (0x01)
...
#define DCU_PCC2(a)     SVU_CTRL_ADDR[a] + SLC_OFFSET_SVU + SVU_PCC2
#define DCU_PCC3(a)     SVU_CTRL_ADDR[a] + SLC_OFFSET_SVU + SVU_PCC3

#define DCU_PC0(a)      SVU_CTRL_ADDR[a] + SLC_OFFSET_SVU + SVU_PC0
#define DCU_PC1(a)      SVU_CTRL_ADDR[a] + SLC_OFFSET_SVU + SVU_PC1
#define DCU_PC2(a)      SVU_CTRL_ADDR[a] + SLC_OFFSET_SVU + SVU_PC2
#define DCU_PC3(a)      SVU_CTRL_ADDR[a] + SLC_OFFSET_SVU + SVU_PC3
...
#define DCU_RF_CFG(a)   (SVU_CTRL_ADDR[a] + SLC_OFFSET_SVU + SVU_RF_CFG)
...
// Register File Ram Timing Constant for IRF,VRF
// This value is a constant defined by silicon parameters and should not be modified.
#define M2_RF_CFG_VAL        (2)
#define IRF_RAM_CFG          (M2_RF_CFG_VAL)
#define VRF_RAM0_CFG         (M2_RF_CFG_VAL)
#define VRF_RAM1_CFG         (M2_RF_CFG_VAL)
#define VRF_RAM2_CFG         (M2_RF_CFG_VAL)
#define VRF_RAM3_CFG         (M2_RF_CFG_VAL)
#define DEFAULT_RF_CONFIG    ((IRF_RAM_CFG << 8) | (VRF_RAM3_CFG << 6) | (VRF_RAM2_CFG << 4) | (VRF_RAM1_CFG << 2) | (VRF_RAM0_CFG << 0))
...
#define PC_DEFAULT PC_STALL_EN | PC_INT_EN | PC_LSU0_WD_EN | PC_LSU1_WD_EN | \
                   PC_LSU0_AS_EN | PC_LSU1_AS_EN | PC_IDC_BUFF_EN | PC_FETCH_EN
...
#define  CACHE_CTRL_STOP          (1 << 3)
#define  CACHE_CTRL_WTHRU         (1 << 2)
#define  CACHE_CTRL_LOCK          (1 << 1)
#define  CACHE_CTRL_ENABLE        (1 << 0)

#define CACHE_STATUS_BUSY_FLUSH_INVAL   (1 << 1)
#define CACHE_STATUS_BUSY_DATA          (1 << 0)

#define CACHE_TXN_PREFETCH_L1_LINE              (0)
#define CACHE_TXN_PREFETCH_L1_LINE_W_LOCK       (1)
#define CACHE_TXN_PREFETCH_L2                   (2)
#define CACHE_TXN_LINE_FLUSH                    (3)
#define CACHE_TXN_LINE_INV                      (4)
#define CACHE_TXN_INV_ALL                       (5)
#define CACHE_TXN_FLUSH_ALL                     (6)
#define CACHE_TXN_WB_INV_ALL                    (7)

typedef enum {
    SVUL1DATACACHE_ENABLE = 0,
    SVUL1DATACACHE_DISABLE,
    SVUL1DATACACHE_STOP,
    SVUL1DATACACHE_INVALIDATE_ALL,
    SVUL1DATACACHE_FLUSH_ALL,
    SVUL1DATACACHE_FLUSH_INVALIDATE_ALL
} DrvSvuL1DCacheAction_t;

#define SVUL1DATACACHE_CACHE_L2_CACHED    (1 << 9)
#define SVUL1DATACACHE_CACHE_L2_BYPASSED  (1 << 8)

// SHAVE_L1C_I_CTRL bit fields
#define SVUL1INSTRCACHE_DEFAULT             (0)
#define SVUL1INSTRCACHE_BYPASS              (1 << 0)
#define SVUL1INSTRCACHE_LOCK                (1 << 1)
#define SVUL1INSTRCACHE_RPLCE_LRU           (0 << 2)
#define SVUL1INSTRCACHE_RPLCE_MRU           (1 << 2)
#define SVUL1INSTRCACHE_RPLCE_PSEUD_RAND    (1 << 3)
#define SVUL1INSTRCACHE_STAT_EN             (1 << 4)
#define SVUL1INSTRCACHE_INVALIDATE          (1 << 5)

// SHAVE_L1C_I_STATUS bit field
#define SVUL1INSTRCACHE_BUSY                (1 << 0)
