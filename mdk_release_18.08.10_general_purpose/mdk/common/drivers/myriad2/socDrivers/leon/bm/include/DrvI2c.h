...
@param
      timeNs - Time in ns for SCL to stay High.
@return
      ret value >=0? HCNT - SCL high count register value. This should be used to call DrvIicSetSpeed* functions
      ret value < 0? The system frequency is too small for the desired I2C SCL HIgh count
info:
...
@param
      timeNs - Time in ns for SCL to stay High.
@return
      ret value >=0? LCNT - SCL low count register value. This should be used to call DrvIicSetSpeed* functions
      ret value < 0? The system frequency is too small for the desired I2C SCL Low count
info:
