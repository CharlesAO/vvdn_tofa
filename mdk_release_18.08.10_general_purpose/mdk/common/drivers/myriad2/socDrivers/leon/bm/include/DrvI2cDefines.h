...
// This defines (I2C_*_MIN_*CNT) should be not use. They are minimum Hcnt and Lcnt values (in ns) from the I2C
//protocol specification, and not the correct values for the desired I2C frequency.
//However, 4000+4700 = 8700ns = 8.7 us. For 100KHz we need
//a clock of 1/100KHz= 10us period. For 8.7 us the frequency is ~115KHz
// HCNT+LCNT of SCL should be 1/I2CFREQ ns.
// From I2C Device datasheet:
// SCL_H_TIME = (HCNT + SPKLEN + 7 )*IC_CLK +SCL_FallTime;
// SCL_L_TINME = (LCNT + 1)*IC_CLK - SCL_FallTime + SCL_RiseTime

// SCL fall time and rise time is board specific. we use 100ns as default, but this value
//should be changed if measured otherwise
#define I2C_SCL_FALL_TIME_NS 100
#define I2C_SCL_RISE_TIME_NS 100
#define I2C_SPKLEN_SS_FS 5
#define I2C_SPKLEN_HS 1

#define I2C_SS_MIN_HCNT 4000
#define I2C_SS_MIN_LCNT 4700
#define I2C_FS_MIN_HCNT 600
#define I2C_FS_MIN_LCNT 1300
#define I2C_HS_MIN_HCNT 60
#define I2C_HS_MIN_LCNT 160
