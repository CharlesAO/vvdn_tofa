.type mvcvMatMinus_asm,@function
.version 00.50.02
// /* matrix definition */
...
IAU.ADDSU i5,  i4,  i7                || LSU1.LDIL i0, __m_sub_loop
IAU.ADDSU i6,  i5,  i7                || LSU1.LDIH i0, __m_sub_loop
IAU.ADDSU i7,  i6,  i7                || LSU1.LDIL i1, __m_sub_post
IAU.MULSU i10, i11, i12               || LSU1.LDIH i1, __m_sub_post
LSU1.LDIL i2, 0x10
...
LSU0.STXVI v8,  i13, i2  || vau.sub.f32 v9,  v1,  v5
LSU1.LDXVI v1,  i15, i2  || IAU.SUBSU i9,  i9,  0x01
LSU0.LDXVI v5,  i14, i2  || IAU.ADDSU i0,  i1,  0     || PEU.PCIX.EQ 0x1
LSU1.STXVI v9,  i13, i2  || vau.sub.f32 v10, v2,  v6  || BRU.JMP i0
LSU0.LDXVI v2,  i15, i2
LSU1.LDXVI v6,  i14, i2
LSU0.STXVI v10, i13, i2  || vau.sub.f32 v11, v3,  v7
LSU1.LDXVI v3,  i15, i2
LSU0.LDXVI v7,  i14, i2
LSU1.STXVI v11, i13, i2  || vau.sub.f32 v8,  v0,  v4
.lalign
__m_sub_post:
CMU.CMII.i8 i8,  i4
vau.sub.f32 v9,  v1,  v5
LSU0.STXVI v8,  i13, i2  || PEU.PVL032 0x3
CMU.CMII.i8 i8,  i5
vau.sub.f32 v10, v2,  v6 || BRU.JMP i30
LSU0.STXVI v9,  i13, i2  || PEU.PVL032 0x3
CMU.CMII.i8 i8,  i6      || vau.sub.f32 v11, v3,  v7
LSU0.STXVI v10, i13, i2  || PEU.PVL032 0x3
CMU.CMII.i8 i8,  i7
LSU0.STXVI v11, i13, i2  || PEU.PVL032 0x3
IAU.ADDSU  i18, i16, 0
.nowarnend
.size mvcvMatMinus_asm,.-mvcvMatMinus_asm
.end
