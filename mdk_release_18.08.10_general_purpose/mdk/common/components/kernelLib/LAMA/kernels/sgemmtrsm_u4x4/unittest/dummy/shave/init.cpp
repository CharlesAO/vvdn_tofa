...
///
/// @brief     sgemmtrsm_u4x4 kernel function call for unitary test
///
...
float ALIGN(16) A12[MAX_K * 4];
float ALIGN(16) B21[MAX_K * 4];
...
int main( void )
{
    ...
    mvcvsgemmtrsm_u4x4(k, &alpha, A12, A11, B21, B11, C11, rs_c, cs_c);
#else
    mvcvsgemmtrsm_u4x4_asm(k, &alpha, A12, A11, B21, B11, C11, rs_c, cs_c);
#endif
    SHAVE_HALT;
    return 0;
}
