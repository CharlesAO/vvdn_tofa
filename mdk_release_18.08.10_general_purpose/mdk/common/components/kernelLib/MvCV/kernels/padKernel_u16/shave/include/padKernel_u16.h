#ifndef PAD_KERNEL_U16_H_
#define PAD_KERNEL_U16_H_
...
MVCV_FUNC(void, mvcvPadKernel_u16, u16* iBuf, u32 iBufLen, u16* oBuf, u32 padSz, u32 padMode, u32 padType, u16 pixValue)

//!@}

#endif /* PAD_KERNEL_U16_H_ */
