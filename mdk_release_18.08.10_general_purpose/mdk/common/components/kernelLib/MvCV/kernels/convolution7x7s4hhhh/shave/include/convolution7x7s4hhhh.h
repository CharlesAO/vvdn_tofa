#ifndef __CONVOLUTION7x7S4HHHH_H__
#define __CONVOLUTION7x7S4HHHH_H__
#include <mv_types.h>
...
MVCV_FUNC(void, mvcvConvolution7x7s4hhhh, half** in, half** out, half *conv, unsigned int inWidth)
//!@}

#endif //__CONVOLUTION7x7S4HHHH_H__
