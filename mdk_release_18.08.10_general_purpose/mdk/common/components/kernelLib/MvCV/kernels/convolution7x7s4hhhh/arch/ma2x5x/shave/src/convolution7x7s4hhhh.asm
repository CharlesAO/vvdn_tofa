...
.type mvcvConvolution7x7s4hhhh_asm,@function
.version 00.51.04

.data .data.convolution7x7s4hhhh
.align 16
 convolution7x7s4hhhh_clampVal:
        .float16 255.0


.code .text.convolution7x7s4hhhh

//void Convolution7x7s4hhhh_asm(u8** in(i18), u8** out(i17), half conv[49](i16), u32 inWidth(i15))
//internal computation are made on fp16, output result is fp16
mvcvConvolution7x7s4hhhh_asm:
iau.xor i9 i9 i9
iau.xor i8 i8 i8
	LSU0.LDIL i10 conv_loopStartConv7x7s4hhhh	|| LSU1.LDIH i10 conv_loopStartConv7x7s4hhhh
...
// start loop													   
	...
	VAU.MACPW.f16 v23, v20,  v22  ||lsu1.swzv8 [00000000] 	
	cmu.vdilv.x16 v21 v23 v23 v23
	cmu.vdilv.x16 v21 v23 v23 v23
	conv_loopStartConv7x7s4hhhh:
	cmu.cmii.i32 i8, i9 || lsu0.cp i7 v23.0
	peu.pc1c NEQ || LSU0.ST.32 i7 i17 	|| IAU.ADD i17 i17 4
	iau.add i8 i8 1
	LSU1.LDXV v7  i0 || iau.add i0, i0, 0x10
	nop 
	nop
...
nop
	...
	cmu.vdilv.x16 v21 v23 v23 v23
	lsu0.cp i7 v23.0
	LSU0.ST.32 i7 i17 	|| IAU.ADD i17 i17 4
	BRU.JMP i30
	nop 6
.size mvcvConvolution7x7s4hhhh_asm,.-mvcvConvolution7x7s4hhhh_asm
.end
