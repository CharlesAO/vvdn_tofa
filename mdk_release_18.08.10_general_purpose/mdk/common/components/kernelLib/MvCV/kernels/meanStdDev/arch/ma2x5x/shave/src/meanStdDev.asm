...
/// @brief
///
.type mvcvMeanstddev_asm,@function
.version 00.70.00
...
// (Myriad2 COMPATIBILITY ISSUE): SAU.DIV.F32: SRF version no longer available at line number 28, in MeanStdDev.asm
    ...
    IAU.INCS i15, -8
__mainloop:
    // Computations for mean value meanStdDev_ meanStdDev_ meanStdDev_ meanStdDev_ meanStdDev_ meanStdDev__ || Computations for stddev value meanStdDev_ meanStdDev_ meanStdDev_ meanStdDev_ meanStdDev_ meanStdDev___ || Load pixel values
.nowarn 10	
...
.size mvcvMeanstddev_asm,.-mvcvMeanstddev_asm
.end
