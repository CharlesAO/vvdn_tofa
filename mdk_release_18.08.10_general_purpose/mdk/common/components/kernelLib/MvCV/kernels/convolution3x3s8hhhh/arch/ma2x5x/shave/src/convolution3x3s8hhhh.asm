...
.type mvcvConvolution3x3s8hhhh_asm,@function
.version 00.51.04

//.data .data.convolution3x3s8hhhh
//.align 4

//.align 16
 //convolution3x3s8hhhh_clampVal:
  //      .float16 255.0


.code .text.convolution3x3s8hhhh

//void Convolution3x3s8hhhh_asm(half** in(i18), half** out(i17), half conv[9](i16), u32 inWidth(i15))
//internal computation are made on fp16, output result is fp16
mvcvConvolution3x3s8hhhh_asm:
	LSU0.LDIL i12 mvcvConvolution3x3s8hhhh_asm_loop       || LSU1.LDIH i12 mvcvConvolution3x3s8hhhh_asm_loop
...
// start loop
	...
	VAU.MACP.f16  v9 v11        || LSU1.SWZV8 [33333333]  		|| lsu0.cp v1 v4 || cmu.vdilv.x16 v13 v12 v12 v12
	...
	VAU.MACP.f16  v9 v11        || LSU1.SWZV8 [66666666]  		|| lsu0.cp v2 v5 || cmu.vdilv.x16 v13 v12 v12 v12
	VAU.MACP.f16  v9 v2         || LSU1.SWZV8 [77777777]  		|| CMU.ALIGNVEC v11 v5 v8 2
	VAU.MACPW.f16 v12 v10 v11   || LSU1.SWZV8 [00000000]  		|| lsu0.cp v3 v6 || cmu.vdilv.x16 v13 v12 v12 v12
...
mvcvConvolution3x3s8hhhh_asm_loop:	    
.nowarn 10                
	LSU0.LD.64.L v8 i2		    || LSU1.LDO.64.H v8 i2 0x08		|| IAU.ADD i1 i1 0x10 
.nowarnend
	CMU.CMII.i32 i10 i11        || IAU.ADD i2 i2 0x10 || lsu0.cp i3 v12.0
	PEU.PC1C NEQ 			    || LSU0.ST.16 i3 i17  		|| IAU.ADD i17 i17 0x2
                                
	IAU.ADD i10 i10 1
    CMU.ALIGNVEC v11 v0 v3 14 
    NOP 2
    nop 3
	cmu.vdilv.x16 v13 v12 v12 v12
	cmu.vdilv.x16 v13 v12 v12 v12
	cmu.vdilv.x16 v13 v12 v12 v12
	lsu0.cp i3 v12.0
    LSU0.ST.16 i3 i17  		|| IAU.ADD i17 i17 0x2
	BRU.JMP i30
	
	nop 6
.size mvcvConvolution3x3s8hhhh_asm,.-mvcvConvolution3x3s8hhhh_asm
.end
