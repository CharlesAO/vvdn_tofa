...
///
/// @brief     Convolution3x3s8hhhh kernel function call for unitary test
///
...
int main( void )
{
	...
	outLines 	= (half**)outLine;
		...
		mvcvConvolution3x3s8hhhh(inLines, outLines, conv, width);
   #else
		mvcvConvolution3x3s8hhhh_asm(inLines, outLines, conv, width);
	#endif
