...
{    
    ...
    mvcvComputeAD32(in1, in2, out, width, flag);
#else
	#ifdef MOVICOMPILE_OPTIMIZED
  	mvcvComputeAD32_opt(in1, in2, out, width, flag);
	#else
    	//mvcvComputeAD32(in1, in2, out, width);
    	mvcvComputeAD32_asm(in1, in2, out, width, flag);
	#endif
#endif  
    SHAVE_HALT; 
    return 0;
