...
int main( void )
{
//	void sLaplacian7x7Fp16ToFp16_asm(u8** in, u8** out, u32 inWidth);
	...
	mvcvSLaplacian7x7Fp16ToFp16(inLines, outLines, width);
	#else
	mvcvSLaplacian7x7Fp16ToFp16_asm(inLines, outLines, width);
	#endif
