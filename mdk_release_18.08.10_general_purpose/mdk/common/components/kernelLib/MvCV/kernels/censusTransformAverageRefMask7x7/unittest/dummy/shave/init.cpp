...
///
/// @brief     censusTransformAverageRefMask7x7 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvCensusTransformAverageRefMask7x7(inLines, output, width);
	#else
	mvcvCensusTransformAverageRefMask7x7_asm(inLines, output, width);
	#endif
