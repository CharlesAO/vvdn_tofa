...
///
/// @brief     medianFilter13x13 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvMedianFilter13x13(widthLine, outLines, inLines);
	#else
	mvcvMedianFilter13x13_asm(widthLine, outLines, inLines);
	#endif
