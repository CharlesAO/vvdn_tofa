...
.type mvcvConvolution5x5s8hhhh_asm,@function
.version 00.51.05

.data .data.convolution5x5s8hhhh
.align 4
...
.code .text.convolution5x5s8hhhh

//void Convolution5x5_asm(half** in(i18)  half** out(i17)  half conv[25](i16)  u32 inWidth(i15))
mvcvConvolution5x5s8hhhh_asm:
	...
	LSU0.LDiL i11 ___forLoopConvolution5x5s8hhhh    	|| LSU1.LDiH i11 ___forLoopConvolution5x5s8hhhh
...
___forLoopConvolution5x5s8hhhh:		
		...
		CMU.CMII.i32 i5 i7
	 	PEU.PC1C NEQ				|| LSU0.ST.16 i6,i17                 || IAU.ADD i17 i17 2  
	 	IAU.ADD i5 i5 1             || CMU.ALIGNVEC v20 v0 v5 12 
		NOP
	

    
    CMU.VDILV.x16 v22 v21 v21 v21  || 	BRU.jmp i30
    CMU.VDILV.x16 v22 v21 v21 v21
    CMU.VDILV.x16 v22 v21 v21 v21
    CMU.CPVI.x16 i6.l v21.0
    LSU0.ST.16 i6,i17              	
...
.size mvcvConvolution5x5s8hhhh_asm,.-mvcvConvolution5x5s8hhhh_asm
.end
