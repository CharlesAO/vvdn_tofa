...
///
/// @brief     convolution5x5s8hhhh kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution5x5s8hhhh(inLines, outLines, conv, width);
	#else
    mvcvConvolution5x5s8hhhh_asm(inLines, outLines, conv, width);
    #endif
