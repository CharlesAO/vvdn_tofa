#ifndef __CONVOLUTION11x11_H__
#define __CONVOLUTION11x11_H__
#include <mv_types.h>
...
MVCV_FUNC(void, mvcvConvolution11x11, u8** in, u8** out, half conv[121], u32 inWidth)
//!@}


#endif //__CONVOLUTION11x11_H__
