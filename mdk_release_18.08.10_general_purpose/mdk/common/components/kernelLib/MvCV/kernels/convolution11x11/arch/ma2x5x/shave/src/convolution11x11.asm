...
.type mvcvConvolution11x11_asm,@function
.version 00.51.05

.code .text.convolution11x11

//void Convolution11x11_asm(u8** in(i18), u8** out(i17), half conv[121](i16), u32 inWidth(i15))
mvcvConvolution11x11_asm:
	...
	LSU0.ST.64.H v31  i19			|| LSU1.LDo.64.L v28 i16 0x40|| IAU.XOR i11 i11 i11
	IAU.SUB i0  i0  8									|| LSU0.LDo.64.H v28 i16 0x48
	IAU.SUB i1  i1  8		
	...
	IAU.SHR.i32 i12 i15 3	|| LSU0.LDi.128.u8f.f16 v9  i9
							   ...
							   LSU0.LDi.128.u8f.f16 v11 i0	|| LSU1.LDo.64.L v29 i16 0x50
							   LSU0.LDi.128.u8f.f16 v12 i1	|| LSU1.LDo.64.H v29 i16 0x58
							   LSU0.LDi.128.u8f.f16 v13 i2	|| LSU1.LDo.64.L v30 i16 0x60
							   LSU0.LDi.128.u8f.f16 v14 i3	|| LSU1.LDo.64.H v30 i16 0x68
							   LSU0.LDi.128.u8f.f16 v15 i4	|| LSU1.LDo.64.L v31 i16 0x70
							   LSU0.LDi.128.u8f.f16 v16 i5	|| LSU1.LDo.64.H v31 i16 0x78
 ...
 .nowarnend
	...
	VAU.MACP.f16  v31 v22 	|| LSU0.SWZV8 [66666666]	|| CMU.ALIGNVEC v22 v5 v16 6	|| LSU1.LDo.64.L v31 i16 0x90
	VAU.MACP.f16  v31 v22 	|| LSU0.SWZV8 [77777777]	|| CMU.ALIGNVEC v22 v5 v16 8    || LSU1.LDo.64.H v31 i16 0x98

	VAU.MACP.f16  v30 v22 	|| LSU0.SWZV8 [00000000]	|| CMU.ALIGNVEC v22 v5 v16 10	|| LSU1.LDi.128.u8f.f16 v17 i6
	...
	VAU.MACP.f16  v31 v22 	|| LSU0.SWZV8 [00000000]	|| CMU.ALIGNVEC v22 v6 v17 4	|| LSU1.LDo.64.L v30 i16 0xA0
	VAU.MACP.f16  v31 v22 	|| LSU0.SWZV8 [11111111]	|| CMU.ALIGNVEC v22 v6 v17 6    || LSU1.LDo.64.H v30 i16 0xA8
	VAU.MACP.f16  v31 v22 	|| LSU0.SWZV8 [22222222]	|| CMU.ALIGNVEC v22 v6 v17 8
	VAU.MACP.f16  v31 v22 	|| LSU0.SWZV8 [33333333]	|| CMU.ALIGNVEC v22 v6 v17 10	|| LSU1.LDi.128.u8f.f16 v18 i7
	...
	VAU.MACP.f16  v30 v22 	|| LSU0.SWZV8 [66666666]	|| CMU.ALIGNVEC v22 v7 v18 10	|| LSU1.LDi.128.u8f.f16 v19 i8
	...
	VAU.MACP.f16  v31 v22 	|| LSU0.SWZV8 [77777777]	|| CMU.ALIGNVEC v22 v8 v19 6	|| LSU1.LDo.64.L v31 i16 0xD0
                                                                                        
	VAU.MACP.f16  v30 v22 	|| LSU0.SWZV8 [00000000]	|| CMU.ALIGNVEC v22 v8 v19 8	|| LSU1.LDo.64.H v31 i16 0xD8
	VAU.MACP.f16  v30 v22 	|| LSU0.SWZV8 [11111111]	|| CMU.ALIGNVEC v22 v8 v19 10	|| LSU1.LDi.128.u8f.f16 v20 i9
	...
	VAU.MACP.f16  v31 v22 	|| LSU0.SWZV8 [44444444]	|| CMU.ALIGNVEC v22 v9  v20 10	|| LSU1.LDi.128.u8f.f16 v21 i10
	...
	LSU0.ST.128.f16.u8f v23 i17	|| IAU.ADD i17 i17 i11
	CMU.CMZ.i32 i15 || LSU0.LDIL i11 8
	PEU.PC1C NEQ || BRU.BRA convolution11x11_loop
	LSU0.LDo.64.L v30 i16 0x60
	LSU0.LDo.64.H v30 i16 0x68
	LSU0.LDo.64.L v31 i16 0x70
	LSU0.LDo.64.H v31 i16 0x78	
...
.size mvcvConvolution11x11_asm,.-mvcvConvolution11x11_asm
.end
