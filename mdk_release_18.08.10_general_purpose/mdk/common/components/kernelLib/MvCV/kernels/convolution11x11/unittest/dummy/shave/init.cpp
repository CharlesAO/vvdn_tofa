...
///
/// @brief     Convolution11x11 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution11x11(inLines, outLines, conv, width);
	#else
	mvcvConvolution11x11_asm(inLines, outLines, conv, width);
	#endif
