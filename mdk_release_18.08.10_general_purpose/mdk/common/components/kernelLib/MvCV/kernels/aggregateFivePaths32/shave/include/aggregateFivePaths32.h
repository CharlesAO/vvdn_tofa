#ifndef __AGGREGATE_FIVE_PATHS_32__
#define __AGGREGATE_FIVE_PATHS_32__
...
MVCV_FUNC(void, mvcvAggregateFivePaths32, u8* path0, u8* path1, u8* path2, u8* path3, u8* path4, u8* out, u32 width)
//!@}
    
#endif //__AGGREGATE_FIVE_PATHS_32__
