...
//	void mvcvThresholdKernel_asm(u8** in, u8** out, u32 width, u32 height, u8 thresh, u32 thresh_type);
...
{	
	...
	mvcvThresholdKernel(inLines, outLinesC, 328, 1, thresh, thresh_type);
...
{	
	...
	mvcvThresholdKernel(inLines, outLinesC, 640, 1, thresh, thresh_type);
...
{	
	...
	thresholdKernel_asm_test(inLines, outLinesAsm, 320, 1, thresh, thresh_type);
	mvcvThresholdKernel(inLines, outLinesC, 320, 1, thresh, thresh_type);
	RecordProperty("CyclePerPixel", thresholdKernelCycleCount / 320);
...
TEST_F(ThresholdKernelTest, Test0ForUniformInputMinimumWidth)
{
	...
	mvcvThresholdKernel(inLines, outLinesC, 8, 1, thresh, thresh_type);
...
{	
	...
	mvcvThresholdKernel(inLines, outLinesC, 1920, 1, thresh, thresh_type);
...
{	
	...
	mvcvThresholdKernel(inLines, outLinesC, width, 1, thresh, thresh_type);
...
{	
	...
	mvcvThresholdKernel(inLines, outLinesC, 168, 1, thresh, thresh_type);
...
{	
	...
	mvcvThresholdKernel(inLines, outLinesC, 648, 1, thresh, thresh_type);
...
{	
	...
	mvcvThresholdKernel(inLines, outLinesC, 120, 1, thresh, thresh_type);
...
{	
	...
	thresholdKernel_asm_test(inLines, outLinesAsm, 24, 1, thresh, thresh_type);
	mvcvThresholdKernel(inLines, outLinesC, 24, 1, thresh, thresh_type);
	RecordProperty("CyclePerPixel", thresholdKernelCycleCount / 24);
...
{	
	...
	mvcvThresholdKernel(inLines, outLinesC, 16, 1, thresh, thresh_type);
