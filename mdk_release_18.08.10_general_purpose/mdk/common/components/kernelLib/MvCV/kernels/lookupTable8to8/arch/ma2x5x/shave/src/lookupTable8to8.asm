...
.lalign
 .nowarn
lsu0.ldil i1, lookupTable8to8_loop_end  || lsu1.ldih i1, lookupTable8to8_loop_end
lsu0.ldil i11, lookupTable8to8_compensation  || lsu1.ldih i11, lookupTable8to8_compensation
...
// (Myriad2 COMPATIBILITY ISSUE): BRU.RPL: changed order of parameters at line number 34, in LookupT.asm
 ...
 lookupTable8to8_compensation:

    lsu0.ldil i1 lookupTable8to8_compensate || lsu1.ldih i1 lookupTable8to8_compensate
...
BRU.jmp i30
nop 6
.size mvcvLUT8to8_asm,.-mvcvLUT8to8_asm
.nowarnend 
.end
