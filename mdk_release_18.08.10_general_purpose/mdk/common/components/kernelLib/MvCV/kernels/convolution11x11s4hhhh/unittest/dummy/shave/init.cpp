...
///
/// @brief     Convolution11x11s4hhhh kernel function call for unitary test
///
...
u32 width;
half conv[121] __attribute__ ((aligned (16)));
...
int main( void )
{
	...
	mvcvConvolution11x11s4hhhh(inLines, outLines, conv, width);
	#else
	mvcvConvolution11x11s4hhhh_asm(inLines, outLines, conv, width);
	#endif
