...
///
/// @brief     convolution5x5s4hhhh kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution5x5s4hhhh(inLines, outLines, conv, width);
	#else
	#ifdef MOVICOMPILE_OPTIMIZED
   		mvcvConvolution5x5s4hhhh_opt(inLines, outLines, conv, width);
		#else
 		mvcvConvolution5x5s4hhhh_asm(inLines, outLines, conv, width);
		#endif
        #endif
