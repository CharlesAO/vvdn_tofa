...
.type mvcvConvolution5x5s4hhhh_asm,@function
.version 00.51.05

.data .data.convolution5x5s4hhhh
.align 4



.code .text.convolution5x5s4hhhh

//void Convolution5x5_asm(half** in(i18)  half** out(i17)  half conv[25](i16)  u32 inWidth(i15))
mvcvConvolution5x5s4hhhh_asm:
	...
	LSU0.LDiL i11 ___forLoopConvolution5x5s4hhhh    	|| LSU1.LDiH i11 ___forLoopConvolution5x5s4hhhh
...
___forLoopConvolution5x5s4hhhh:		
.nowarn 10
...
.nowarnend
		...
		CMU.CMII.i32 i5 i7
	 	PEU.PC1C NEQ				|| LSU0.ST.32 i6,i17                 || IAU.ADD i17 i17 4
...
.size mvcvConvolution5x5s4hhhh_asm,.-mvcvConvolution5x5s4hhhh_asm
.end
