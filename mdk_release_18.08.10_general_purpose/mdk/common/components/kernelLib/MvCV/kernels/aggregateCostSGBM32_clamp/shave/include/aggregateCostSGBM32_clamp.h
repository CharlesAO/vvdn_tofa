#ifndef __AGGREGATE_COST_SGBM_32_CLAMP__
#define __AGGREGATE_COST_SGBM_32_CLAMP__

#include <mv_types.h>
#include <mvcv_macro.h>

//!@{
/// mvcvAggregateCostSGBM32_clamp 	- computes aggregated cost over a given path considering min2, penaltyP1 and penaltyP2 previously computed
...
MVCV_FUNC(void, mvcvAggregateCostSGBM32_clamp, u8* input1, u8* input2, u8* output, u16 penaltyP1, u16 penaltyP2, u8 min2, u8 activateClamp)
//!@}
	
#endif //__AGGREGATE_COST_SGBM_32_CLAMP__