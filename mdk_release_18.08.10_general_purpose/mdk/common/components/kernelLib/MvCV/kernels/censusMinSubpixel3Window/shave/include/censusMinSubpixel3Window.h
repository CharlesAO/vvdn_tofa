#ifndef __CENSUS_MIN_SUBPIXEL_3_WINDOW__
#define __CENSUS_MIN_SUBPIXEL_3_WINDOW__
...
MVCV_FUNC(void, mvcvCensusMinSubpixel3Window, u8 *in, half *out, u8 *outm, u32 width)
//!@}
    
#endif //__CENSUS_MIN_SUBPIXEL_3_WINDOW__
