...
///
/// @brief     boxfilter13x13 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvBoxfilter13x13(inLines, outLines, normalize, width);
	#else
	mvcvBoxfilter13x13_asm(inLines, outLines, normalize, width);
	#endif
