#ifndef __CONVOLUTION11x11S2XXHX_H__
#define __CONVOLUTION11x11S2XXHX_H__
#include <mv_types.h>
...
MVCV_FUNC(void, mvcvConvolution11x11s2xxhx, u8** in, u8** out, u8 conv[121], u32 inWidth)
//!@}


#endif //__CONVOLUTION11x11S2XXHX_H__
