...
///
/// @brief     Convolution11x11s2xxhx kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution11x11s2xxhx(inLines, outLines, conv, width);
	#else
	mvcvConvolution11x11s2xxhx_asm(inLines, outLines, conv, width);
	#endif
