...
LSU0.ST.32  i23  i19 
	lsu0.ldil i0, cvtColorKernelRGBToYUV_mask || lsu1.ldih i0, cvtColorKernelRGBToYUV_mask 
	LSU0.LD.64.L v23, i0 || IAU.ADD i0 i0 8
	LSU0.LD.64.H v23, i0
	
	lsu0.ldil i12, cvtColorKernelRGBToYUV_RGB2YUV_coefs || lsu1.ldih i12, cvtColorKernelRGBToYUV_RGB2YUV_coefs  || iau.sub i19, i19, 12
	...
	lsu0.ldil i8, cvtColorKernelRGBToYUV_main_loop     || lsu1.ldih i8, cvtColorKernelRGBToYUV_main_loop
...
nop
 cvtColorKernelRGBToYUV_main_loop:
		//                             save i0
...
LSU0.LD.32  i20  i19 || IAU.ADD i19 i19 4
	...
	bru.jmp i30
nop 6
.size mvcvCvtColorKernelRGBToYUV_asm,.-mvcvCvtColorKernelRGBToYUV_asm
.end
