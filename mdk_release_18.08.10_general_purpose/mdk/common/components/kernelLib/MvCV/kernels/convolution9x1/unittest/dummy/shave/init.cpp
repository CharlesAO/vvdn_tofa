...
///
/// @brief     Convolution9x1 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution9x1(inLines, outLines, conv, width);
	#else
	mvcvConvolution9x1_asm(inLines, outLines, conv, width);
	#endif
