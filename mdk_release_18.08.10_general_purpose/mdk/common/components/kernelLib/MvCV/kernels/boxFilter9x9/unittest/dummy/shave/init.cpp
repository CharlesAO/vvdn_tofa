...
///
/// @brief     boxfilter9x9 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvBoxfilter9x9(inLines, outLines, normalize, width);
	#else
	mvcvBoxfilter9x9_asm(inLines, outLines, normalize, width);
	#endif
