...
class BoxFilter5x5KernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(BoxFilter5x5KernelTest, TestUniformInputLines32)
{
	...
	mvcvBoxfilter5x5(inLinesOffseted, outLinesC, 1, width);
...
TEST_F(BoxFilter5x5KernelTest, TestUniformInputLines32Unnormalized)
{
	...
	inLinesOffseted = inputGen.GetOffsettedLines(inLines, 5, 8);
	mvcvBoxfilter5x5(inLinesOffseted, outLinesC, 0, width);
