...
///
/// @brief     accumulateFp16MaxPool3s1 kernel function call for unitary test
///
...
int main( void )
{
	...
	outLines = (half**)outLine;
		...
		mvcvAccumulateFp16MaxPool3s1(outLines, inLines, width);
	#else   
		mvcvAccumulateFp16MaxPool3s1_asm(outLines, inLines, width);
	#endif
