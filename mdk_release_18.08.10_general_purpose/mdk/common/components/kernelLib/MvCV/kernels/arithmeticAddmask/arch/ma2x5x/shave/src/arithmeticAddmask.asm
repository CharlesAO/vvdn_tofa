...
.type mvcvArithmeticAddmask_asm,@function
.version 00.51.04

.data .data.arithmeticAddmask
.align 4
.code .text.arithmeticAddmask

//void arithmeticAddmask(u8** src1, u8** src2, u8** dst, u8** mask, u32 width) 
//					       i18         i17       i16       i15         i14
mvcvArithmeticAddmask_asm:
.nowarn		
	...
	nop 5
	lsu1.ldil i5 arithmeticAddmask_loop || lsu0.ldih i5 arithmeticAddmask_loop 
	LSU0.ldil i7 arithmeticAddmask_final || LSU1.ldih i7 arithmeticAddmask_final || iau.sub i19 i19 0x40
	LSU0.ldil i8 arithmeticAddmask_compensate || LSU1.ldih i8 arithmeticAddmask_compensate 
	nop 5
	...
	LSU0.LDO.64.L v15 i15 0    || LSU1.LDO.64.H v15 i15 8 || iau.add i15 i15 16 || bru.rpl i5 i1 _end_delay_loop_arithmeticAddmask
	...
	LSU0.LDO.64.L v16 i15 0    || LSU1.LDO.64.H v16 i15 8  || iau.add i15 i15 16 || VAU.IADDS.U8 v9 v1 v2
	...
	peu.pvl18 gt || lsu1.sto.64.h v9 i16 8 || iau.add i16 i16 16 || VAU.IADDS.U8 v10 v3 v4
	...
	peu.pvl18 gt || lsu1.sto.64.h v10 i16 8 || iau.add i16 i16 16 || VAU.IADDS.U8 v11 v5 v6 
	
	cmu.cmz.i8 v15 || LSU1.LDXV v4 i17   || iau.add i17 i17 16
 arithmeticAddmask_loop:

	peu.pvl08 gt || lsu0.sto.64.l v11 i16 0 || cmu.alignvec v19 v15 v0 8
	cmu.cmz.i8 v19 || LSU0.LDXV v14 i15  || iau.add i15 i15 16
	peu.pvl18 gt || lsu1.sto.64.h v11 i16 8 || iau.add i16 i16 16 || VAU.IADDS.U8 v12 v7 v8
	...
	_end_delay_loop_arithmeticAddmask:
 ...
 arithmeticAddmask_compensate:
	nop 4
	LSU0.LDO.64.L v7  i18 0    || LSU1.LDO.64.H v7  i18 8  || iau.add i18 i18 16  || VAU.IADDS.U8 v9 v1 v2
	LSU0.LDO.64.L v8  i17 0    || LSU1.LDO.64.H v8  i17 8  || iau.add i17 i17 16  || VAU.IADDS.U8 v10 v3 v4
	
	VAU.IADDS.U8 v11 v5 v6 || lsu0.ldil i6 arithmeticAddmask_loop2 || lsu1.ldih i6 arithmeticAddmask_loop2 || iau.sub i15 i15 0x20  
	sau.sub.i32 i9 i19 0 
	nop 4
	LSU0.STO.64.L v9 i9 0 || LSU1.STO.64.H v9 i9 8 || VAU.IADDS.U8 v12 v7 v8
 ...
 arithmeticAddmask_final:
    BRU.jmp i30
    iau.add i19 i19 0x40
	nop 5
.nowarnend
.size mvcvArithmeticAddmask_asm,.-mvcvArithmeticAddmask_asm
.end
