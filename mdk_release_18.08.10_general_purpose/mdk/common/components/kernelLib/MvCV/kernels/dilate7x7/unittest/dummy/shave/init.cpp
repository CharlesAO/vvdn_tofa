...
int main( void )
{
	...
	mvcvDilate7x7(src, dst, kernelLines, width);
	#else
		#ifdef MOVICOMPILE_OPTIMIZED
		mvcvDilate7x7_opt(src, dst, kernelLines, width);
		#else
                mvcvDilate7x7_asm(src, dst, kernelLines, width);
