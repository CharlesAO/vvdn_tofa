.type mvcvGaussVx2_asm,@function
.version 00.50.00
///
/// @file
...
lsu0.ldil i8, gaussVx2__GaussDownV_Loop   ||lsu1.ldih i8, gaussVx2__GaussDownV_Loop ||CMU.CPIVR.x16 v16, i9
iau.incs i16, -1
...
.lalign
 ...
 gaussVx2__GaussDownV_Loop:
 bru.rpl i8, i7 || LSU0.LDI.128.U8.U16 v0, i0
VAU.MACPZ.u16 v0, v18           ||LSU0.LDI.128.U8.U16 v1, i1
VAU.MACP.u16  v1, v17           ||LSU0.LDI.128.U8.U16 v2, i2
VAU.MACP.u16  v2, v16           ||LSU0.LDI.128.U8.U16 v3, i3    ||CMU.VSZM.BYTE v7, v7, [Z3Z1]
VAU.MACP.u16  v3, v17           ||LSU0.LDI.128.U8.U16 v4, i4    ||LSU1.STI.128.U16.U8 v7, i17
VAU.MACPW.u16 v7, v18, v4
NOP //myriad2
//// end loop
BRU.JMP i30
...
.size mvcvGaussVx2_asm,.-mvcvGaussVx2_asm
.end
