...
.type mvcvHarrisResponse_asm,@function
.version 00.50.00
...
mvcvHarrisResponse_asm:
IAU.SUB i19 i19 8 || Sau.sub.i32 i3, i16, RADIUS
LSU0.ST.64.l v24  i19  || IAU.SUB i19 i19 8
LSU0.ST.64.h v24  i19  || iau.sub i2, i17, RADIUS
...
.size mvcvHarrisResponse_asm,.-mvcvHarrisResponse_asm
.end
