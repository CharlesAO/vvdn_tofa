...
///
/// @brief     Convolution7x1 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution7x1(inLines, outLines, conv, width);
	#else
	mvcvConvolution7x1_asm(inLines, outLines, conv, width);
	#endif
