...
.type mvcvWarpMeshSample8bitStride_asm,@function
.version 00.51.04

.data .data.warpMeshSample8bitStride
.align 4

.code .text.warpMeshSample8bitStride
//void mvcvwarpMeshSample8bitStride(unsigned char *tile, unsigned char * out_tile, half *mx, half *my, unsigned int tile_width, unsigned int tile_height)
//                                  i18                      i17               i16           i15                 i14                     i13

mvcvWarpMeshSample8bitStride_asm:
.nowarn 12,10
...
lsu0.ldil i1 0x4  || lsu1.ldih i1 0x4 || iau.sub i14 i14 8
cmu.cpivr.x32 v24 i1  || lsu0.ldil i2 0x4  || lsu1.ldih i2 0x0
cmu.cpivr.x32 v25 i2  || iau.xor i1 i1 i1 || vau.xor v31 v31 v31




cmu.cpvv.f16.i16s  v10 v0 || lsu0.ldih i1 8
cmu.cpvv.f16.i16s  v11 v2 || iau.or i14 i14 i1
cmu.cpvv.i16.f16 v12 v10 || lsu0.cp v31.0 i19
cmu.cpvv.i16.f16 v13 v11  || vau.mul.i16 v1 v24 v11 || lsu0.cp i19 i14
...
cmu.SHRIV.x32  v1 v1 i10  || lsu0.ldil i0 mvcvWarpMeshSample8bitStride_loop  || lsu1.ldih i0 mvcvWarpMeshSample8bitStride_loop
...
LSU0.ld.64  i20  i4     || lsu1.cp i3 v17.1                                         ||  cmu.cpivd v30.2 i13 || iau.xor i0 i0 i0
LSU0.ld.64  i22  i5     || lsu1.cp i4 v17.2                                         ||  cmu.cpivd v27.0 i20 || iau.add i0 i0 0xff
LSU0.ld.64  i24  i6     || lsu1.cp i5 v17.3                                         ||  cmu.cpivd v27.2 i22 || iau.rol i0 i0 8
LSU0.ld.64  i26  i7     || lsu1.cp i6  v9.0                                         ||  CMU.VDILV.x16 v19 v23 v30 v27 || iau.add i0 i0 0xff
LSU0.ld.64  i28  i8     || lsu1.cp i7  v9.1                                         ||  cmu.cpivd v28.0 i24
LSU0.ld.64  i30  i9                                      || iau.add i11 i11  i2   ||  cmu.cpivd v28.2 i26  ||  lsu1.cp v30.3 i31
LSU0.LD.128.u8.f16   v14 i11   	                         || iau.add i13 i13  i3   ||  cmu.cpivd v30.0 i28  ||  lsu1.cp v30.2 i30
LSU0.LD.128.u8.f16   v14 i13 	                         || iau.add i20 i20  i4   || CMU.VDILV.x16 v20 v25 v28 v30
...
LSU0.LD.128.u8.f16   v14 i31     || lsu1.cp  i24 v14.0                            || cmu.SHRIV.x32  v10 v10 i10     || vau.sub.f16 v16 v0 v12 || iau.rol i19 i19 16
mvcvWarpMeshSample8bitStride_loop:

                                    lsu1.cp  i25 v14.0                            || cmu.cpvv v15 v29                || LSU0.LDo.64.l v0  i16 0 || vau.sub.f16 v29 v2 v13                   //frac x

                                    lsu1.cp  i26 v14.0                            || cmu.cpvv  v8 v7                 || LSU0.LDo.64.h v0  i16 8 || iau.and i1 i19 i0
                                    ...
                                    lsu1.cp  i31 v14.0                            || lsu0.st.128.f16.u8 v25 i17 || cmu.cpvid  i8 v6.2 || vau.sub.f16  v7 v26  v29 || iau.add i17 i17 i1
    ...
    nop 6
.nowarnend
.size mvcvWarpMeshSample8bitStride_asm,.-mvcvWarpMeshSample8bitStride_asm
.end
