...
int main( void )
{
	...
	//printf("%x %x\n", input_tile, output_tile);
		...
		mvcvWarpMeshSample8bitStride(tile, output_tile, mx, my, tile_width, tile_height);
	#else
		mvcvWarpMeshSample8bitStride_asm(tile, output_tile, mx, my, tile_width, tile_height);
	#endif
