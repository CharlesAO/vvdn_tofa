...
//--------------------------------------------------------------------------------------------------------------
.type mvcvCornerMinEigenVal_asm,@function
.version 00.50.05
.data .rodata.CornerMinEigenVal 
.align 16
 cornerMinEigenVal_multiply:
...
mvcvCornerMinEigenVal_asm:
//CornerMinEigenVal(u8 **in_lines, u8 **out_line, u8 *buff u32 width)//
//                     i18               i17        i16        i15
	IAU.SUB i19 i19 8
	...
	lsu0.ldil i14, cornerMinEigenVal_multiply     ||  lsu1.ldih i14, cornerMinEigenVal_multiply
...
lsu0.ldil i13, cornerMinEigenVal_loop     ||  lsu1.ldih i13, cornerMinEigenVal_loop
...
lsu0.ldil i13, cornerMinEigenVal_loop2     ||  lsu1.ldih i13, cornerMinEigenVal_loop2							
...
CMU.CLAMP0.f32 v19 v19 v28
nop
 cornerMinEigenVal_loop2:
CMU.CPVV.f32.i32s v20 v19
nop 
CMU.CPVi.x32 i20  v20.0
CMU.CPVi.x32 i21  v20.1 || lsu0.sti.8 i20 i17
CMU.CPVi.x32 i22  v20.2 || lsu0.sti.8 i21 i17
CMU.CPVi.x32 i23  v20.3 || lsu0.sti.8 i22 i17
lsu0.sti.8 i23 i17
...
nop 6
	...
	bru.jmp i30
nop 6
.size mvcvCornerMinEigenVal_asm,.-mvcvCornerMinEigenVal_asm
.end
