...
//    mvcvLUT10to8_asm(u16** src, u8** dest, const u16* lut, u32 width, u32 height);
//
...
//    void mvcvLUT10to8(u16** src, u8** dest, const u16* lut, u32 width, u32 height);
//
...
TEST_F(LookupTable10to8Test, TestUniformInputLinesAll0)
{
    ...
    mvcvLUT10to8(inLines, outLinesC, lut, width, 1);
