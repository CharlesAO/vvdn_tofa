#ifndef __LOOKUPTABLE10TO8_H__
#define __LOOKUPTABLE10TO8_H__
#include <mv_types.h>
...
MVCV_FUNC(void, mvcvLUT10to8, u16** src, u8** dest, const u8* lut, u32 width, u32 height)
//!@}

#endif //__LOOKUPTABLE10TO8_H__