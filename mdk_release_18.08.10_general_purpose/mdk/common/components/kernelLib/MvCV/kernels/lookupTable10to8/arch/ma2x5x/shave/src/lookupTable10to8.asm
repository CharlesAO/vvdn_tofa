...
.type mvcvLUT10to8_asm,@function
.version 00.50.34.0
...
IAU.SUB i19 i19 4 || lsu0.ldil i1, lookupTable10to8_loop_end  || lsu1.ldih i1, lookupTable10to8_loop_end
...
lsu0.ldil i24, lookupTable10to8_compensate  || lsu1.ldih i24, lookupTable10to8_compensate
...
nop 6
 ...
 lookupTable10to8_pre_processing:
...
nop
 lookupTable10to8_compensate:
nop 2
    lsu0.ldil i1 lookupTable10to8_loop  || lsu1.ldih i1 lookupTable10to8_loop
	lsu0.ldil i4 lookupTable10to8_final || lsu1.ldih i4 lookupTable10to8_final
...
nop 6
.nowarnend
.size mvcvLUT10to8_asm,.-mvcvLUT10to8_asm
.end
