...
///
/// @brief     convSeparable11x11 Fp16ToFp16 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvSeparable11x11Fp16ToFp16(outLines, inLines, conv, width);
	#else
	mvcvConvSeparable11x11Fp16ToFp16_asm(outLines, inLines, conv, width);
	#endif
