...
int main( void )
{
//	void cvtColorRGBtoNV12_asm(u8** inR, u8** inG, u8** inB, u8** yOut, u8** uvOut, u32 width, u32 k) 
	...
	mvcvCvtColorRGBtoNV12(inLinesR, inLinesG, inLinesB, outLinesY, outLinesUV, width, line);
	#else
	mvcvCvtColorRGBtoNV12_asm(inLinesR, inLinesG, inLinesB, outLinesY, outLinesUV, width, line);
	#endif
