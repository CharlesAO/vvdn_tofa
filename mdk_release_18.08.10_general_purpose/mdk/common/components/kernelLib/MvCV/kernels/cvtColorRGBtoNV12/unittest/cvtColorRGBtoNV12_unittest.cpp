...
#include "cvtColorRGBtoNV12.h"
#include "cvtColorRGBtoNV12_asm_test.h"
...
class cvtColorRGBtoNV12Test : public ::testing::Test {
protected:
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput0)
{
	width = 8;
	line = 0;
	...
	mvcvCvtColorRGBtoNV12(inLineR, inLineG, inLineB, outLineC_Y, outLineC_UV, width, line);	
	cvtColorRGBtoNV12_asm_test(inLineR, inLineG, inLineB, outLineAsm_Y, outLineAsm_UV, width, line);	
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput0Oddline)
{
	width = 8;
	line = 1;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput255)
{
	width = 8;
	line = 0;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput255OddLine)
{
	width = 8;
	line = 3;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput128)
{
	width = 8;
	line = 0;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput128OddLine)
{
	width = 8;
	line = 3;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput43)
{
	width = 8;
	line = 0;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput43OddLine)
{
	width = 8;
	line = 3;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput96width32)
{
	width = 32;
	line = 0;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestUniformInput96width32OddLine)
{
	width = 32;
	line = 3;
	inputGen.SelectGenerator("uniform");
...
TEST_F(cvtColorRGBtoNV12Test, TestRandomInput)
{
	width = 8;
	line = 0;
...
TEST_F(cvtColorRGBtoNV12Test, TestRandomInputOddLine)
{
	width = 8;
	line = 3;
	inputGen.SelectGenerator("random");
...
TEST_F(cvtColorRGBtoNV12Test, TestRandomInputWidth16)
{
	width = 16;
	line = 0;
	inputGen.SelectGenerator("random");
...
TEST_F(cvtColorRGBtoNV12Test, TestRandomInputWidth16OddLine)
{
	width = 16;
	line = 3;
	inputGen.SelectGenerator("random");
...
TEST_F(cvtColorRGBtoNV12Test, TestRandomInputWidth88)
{
	width = 88;
	line = 0;
	inputGen.SelectGenerator("random");
...
TEST_F(cvtColorRGBtoNV12Test, TestRandomInputWidth88OddLine)
{
	width = 88;
	line = 3;
	inputGen.SelectGenerator("random");
...
TEST_F(cvtColorRGBtoNV12Test, TestRandomInputMaxWidth)
{
	width = 1920;
	line = 0;
	inputGen.SelectGenerator("random");
...
TEST_F(cvtColorRGBtoNV12Test, TestRandomInputMaxWidthOddLine)
{
	width = 1920;
	line = 3;
	inputGen.SelectGenerator("random");
