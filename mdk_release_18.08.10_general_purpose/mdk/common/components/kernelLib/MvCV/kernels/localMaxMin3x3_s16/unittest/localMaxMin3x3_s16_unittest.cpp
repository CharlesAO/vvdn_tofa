...
#include "localMaxMin3x3_s16_asm_test.h"
...
protected:
    ...
    unsigned int candidateLocationIn[640];
...
TEST_F(localMaxMin3x3Test, TestUniformInputLine)
{
    ...
    inLines[0] = (short*)inputGen.GetLineU16(width + PADDING, 0.5);
    inLines[1] = (short*)inputGen.GetLineU16(width + PADDING, 0.5);
    inLines[2] = (short*)inputGen.GetLineU16(width + PADDING, 0.5);
   ...
   for(i=0;i<width;i++)
    ...
    localMaxMin3x3_s16_asm_test(inLines, candidateLocationIn, width/2, minLocationList_asm, maxLocationList_asm, &minCount_asm, &maxCount_asm);
    mvcvLocalMaxMin3x3_s16(inLines_c, candidateLocationIn, width/2, minLocationList_c,  maxLocationList_c, &minCount_c, &maxCount_c);
...
TEST_F(localMaxMin3x3Test, TestUniformInputLine2)
{
    ...
    inLines[0] = (short*)inputGen.GetLineU16(width + PADDING, 10);
    inLines[1] = (short*)inputGen.GetLineU16(width + PADDING, 10);
    inLines[2] = (short*)inputGen.GetLineU16(width + PADDING, 10);
    inLines_c[0] = inLines[0] + PADDING/2;
    inLines_c[1] = inLines[1] + PADDING/2;
    inLines_c[2] = inLines[2] + PADDING/2;
...
TEST_F(localMaxMin3x3Test, TestRandomInputLine)
{
    ...
    inLines[0] = (short*)inputGen.GetLineU16(width + PADDING, -255, 255);
    inLines[1] = (short*)inputGen.GetLineU16(width + PADDING, -255, 255);
    inLines[2] = (short*)inputGen.GetLineU16(width + PADDING, -255, 255);
    inLines_c[0] = inLines[0] + PADDING/2;
    inLines_c[1] = inLines[1] + PADDING/2;
    inLines_c[2] = inLines[2] + PADDING/2;
