...
class BoxFilter3x3KernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(BoxFilter3x3KernelTest, TestUniformInputLines32)
{
	...
	mvcvBoxfilter3x3(inLinesOffseted, outLinesC, 1, width);
...
TEST_F(BoxFilter3x3KernelTest, TestRandomWidthRandomData)
{
	...
	//outputChecker.DumpArrays("refOutput", "refOutput.c", outLinesAsm, width , 1);
}
...
TEST_F(BoxFilter3x3KernelTest, TestUniformInputLines32Unnormalized)
{
	...
	mvcvBoxfilter3x3(inLinesOffseted, outLinesC, 0, width);
