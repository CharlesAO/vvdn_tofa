...
//--------------------------------------------------------------------------------------------------------------
.type mvcvBoxfilter3x3_asm,@function
.version 00.50.05
.data .rodata.vect_mask 
.align 16
 boxFilter3x3_vect_mask:
		.float16    0.1111
 boxFilter3x3_vect_mask2:
		.short    1
...
lsu0.ldil i7, boxFilter3x3_vect_mask     ||  lsu1.ldih i7, boxFilter3x3_vect_mask
LSU0.ldil i6, boxFilter3x3_unormalizedFunction || LSU1.ldih i6, boxFilter3x3_unormalizedFunction
lsu0.ld.16r v23, i7	
nop 2
iau.sub i0, i0, 1
...
CMU.CMZ.i32 i16 ||lsu0.ldil i5, boxFilter3x3_loop0     ||  lsu1.ldih i5, boxFilter3x3_loop0	
PEU.PC1C EQ || BRU.JMP i6	||lsu0.ldil i5, boxFilter3x3_loop1     ||  lsu1.ldih i5, boxFilter3x3_loop1
...
nop
 ...
 boxFilter3x3_normalizedFunction:
.align 16  
//// start loop 
.lalign 
...
PEU.PC1C GT || LSU0.STi.128.f16.u8 v16 i17
 ...
 boxFilter3x3_unormalizedFunction:
.align 16  
//// start loop  
.nowarn
bru.rpl i5 i3                  ||VAU.ADD.i16  v7, v0, v1   ||cmu.cpvv v9, v6                ||LSU0.LDi.128.u8.u16 v0 i0 
...
.size mvcvBoxfilter3x3_asm,.-mvcvBoxfilter3x3_asm
.end
