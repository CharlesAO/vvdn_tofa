...
///
/// @brief     Convolution9x9s3hhhh kernel function call for unitary test
///
...
int main( void )
{
    ...
    mvcvConvolution9x9s3hhhh(inLines, outLines, conv, width);
    #else
    mvcvConvolution9x9s3hhhh_asm(inLines, outLines, conv, width);
    #endif
