...
.type mvcvConvolution9x9s3hhhh_asm,@function
.version 00.50.01

.data .data.convolution9x9s3hhhh
.align 16

.code .text.convolution9x9s3hhhh

//void Convolution9x9s3hhhh_asm(u8** in(i18), u8** out(i17), half conv[81](i16), u32 inWidth(i15))
mvcvConvolution9x9s3hhhh_asm:

    IAU.SUB i19 i19 8       || LSU0.LDIL i10 convolution9x9s3hhhh_loop  || LSU1.LDIH i10 convolution9x9s3hhhh_loop
    ...
    LSU0.ST.64.H v27  i19   || IAU.SUB i19 i19 8        || LSU1.LDo.64.l v11 i16 0x10       || SAU.XOR i13 i13 i13
    LSU0.ST.64.L v28  i19   || IAU.SUB i19 i19 8        || LSU1.LDo.64.h v11 i16 0x18       || SAU.XOR i12 i12 i12
    LSU0.ST.64.H v28  i19   || IAU.SUB i19 i19 8        || LSU1.LDo.64.l v12 i16 0x20       || SAU.XOR i11 i11 i11
    LSU0.ST.64.L v30  i19   || IAU.SUB i19 i19 8        || LSU1.LDo.64.h v12 i16 0x28
    ...
    LSU0.LDo.64.l v14 i16 0x40                          || LSU1.LDo.64.h v14 i16 0x48       || IAU.SUB i2 i2 16 || SAU.ADD.i32 i12 i12 24
    ...
    LSU0.LDo.64.l v29 i16 0xA0                          || LSU1.LD.32 i17 i17               || IAU.SUB i8 i8 16 || SAU.DIV.u32 i12 i15 i12
    ...
    VAU.MACPZ.f16 v10 v9    || LSU0.SWZV8 [00000000]    || CMU.ALIGNVEC v9 v0 v20 10    || BRU.RPL i10 i12
    ...
    VAU.MACPW.f16 v30 v29 v9 || LSU0.SWZV8 [00000000]   || IAU.INCS i15 -8
    CMU.CMZ.i32 i13
    CMU.CPVI.x16 i11.l v30.2
    LSU0.STi.16 i11 i17   || PEU.PC1C gt
    CMU.CPVI.x16 i11.l v30.5
    LSU0.STi.16 i11 i17   || PEU.PC1C gt
    nop
    LSU0.LD.64.L v20 i0      || LSU1.LDO.64.H v20 i0 0x08   ||  IAU.ADD i0 i0 16
    CMU.ALIGNVEC v9 v0 v20 8 || IAU.INCS i13 1
    nop

    VAU.MACPZ.f16 v10 v9    || LSU0.SWZV8 [00000000]    || CMU.ALIGNVEC v9 v0 v20 10
    VAU.MACP.f16  v10 v9    || LSU0.SWZV8 [11111111]    || CMU.ALIGNVEC v9 v0 v20 12
    VAU.MACP.f16  v10 v9    || LSU0.SWZV8 [22222222]    || CMU.ALIGNVEC v9 v0 v20 14
    VAU.MACP.f16  v10 v9    || LSU0.SWZV8 [33333333]    || CMU.CPVV v0 v20
    VAU.MACP.f16  v10 v0    || LSU0.SWZV8 [44444444]    || CMU.ALIGNVEC v9 v0 v20  2
    ...
    VAU.MACPW.f16 v30 v29 v9 || LSU0.SWZV8 [00000000]   || IAU.INCS i15 -8
    CMU.CPVI.x16 i11.l v30.0
    LSU0.STi.16 i11 i17
    CMU.CPVI.x16 i11.l v30.3
    LSU0.STi.16 i11 i17
    CMU.CPVI.x16 i11.l v30.6
    LSU0.STi.16 i11 i17
    LSU0.LD.64.L v20 i0      || LSU1.LDO.64.H v20 i0 0x08   ||  IAU.ADD i0 i0 16
    CMU.ALIGNVEC v9 v0 v20 8
    nop
    ...
    CMU.CPVI.x16 i11.l v30.1
    LSU0.STi.16 i11 i17

    convolution9x9s3hhhh_loop:
    CMU.CPVI.x16 i11.l v30.4
    LSU0.STi.16 i11 i17
    CMU.CPVI.x16 i11.l v30.7
    LSU0.STi.16 i11 i17
    LSU0.LD.64.L v20 i0      || LSU1.LDO.64.H v20 i0 0x08   ||  IAU.ADD i0 i0 16
    CMU.ALIGNVEC v9 v0 v20 8
    nop
...
// Compensate for width = N * 24 + 8 or width = N *24 + 16
    ...
    CMU.CMZ.i32 i15
    CMU.CPVI.x16 i11.l v30.1
    LSU0.STi.16 i11 i17   || PEU.PC1C eq
    CMU.CPVI.x16 i11.l v30.4
    LSU0.STi.16 i11 i17   || PEU.PC1C eq
    CMU.CPVI.x16 i11.l v30.7
   LSU0.STi.16 i11 i17   || PEU.PC1C gt
...
.size mvcvConvolution9x9s3hhhh_asm,.-mvcvConvolution9x9s3hhhh_asm
.end
