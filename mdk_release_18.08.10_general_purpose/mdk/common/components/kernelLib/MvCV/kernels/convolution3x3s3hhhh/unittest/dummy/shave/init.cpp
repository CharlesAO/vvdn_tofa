...
///
/// @brief     Convolution3x3s3hhhh kernel function call for unitary test
///
...
int main( void )
{
	...
	outLines 	= (half**)outLine;
		...
		mvcvConvolution3x3s3hhhh(inLines, outLines, conv, width);
        #else
		mvcvConvolution3x3s3hhhh_asm(inLines, outLines, conv, width);
