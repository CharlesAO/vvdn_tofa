...
.type mvcvEqualizeHist_asm,@function
.version 00.51.04
...
nop 6
LSU0.ldil i1, equalizeHist_loop  || LSU1.ldih i1, equalizeHist_loop //loop for processing loop
iau.add i29 i17 i15
lsu0.ld.32 i30 i29
nop 2
...
LSU0.ldil i24, equalizeHist_small  || LSU1.ldih i24, equalizeHist_small //jump if width is smaller then 49
...
LSU0.LDIL i1 equalizeHist_compensation || LSU1.LDIH i1 equalizeHist_compensation //loop for R-plane
IAU.SUB i10 i10 i10

CMU.CMII.i32 i15 i23 //see if the width is smaller then 49
PEU.PC1C LT || IAU.SUB i28  i15 0

 equalizeHist_compensation:
...
NOP 6
.nowarnend
.size mvcvEqualizeHist_asm,.-mvcvEqualizeHist_asm
.end
