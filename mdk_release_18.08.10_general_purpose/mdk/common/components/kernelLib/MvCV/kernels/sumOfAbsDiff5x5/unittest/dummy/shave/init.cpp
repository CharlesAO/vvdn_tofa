...
///
/// @brief    sumOfAbsDiff5x5 kernel function call for unitary test
///
...
//	void sumOfAbsDiff5x5(u8** in1, u8** in2, u8** out, u32 width)
	...
	mvcvSumOfAbsDiff5x5(inLines1, inLines2, outLines, width);
	#else
	mvcvSumOfAbsDiff5x5_asm(inLines1, inLines2, outLines, width);
	#endif
