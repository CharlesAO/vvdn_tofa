...
//--------------------------------------------------------------------------------------------------------------
.type mvcvCornerMinEigenVal_patched_asm,@function
.version 00.50.05
.data .rodata.CornerMinEigenVal_patched 
.align 16
 cornerMinEigenVal_patched_val:
...
mvcvCornerMinEigenVal_patched_asm:
IAU.SUB i19 i19 4
...
LSU0.ST.32  i31  i19 
//void CornerMinEigenVal_patched(u8 **in_lines, int posx, u8 *out_pix, u32 width)//
//                                  i18            i17        i16         i15
//CMU.CPTI    i14 P_CFG
...
lsu0.ldil i12, cornerMinEigenVal_patched_skip     ||  lsu1.ldih i12, cornerMinEigenVal_patched_skip
	lsu0.ldil i7, cornerMinEigenVal_patched_val     ||  lsu1.ldih i7, cornerMinEigenVal_patched_val
...
nop 2
 cornerMinEigenVal_patched_skip:
...
nop 6	
	bru.jmp i30
nop 6
.size mvcvCornerMinEigenVal_patched_asm,.-mvcvCornerMinEigenVal_patched_asm
.end
