...
///
/// @brief     Convolution1x5 kernel function call for unitary test
///
...
u32 width;
half conv[5] __attribute__ ((aligned (16)));
...
int main( void )
{
	...
	mvcvConvolution1x5(inLines, outLines, conv, width);
	#else
	mvcvConvolution1x5_asm(inLines, outLines, conv, width);
	#endif
