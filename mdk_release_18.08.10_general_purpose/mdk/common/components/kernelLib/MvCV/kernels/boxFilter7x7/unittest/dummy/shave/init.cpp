...
///
/// @brief     boxfilter7x7 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvBoxfilter7x7(inLines, outLines, normalize, width);
	#else
		#ifdef MOVICOMPILE_OPTIMIZED
		mvcvBoxfilter7x7_opt(inLines, outLines, normalize, width);
		#else
		mvcvBoxfilter7x7_asm(inLines, outLines, normalize, width);
		#endif
	#endif
