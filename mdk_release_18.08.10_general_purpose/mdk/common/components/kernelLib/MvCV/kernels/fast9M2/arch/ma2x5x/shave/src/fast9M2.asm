...
bru.rpl i14, i13, fast9M2BitFlag_end_loop  	||cmu.cpvi.x32 i0, v0.0						||lsu0.ldi.32r v20, i17 		||lsu1.cp i18, v7.3 
...
.nowarnend
.size mvcvFast9M2_asm,.-mvcvFast9M2_asm
.end
