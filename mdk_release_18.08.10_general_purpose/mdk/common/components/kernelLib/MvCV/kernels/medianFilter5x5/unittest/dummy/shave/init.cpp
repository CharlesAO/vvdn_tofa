...
///
/// @brief     medianFilter3x3 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvMedianFilter5x5(widthLine, outLines, inLines);
	#else
	mvcvMedianFilter5x5_asm(widthLine, outLines, inLines);
	#endif
