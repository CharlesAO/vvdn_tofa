...
// Median denoise
.type mvcvMedianFilter5x5_asm,@function
.version 0.50
.ifndef MEDIAN_CFG
.set MEDIAN_CFG 1
.set StackPtr	 	i19
...
CMU.CPZV v24, 0x3 || LSU1.LDIL i20, medianFilter5x5_Median_HistogramRow	||	LSU0.LDIL i23, medianFilter5x5_Restore_And_Exit
CMU.CPZV v28, 0x3 || LSU1.LDIH i20, medianFilter5x5_Median_HistogramRow	||	LSU0.LDIH i23, medianFilter5x5_Restore_And_Exit



.lalign
 medianFilter5x5_Median_HistogramCol:
BRU.RPS i20, MED_KWIDTH || LSU0.LDI.8 i21, i1
nop
nop
nop
nop
 medianFilter5x5_Median_HistogramRow:
CMU.CMZ.i32 i22
nop
...
nop
PEU.PC1C 0x6 || BRU.BRA medianFilter5x5_Median_HistogramCol
PEU.PC1C 0x6 || BRU.RFB16.I 0x01 || IAU.SUB i22, i22, 0x01
PEU.PC1C 0x6 || IAU.SUB i1, i1, (MED_KWIDTH>>1)
PEU.PC1C 0x6 || LSU1.LDIL i20, medianFilter5x5_Median_HistogramRow
PEU.PC1C 0x6 || LSU1.LDIH i20, medianFilter5x5_Median_HistogramRow
PEU.PC1C 0x1 || BRU.RFB16.Z 0
nop

.lalign

 medianFilter5x5_Median_Loop:
...
PEU.PC1I 0x6  || LSU0.LDI.8 i10, i1
PEU.PC1I 0x6  || LSU0.LDO.8 i11, i2, -MED_KWIDTH
PEU.PC1I 0x6  || LSU0.LDI.8 i12, i2
PEU.PC1I 0x6  || LSU0.LDO.8 i13, i3, -MED_KWIDTH
PEU.PC1I 0x6  || LSU0.LDI.8 i14, i3
nop
CMU.LUT.U8 i20, i21, 0x2
nop
IAU.SUBSU i20, i20, 0x01
CMU.LUTW.X8    i20, i21, 0x2
CMU.LUT.U8 i15, i10, 0x2
nop
IAU.ADDSU i15, i15, 0x01
CMU.LUTW.X8    i15, i10, 0x2
CMU.LUT.U8 i6,  i11, 0x2
nop
IAU.SUBSU i6,  i6,  0x01
CMU.LUTW.X8    i6,  i11, 0x2
CMU.LUT.U8 i7,  i12, 0x2
nop
IAU.ADDSU i7,  i7,  0x01
CMU.LUTW.X8    i7,  i12, 0x2
CMU.LUT.U8 i8,  i13, 0x2     || LSU0.LDO.8 i21, i4, -MED_KWIDTH
nop
IAU.SUBSU i8,  i8,  0x01
CMU.LUTW.X8    i8, i13, 0x2
CMU.LUT.U8 i9,  i14, 0x2      || LSU0.LDI.8 i10, i4
nop
IAU.ADDSU i9,  i9,  0x01
CMU.LUTW.X8    i9, i14, 0x2
CMU.LUT.U8 i20, i21, 0x2      || LSU0.LDO.8 i11, i5, -MED_KWIDTH
nop
IAU.SUBSU i20, i20, 0x01
CMU.LUTW.X8    i20, i21, 0x2
CMU.LUT.U8 i15, i10, 0x2      || LSU0.LDI.8 i12, i5
nop
IAU.ADDSU i15, i15, 0x01
CMU.LUTW.X8    i15, i10, 0x2
CMU.LUT.U8 i6,  i11, 0x2
BRU.BRA medianFilter5x5_Median_Loop
IAU.SUBSU i6,  i6,  0x01
CMU.LUTW.X8    i6,  i11, 0x2
CMU.LUT.U8 i7,  i12, 0x2
nop
IAU.ADDSU i7,  i7,  0x01
CMU.LUTW.X8    i7,  i12, 0x2
 medianFilter5x5_Restore_And_Exit:
IAU.SUB i1 i1 i1
cmu.cpit B_RFB i1
...
BRU.JMP i30
NOP 6
.size mvcvMedianFilter5x5_asm,.-mvcvMedianFilter5x5_asm
.end
