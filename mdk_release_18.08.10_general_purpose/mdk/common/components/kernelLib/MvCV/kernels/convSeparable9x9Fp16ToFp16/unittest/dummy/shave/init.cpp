...
///
/// @brief     convSeparable9x9 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvSeparable9x9Fp16ToFp16(outLines, inLines, conv, width);
	#else
	mvcvConvSeparable9x9Fp16ToFp16_asm(outLines, inLines, conv, width);
	#endif
