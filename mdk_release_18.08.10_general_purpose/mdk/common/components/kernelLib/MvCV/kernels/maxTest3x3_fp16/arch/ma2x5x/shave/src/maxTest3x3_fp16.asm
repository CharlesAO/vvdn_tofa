...
.type mvcvMaxTest3x3_fp16_asm,@function
.version 00.51.05
//-------------------------------------------------------------------------------
//void mvcvMaxTest3x3_fp16_asm(fp16* inBufferCandidates, fp16** inBuffer, u32 width, u32 maxLocationsIn[], u32 maxLocationsOut[], u32 maxCountIn, u32* maxCountOut)
//                                    i18                        i17        i16         i15                    i14                   i13                 i12

.code .text.mvcvMaxTest3x3_fp16_asm
.align 16
 .nowarn
mvcvMaxTest3x3_fp16_asm:
...
LSU0.LDIL i11 maxTest3x3_fp16_maxTest_lastCandidate || LSU1.LDIH i11 maxTest3x3_fp16_maxTest_lastCandidate
IAU.SUB i16 i13 2
...
IAU.XOR i11 i11 i11
IAU.SUB i3 i2 2 || LSU0.LDIL i16 maxTest3x3_fp16_maxTest_loop_end || LSU1.LDIH i16 maxTest3x3_fp16_maxTest_loop_end
...
//cycle start // process two candidates in a cycle
    ...
    CMU.max.f16 v1 v1 v0 || LSU1.LD.16r v11 i3
    CMU.CPII i16 i0
    CMU.CPII i8 i1
    nop
 maxTest3x3_fp16_maxTest_loop_end:

    CMU.CMVV.f16 v1 v10 || LSU1.SWZV8 [22222210] || VAU.ALIGNBYTE v3 v3 v3 0
    PEU.PC8C.AND 0x4 || IAU.ADD i11 i11 1 || LSU1.STI.32 i16 i14 //it is a maxima store it
    LSU1.SWZV8 [66654210] || IAU.SHL i2 i0 1 || VAU.ALIGNBYTE v2 v2 v2 0
    CMU.max.f16 v2 v2 v3 || IAU.SUB i3 i2 2
    IAU.ADD i6 i3 i17 || VAU.XOR v1 v1 v1
    CMU.CMVV.f16 v2 v11 || IAU.ADD i7 i3 i10
    PEU.PC8C.AND 0x4 || IAU.ADD i11 i11 1 || LSU1.STI.32 i8 i14 //it is a maxima store it

 maxTest3x3_fp16_maxTest_lastCandidate:
IAU.AND i13 i13 i4 || LSU0.LDIL i1 maxTest3x3_fp16_maxTest_end || LSU1.LDIH i1 maxTest3x3_fp16_maxTest_end
...
CMU.max.f16 v1 v1 v0
nop 1
CMU.CMVV.f16 v1 v10
PEU.PC8C.AND 0x4 || IAU.ADD i11 i11 1 || LSU1.STI.32 i0 i14 //it is a maxima store it


 maxTest3x3_fp16_maxTest_end:
LSU0.ST.32 i11 i12 || BRU.JMP i30
nop 6
.size mvcvMaxTest3x3_fp16_asm,.-mvcvMaxTest3x3_fp16_asm
.nowarnend
.end
