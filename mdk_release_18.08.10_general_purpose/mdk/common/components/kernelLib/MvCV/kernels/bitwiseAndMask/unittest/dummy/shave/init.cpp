...
///
/// @brief     bitwiseAndMask kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvBitwiseAndMask(inLines1, inLines2, outLines, Mask, width);
	#else
	mvcvBitwiseAndMask_asm(inLines1, inLines2, outLines, Mask, width);
	#endif
