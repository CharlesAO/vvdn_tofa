...
.type mvcvBitwiseAndMask_asm,@function
.version 00.51.05
//-------------------------------------------------------------------------------	
.code .text.bitwiseAndMask
//	void bitwiseAndMask(	u8** src1Addr, 	u8** src2Addr, 	u8** dstAddr,	u8** maskAddr, 	u32 width)
//			   					i18				i17					i16				i15				i14
mvcvBitwiseAndMask_asm:
 .nowarn
	
	LSU0.LD.32 i18 i18 			|| LSU1.LD.32 i17 i17			|| IAU.SHR.u32 i0 i14 6
	LSU0.LD.32 i16 i16 			|| LSU1.LD.32 i15 i15			|| IAU.SHL i2, i0, 6
	LSU0.LDIL i1, bitwiseAndMask_loop 		|| LSU1.LDIH i1, bitwiseAndMask_loop	
	LSU0.LDIL i4, bitwiseAndMask_compensate || LSU1.LDIH i4, bitwiseAndMask_compensate	|| IAU.SUB i19 i19 0x40 
	LSU0.LDIL i10 16
	VAU.XOR v12 v12 v12
	NOP
	...
	IAU.SUB i3 i19 0
	LSU0.LDIL i6, bitwiseAndMask_compensate_loop 
	LSU1.LDIH i6, bitwiseAndMask_compensate_loop
	IAU.SUB i2, i14, i2
	NOP 2
	
	
	LSU1.LDXVi v0  i18  i10	|| BRU.RPL i1 i0
	LSU0.LDXVi v1  i17  i10	|| VAU.AND v8 v0 v1
	LSU1.LDXVi v2  i18  i10	
	LSU0.LDXVi v3  i17  i10	|| VAU.AND v9 v2 v3 
	LSU1.LDXVi v4  i18  i10 	 
	LSU0.LDXVi v5  i17  i10 || VAU.AND v10 v4 v5	
	LSU1.LDXVi v6  i18  i10 	
	LSU0.LDXVi v7  i17  i10 || VAU.AND v11 v6 v7	
 ...
 bitwiseAndMask_loop:
	...
	CMU.CMZ.i32 i2	
	PEU.PC1C eq 	|| BRU.BRA bitwiseAndMask_final 
	NOP 6
	
	
 bitwiseAndMask_compensate:

	VAU.AND v8 v0 v1		|| IAU.SUB i5 i19 0

	LSU0.STO.64.L v8  i3 0 	|| LSU1.STO.64.H v8 i3  8	|| VAU.AND v9 v2 v3		 
	LSU0.STO.64.L v9  i3 16 || LSU1.STO.64.H v9 i3  24	|| VAU.AND v10 v4 v5	
	LSU0.STO.64.L v10 i3 32 || LSU1.STO.64.H v10 i3 40	|| VAU.AND v11 v6 v7	|| IAU.SUB i15 i15 0x40
	LSU0.STO.64.L v11 i3 48 || LSU1.STO.64.H v11 i3 56	|| IAU.SHR.u32 i2 i2 3	
	
	
	LSU0.LD.64.L v0 i5	|| LSU1.LD.64.L v20 i15  || BRU.RPL i6 i2		
	IAU.ADD i5 i5 8
 bitwiseAndMask_compensate_loop:
	NOP 4
	IAU.ADD i15 i15 8
	CMU.CMVV.u8 v20 v12 
 ...
 bitwiseAndMask_final:
	BRU.JMP i30
	IAU.ADD i19 i19 0x40
	NOP 5
.size mvcvBitwiseAndMask_asm,.-mvcvBitwiseAndMask_asm
 .nowarnend
.end
