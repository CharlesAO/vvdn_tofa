...
///
/// @brief     bitwiseOrMask kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvBitwiseOrMask(inLines1, inLines2, outLines, Mask, width);
	#else
	mvcvBitwiseOrMask_asm(inLines1, inLines2, outLines, Mask, width);
	#endif
