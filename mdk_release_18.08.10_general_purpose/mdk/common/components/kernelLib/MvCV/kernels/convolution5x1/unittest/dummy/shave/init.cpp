...
///
/// @brief     Convolution5x1 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution5x1(inLines, outLines, conv, width);
	#else
	mvcvConvolution5x1_asm(inLines, outLines, conv, width);
	#endif
