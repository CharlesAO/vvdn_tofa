...
///
/// @brief     Convolution11x11s8hhhh kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution11x11s8hhhh(inLines, outLines, conv, width);
	#else
	mvcvConvolution11x11s8hhhh_asm(inLines, outLines, conv, width);
	#endif
