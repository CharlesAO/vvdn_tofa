...
// Median denoise
.type mvcvMedianFilter9x9_asm,@function
.version 0.50
.ifndef MEDIAN_CFG
.set MEDIAN_CFG 1
.set StackPtr	 	i19
...
CMU.CPZV v24, 0x3 || LSU1.LDIL i20, medianFilter9x9_Median_HistogramRow	||	LSU0.LDIL i23, medianFilter9x9_Restore_And_Exit
CMU.CPZV v28, 0x3 || LSU1.LDIH i20, medianFilter9x9_Median_HistogramRow	||	LSU0.LDIH i23, medianFilter9x9_Restore_And_Exit



.lalign
 medianFilter9x9_Median_HistogramCol:
BRU.RPS i20, MED_KWIDTH || LSU0.LDI.8 i21, i1
nop
nop
nop
nop
 medianFilter9x9_Median_HistogramRow:
CMU.CMZ.i32 i22
nop
...
nop
PEU.PC1C 0x6 || BRU.BRA medianFilter9x9_Median_HistogramCol
PEU.PC1C 0x6 || BRU.RFB16.I 0x01 || IAU.SUB i22, i22, 0x01
PEU.PC1C 0x6 || IAU.SUB i1, i1, (MED_KWIDTH>>1)
PEU.PC1C 0x6 || LSU1.LDIL i20, medianFilter9x9_Median_HistogramRow
PEU.PC1C 0x6 || LSU1.LDIH i20, medianFilter9x9_Median_HistogramRow
PEU.PC1C 0x1 || BRU.RFB16.Z 0
nop

.lalign

 medianFilter9x9_Median_Loop:
...
nop
 medianFilter9x9_Median_HistogramLoop:
CMU.LUT.U8 i20, i21, 0x2      || IAU.SUBSU i22, i22, 0x01
CMU.CMZ.i32  i22              || BRU.RFB16.I 0x01
IAU.SUBSU i20, i20, 0x01      || PEU.PCCX.NEQ 0x10 || BRU.BRA medianFilter9x9_Median_HistogramLoop || LSU0.LDO.8 i21, i1, -MED_KWIDTH
CMU.LUTW.X8    i20, i21, 0x2  || PEU.PCCX.EQ  0x10 || BRU.BRA medianFilter9x9_Median_Loop
CMU.LUT.U8 i20, i21, 0x2
nop
...
nop
BRU.RFB16.Z 0
 medianFilter9x9_Restore_And_Exit:
IAU.SUB i1 i1 i1
cmu.cpit B_RFB i1
...
BRU.JMP i30
NOP 6
.size mvcvMedianFilter9x9_asm,.-mvcvMedianFilter9x9_asm
.end
