...
///
/// @brief     medianFilter9x9 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvMedianFilter9x9(widthLine, outLines, inLines);
	#else
	mvcvMedianFilter9x9_asm(widthLine, outLines, inLines);
	#endif
