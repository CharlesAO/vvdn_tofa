...
///
/// @brief     convSeparable5x5 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvSeparable5x5(outLines, inLines, conv, width);
	#else
	mvcvConvSeparable5x5_asm(outLines, inLines, conv, width);
	#endif
