//AccumulateFp16MaxPool2s1 test    
//Asm function prototype:
//    void mvcvAccumulateFp16MaxPool2s1_asm(half** dst, half** input, u32 width);
//
...
#include "accumulateFp16MaxPool2s1_asm_test.h"
...
#define PADDING 32
class AccumulateFp16MaxPool2s1Test : public ::testing::Test {
 protected:
...
TEST_F(AccumulateFp16MaxPool2s1Test , AllUniform)
{
    width = 16;
    ...
    AccumulateFp16MaxPool2s1_asm_test(outLinesASM, inLines, width);
    mvcvAccumulateFp16MaxPool2s1(outLinesC, inLines, width);
    RecordProperty("CycleCount", AccumulateFp16MaxPool2s1CycleCount);

    arrCheck.CompareArrays(outLinesASM[0],outLinesC[0],width + PADDING);
}

TEST_F(AccumulateFp16MaxPool2s1Test , AllUniform0)
{
    width = 1024;
    inputGen.SelectGenerator("uniform");
...
TEST_F(AccumulateFp16MaxPool2s1Test , AllUniform255)
{
    width = 1024;
    inputGen.SelectGenerator("uniform");
...
TEST_F(AccumulateFp16MaxPool2s1Test , AllRandomSmallWidth)
{
...
TEST_F(AccumulateFp16MaxPool2s1Test , AllRandomBigWidth)
{
...
TEST_F(AccumulateFp16MaxPool2s1Test , AllRandomMaxWidth)
{
    width = 1920;
    inputGen.SelectGenerator("random");
    inLines = inputGen.GetLinesFloat16(width + PADDING, 1, 0, 255);
