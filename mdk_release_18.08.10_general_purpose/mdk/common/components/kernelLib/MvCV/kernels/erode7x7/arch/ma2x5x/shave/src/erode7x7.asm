...
.type mvcvErode7x7_asm,@function
.version 00.51.04
...
.align 4
.code .text.erode
//  void Erode7x7(u8** src, u8** dst, u8** kernel, u32 width)
//                   i18       i17        i16        i15    
mvcvErode7x7_asm:
...
lsu0.sto.32 I27,i19,-4 || iau.incs i19,-4
lsu0.sto.32 I28,i19,-4 || iau.incs i19,-4
lsu0.sto.32 I29,i19,-4 || iau.incs i19,-4
...
VAU.SUB.i8  v30 v30 v30 || iau.add i25 i17 i15 


CMU.CPII   i5 i18       || LSU0.LDIL i7 0         || LSU1.LDIL i21  3 || VAU.SUB.i8  v23 v23 v23
LSU0.LDIL  i4 erode7x7_Store_Values                     || LSU1.LDIH i4 erode7x7_Store_Values
LSU0.LDIL i2 7          || VAU.SUB.i8 v27 v27 v27 
VAU.SUB.i8 v30 v30 v30  || LSU1.LDO.64 I26 I25 0  
VAU.SUB.i8 v26 v26 v26  || LSU1.LDO.64 I28 I25 8  
...
BRU.RPL i4 i3
 ...
 erode7x7_Load_Source_Values:

IAU.SUB i1 i1 3 // sipp
...
IAU.SUB i2 i2 1
PEU.PC1I GT               || BRU.BRA erode7x7_Load_Source_Values
NOP 2
...
LSU1.STO.64 I28 I25 8
LSU1.STO.64 I26 I25 0
...
lsu0.ldo.32 I29,i19,0 || iau.incs i19,4
lsu0.ldo.32 I28,i19,0 || iau.incs i19,4
lsu0.ldo.32 I27,i19,0 || iau.incs i19,4
...
.size mvcvErode7x7_asm,.-mvcvErode7x7_asm
.end
