...
.type mvcvMinMaxKernel_asm,@function
.version 00.51.04
...
mvcvMinMaxKernel_asm:
LSU0.LD.32 i10 i18 || IAU.SUB i4 i4 i4// loads input img
LSU0.LDIL i0 minMaxKernel_minMax_loop || LSU1.LDIH i0 minMaxKernel_minMax_loop  || IAU.SUB i2 i2 i2
IAU.SUB i5 i5 i5
...
.size mvcvMinMaxKernel_asm,.-mvcvMinMaxKernel_asm
.end
