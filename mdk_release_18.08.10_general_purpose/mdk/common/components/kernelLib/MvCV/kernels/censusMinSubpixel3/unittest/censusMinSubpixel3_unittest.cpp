...
#include "censusMinSubpixel3_asm_test.h"
...
class mvcvCensusMinSubpixel3KernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(mvcvCensusMinSubpixel3KernelTest, TestUniformData0)
{
    width = 320;
    ...
    mvcvCensusMinSubpixel3(input, outputC + OFFSET, outputmC + OFFSET, width);
    mvcvCensusMinSubpixel3_asm_test(input, outputAsm, outputmAsm, width);
    
    RecordProperty("CyclePerPixel", mvcvCensusMinSubpixel3CycleCount / (width));
...
TEST_F(mvcvCensusMinSubpixel3KernelTest, TestUniformData255)
{
    width = 320;
    inputGen.SelectGenerator("uniform");
    outputC   = inputGen.GetEmptyLineFp16(width + PADDING);
...
TEST_F(mvcvCensusMinSubpixel3KernelTest, TestRandomDataWidth640)
{
    width = 640;
    inputGen.SelectGenerator("uniform");
    outputC   = inputGen.GetEmptyLineFp16(width + PADDING);
...
TEST_F(mvcvCensusMinSubpixel3KernelTest, TestRandomDataWidth320)
{
    width = 320;
    inputGen.SelectGenerator("uniform");
    outputC   = inputGen.GetEmptyLineFp16(width + PADDING);
...
TEST_F(mvcvCensusMinSubpixel3KernelTest, TestRandomDataWidth8)
{
    width = 8;
    inputGen.SelectGenerator("uniform");
    outputC   = inputGen.GetEmptyLineFp16(width + PADDING);
...
TEST_F(mvcvCensusMinSubpixel3KernelTest, TestRandomDataWidth16)
{
    width = 16;
    inputGen.SelectGenerator("uniform");
    outputC   = inputGen.GetEmptyLineFp16(width + PADDING);
...
TEST_F(mvcvCensusMinSubpixel3KernelTest, TestRandomWidthRandomData)
{
