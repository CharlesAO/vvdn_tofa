...
///
/// @brief     bitwiseXorMask kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvBitwiseXorMask(inLines1, inLines2, outLines, Mask, width);
	#else
	mvcvBitwiseXorMask_asm(inLines1, inLines2, outLines, Mask, width);
	#endif
