...
int main( void )
{
    ...
    mvcvComputeCombinedCost3Window(disparityCost, adCost, alpha, beta, width, normFactor);
#else
    mvcvComputeCombinedCost3Window_asm(disparityCost, adCost, alpha, beta, width, normFactor);
#endif
