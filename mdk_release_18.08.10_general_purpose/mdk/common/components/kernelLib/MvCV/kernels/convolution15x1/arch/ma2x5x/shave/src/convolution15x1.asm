...
.type mvcvConvolution15x1_asm,@function
.version 00.70.00
...
mvcvConvolution15x1_asm:
CMU.CPTI    i14 P_CFG
lsu0.ldil i13, 0x0002     ||  lsu1.ldih i13, 0x0000
IAU.OR i14 i14 i13
CMU.CPIT   P_CFG i14
...
NOP 6
.size mvcvConvolution15x1_asm,.-mvcvConvolution15x1_asm
.end
