...
///
/// @brief     Convolution15x1 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution15x1(inLines, outLines, conv, width);
	#else
	mvcvConvolution15x1_asm(inLines, outLines, conv, width);
	#endif
