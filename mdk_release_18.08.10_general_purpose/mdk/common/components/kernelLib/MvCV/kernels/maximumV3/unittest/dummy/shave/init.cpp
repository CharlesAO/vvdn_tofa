...
///
/// @brief     MaximumV3 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvMaximumV3(inLines, outLines, width);
	#else
		#ifdef MOVICOMPILE_OPTIMIZED
		mvcvMaximumV3_opt(inLines, outLines, width);
		#else
		mvcvMaximumV3_asm(inLines, outLines, width);
		#endif
	#endif
