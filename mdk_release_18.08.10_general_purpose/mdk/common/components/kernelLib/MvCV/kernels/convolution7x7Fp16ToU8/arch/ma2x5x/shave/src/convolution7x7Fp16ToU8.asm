...
.type mvcvConvolution7x7Fp16ToU8_asm,@function
.version 00.51.04

.data .data.convolution7x7Fp16ToU8
.align 16
 convolution7x7Fp16ToU8_clampVal:
        .float16 255.0


.code .text.convolution7x7Fp16ToU8
...
mvcvConvolution7x7Fp16ToU8_asm:
...
.nowarnend
	...
	peu.pc1c NEQ ||LSU0.STI.128.f16.u8f v23, i17
	IAU.SUBSU i15,  i15,  0x08
	PEU.PC1I NEQ || BRU.BRA _loopStartConv7x7Fp16ToU8
    ...
    cmu.alignvec v22, v0 , v7, 10 
//end loop	
	LSU0.STI.128.f16.u8f v23, i17
.size mvcvConvolution7x7Fp16ToU8_asm,.-mvcvConvolution7x7Fp16ToU8_asm
.end
