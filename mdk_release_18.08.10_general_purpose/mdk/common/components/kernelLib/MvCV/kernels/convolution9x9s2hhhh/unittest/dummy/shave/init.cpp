...
///
/// @brief     Convolution9x9s2hhhh kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution9x9s2hhhh(inLines, outLines, conv, width);
	#else
	mvcvConvolution9x9s2hhhh_asm(inLines, outLines, conv, width);
	#endif
