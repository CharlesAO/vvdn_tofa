//convolution9x9s2hhhh kernel test
//Asm function prototype:
//     void Convolution9x9s2hhhh_asm(u8** in, u8** out, half conv[81], u32 inWidth);
//
//Asm test function prototype:
//     void Convolution9x9s2hhhh_asm(unsigned char** in, unsigned char** out, half conv[81], unsigned int inWidth);
//
//C function prototype:
//     void Convolution9x9s2hhhh(u8** in, u8** out, float conv[81], u32 inWidth);
//
...
#include "convolution9x9s2hhhh_asm_test.h"
...
class Convolution9x9s2hhhhKernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(Convolution9x9s2hhhhKernelTest, TestUniformInputLinesMinimumWidth)
{
	width = 32;
	...
	Convolution9x9s2hhhh_asm_test(inLines, outLinesAsm, convMat, width);
	RecordProperty("CyclePerPixel", convolution9x9s2hhhhCycleCount / width);

	inLines = inputGen.GetOffsettedLines(inLines, SIZE, PADDING / 2);
	mvcvConvolution9x9s2hhhh(inLines, outLinesC, convMat, width);
...
TEST_F(Convolution9x9s2hhhhKernelTest, TestUniformInputLinesAll0)
{
	width = 640;
	inputGen.SelectGenerator("uniform");
...
TEST_F(Convolution9x9s2hhhhKernelTest, TestUniformInputLinesAll255)
{
	width = 160;
	inputGen.SelectGenerator("uniform");
...
TEST_F(Convolution9x9s2hhhhKernelTest, TestUniformInputLinesRandomConvMatrix)
{
	width = 640;
	inputGen.SelectGenerator("uniform");
...
TEST_F(Convolution9x9s2hhhhKernelTest, TestRandomInputLinesRandomConvMatrix)
{
	width = 320;
	inputGen.SelectGenerator("random");
...
INSTANTIATE_TEST_CASE_P(UniformInputs, Convolution9x9s2hhhhKernelTest,
...
TEST_P(Convolution9x9s2hhhhKernelTest, TestRandomInputLinesBlurFilter)
{
