...
.type mvcvConvolution9x9s2hhhh_asm,@function
.version 00.51.05

.data .data.convolution9x9s2hhhh
.align 16

.code .text.convolution9x9s2hhhh

//void Convolution9x9s2hhhh_asm(u8** in(i18), u8** out(i17), half conv[49](i16), u32 inWidth(i15))
mvcvConvolution9x9s2hhhh_asm:
	IAU.SUB i19 i19 8	 
	LSU0.ST.64.l v31  i19  || IAU.SUB i19 i19 8
	LSU0.ST.64.h v31  i19  || IAU.SUB i19 i19 8
	nop
	LSU0.LDIL i10 convolution9x9s2hhhh_loop	|| LSU1.LDIH i10 convolution9x9s2hhhh_loop
...
convolution9x9s2hhhh_loop:
.nowarn 10
	cmu.vdilv.x16 v31 v30 v30 v30
.nowarnend
	CMU.CMII.i32 i11 i12
	PEU.PC1C NEQ 			|| LSU0.ST.64.L v30 i17 	|| IAU.ADD i17 i17 8
	IAU.ADD  i11 i11 1
	NOP 
	LSU0.LD.64.L v20 i0      || LSU1.LDO.64.H v20 i0 0x08	||	IAU.ADD i0 i0 16
	CMU.ALIGNVEC v9 v0 v20 8
...
.size mvcvConvolution9x9s2hhhh_asm,.-mvcvConvolution9x9s2hhhh_asm
.end
