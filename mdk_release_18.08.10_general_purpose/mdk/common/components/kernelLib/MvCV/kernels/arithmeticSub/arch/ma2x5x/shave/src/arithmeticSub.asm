...
.type mvcvArithmeticSub_asm,@function
.version 00.51.04

.data .data.arithmeticSub
.align 4
.code .text.arithmeticSub

//void arithmeticSub(u8** src1, u8** src2, u8** dst, u32 width)
//					   i18         i17       i16       i15
mvcvArithmeticSub_asm:
.nowarn
    LSU0.LDIL i2 0x003F || LSU1.LDIH i2 0x0 
	lsu0.ldil i4 0x10   || lsu1.ldil i6 0x20 	
    LSU0.LD.32  i18  i18 || LSU1.LD.32  i17  i17 
    lsu1.ldil i5 arithmeticSub_loop || lsu0.ldih i5 arithmeticSub_loop || IAU.AND i3 i15 i2
	LSU0.ldil i7 arithmeticSub_final || LSU1.ldih i7 arithmeticSub_final //|| IAU.ADD i15 i15 i9
	LSU0.ldil i9 arithmeticSub_compensate || LSU1.ldih i9 arithmeticSub_compensate
	...
	LSU1.LDXVI v1 i18 i4 || VAU.ISUBS.U8 v9 v1 v2 || bru.rpl i5 i1 _end_delay_loop_arithmeticSub
	LSU0.LDXVI v2 i17 i4 
		LSU1.STXVI v9 i16 i4 
	LSU0.LDXVI v3 i18 i4 || VAU.ISUBS.U8 v10 v3 v4 
	LSU1.LDXVI v4 i17 i4 
 arithmeticSub_loop:
		LSU0.STXVI v10 i16 i4
	LSU1.LDXVI v5 i18 i4 || VAU.ISUBS.U8 v11 v5 v6  
	LSU0.LDXVI v6 i17 i4 
		LSU1.STXVI v11 i16 i4
	LSU0.LDXVI v7 i18 i4 || VAU.ISUBS.U8 v12 v7 v8  
	LSU1.LDXVI v8 i17 i4 
		LSU0.STXVI v12 i16 i4
	_end_delay_loop_arithmeticSub:
 ...
 arithmeticSub_compensate:
	...
	nop 6
	VAU.ISUBS.U8 v9 v1 v2 
	VAU.ISUBS.U8 v10 v3 v4 
	VAU.ISUBS.U8 v11 v5 v6 
	VAU.ISUBS.U8 v12 v7 v8 || IAU.SUB i3, i3, 8
 ...
 arithmeticSub_final:
	...
	nop 6
.nowarnend
.size mvcvArithmeticSub_asm,.-mvcvArithmeticSub_asm
.end
