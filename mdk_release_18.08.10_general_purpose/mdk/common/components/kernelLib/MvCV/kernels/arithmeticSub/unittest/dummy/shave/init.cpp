...
{
//	void arithmeticSub(u8** in1, u8** in2, u8** out, u32 width)
	...
	mvcvArithmeticSub(inLines1, inLines2, outLines, width);
	#else
	mvcvArithmeticSub_asm(inLines1, inLines2, outLines, width);
	#endif
