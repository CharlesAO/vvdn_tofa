...
.type mvcvMaxPool3x3hh_asm,@function
.version 00.50.00

.data .data.maxPool3x3hh
.align 4
.code .text.maxPool3x3hh

//void maxPool3x3hh(half** src, half** dst, u32 outputWidth)
//                          i18         i17        i16
mvcvMaxPool3x3hh_asm:

    lsu1.ldi.64 i0 i18   || lsu0.ldil i3 0x10
    lsu1.ld.32 i2 i18    || lsu0.ldil i5 ___maxPool3x3hhLoop
    iau.shr.u32 i4 i16 3 || lsu0.ldih i5 ___maxPool3x3hhLoop
...
.size mvcvMaxPool3x3hh_asm,.-mvcvMaxPool3x3hh_asm
.end
