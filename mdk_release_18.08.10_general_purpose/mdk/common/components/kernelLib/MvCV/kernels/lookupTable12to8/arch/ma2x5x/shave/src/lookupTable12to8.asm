...
.type mvcvLUT12to8_asm,@function
.version 00.50.31.7
...
lsu0.ldil i1, lookupTable12to8_loop_end  || lsu1.ldih i1, lookupTable12to8_loop_end
...
nop
 ...
 lookupTable12to8_pre_processing:
...
nop
 ...
 lookupTable12to8_loop_end_start:
 .nowarn 10
...
bru.jmp i30
nop 6
.size mvcvLUT12to8_asm,.-mvcvLUT12to8_asm
.end
