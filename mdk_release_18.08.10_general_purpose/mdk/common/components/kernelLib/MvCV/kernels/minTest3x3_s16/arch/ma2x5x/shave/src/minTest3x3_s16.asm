...
.type mvcvMinTest3x3_s16_asm,@function
.version 00.51.05
//-------------------------------------------------------------------------------
//void mvcvMinTest3x3_s16_asm(s16* inBufferCandidates, s16** inBuffer, u32 minLocationsIn[], u32 minLocationsOut[], u32 minCountIn, u32* minCountOut)
//                                   i18                        i17          i16                   i15                    i14              i13                

.code .text.mvcvMinTest3x3_s16_asm
.align 16
.nowarn
mvcvMinTest3x3_s16_asm:
...
LSU0.LDIL i11 minTest3x3_s16_minTest_lastCandidate || LSU1.LDIH i11 minTest3x3_s16_minTest_lastCandidate
IAU.SUB i12 i14 2
...
IAU.XOR i11 i11 i11
IAU.SUB i3 i2 2 || LSU0.LDIL i12 minTest3x3_s16_minTest_loop_end || LSU1.LDIH i12 minTest3x3_s16_minTest_loop_end
...
//cycle start // process two candidates in a cycle
    ...
    CMU.min.i16 v1 v1 v0 || LSU1.LD.16r v11 i3
    CMU.CPII i12 i0
    CMU.CPII i8 i1
    nop
 minTest3x3_s16_minTest_loop_end:

    CMU.CMVV.i16 v1 v10 || LSU1.SWZV8 [22222210] || VAU.ALIGNBYTE v3 v3 v3 0
    PEU.PC8C.AND 0x2 || IAU.ADD i11 i11 1 || LSU1.STI.32 i12 i15 //it is a minima store it
    LSU1.SWZV8 [66654210] || IAU.SHL i2 i0 1 || VAU.ALIGNBYTE v2 v2 v2 0
    CMU.min.i16 v2 v2 v3 || IAU.SUB i3 i2 2
    IAU.ADD i6 i3 i17 || VAU.XOR v1 v1 v1
    CMU.CMVV.i16 v2 v11 || IAU.ADD i7 i3 i10
    PEU.PC8C.AND 0x2 || IAU.ADD i11 i11 1 || LSU1.STI.32 i8 i15 //it is a minima store it

 minTest3x3_s16_minTest_lastCandidate:
IAU.AND i14 i14 i4 || LSU0.LDIL i1 minTest3x3_s16_minTest_end || LSU1.LDIH i1 minTest3x3_s16_minTest_end
...
CMU.min.i16 v1 v1 v0
nop 1
CMU.CMVV.i16 v1 v10
PEU.PC8C.AND 0x2 || IAU.ADD i11 i11 1 || LSU1.STI.32 i0 i15 //it is a minima store it


 minTest3x3_s16_minTest_end:
LSU0.ST.32 i11 i13 || BRU.JMP i30
nop 6
.size mvcvMinTest3x3_s16_asm,.-mvcvMinTest3x3_s16_asm
.nowarnend
.end
