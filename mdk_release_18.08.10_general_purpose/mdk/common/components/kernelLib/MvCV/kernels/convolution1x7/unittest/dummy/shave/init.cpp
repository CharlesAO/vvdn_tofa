...
///
/// @brief     Convolution5x5 kernel function call for unitary test
///
...
// 4 padding values added to the maximum width
#define PADDING 16
...
u32 width;
half conv[7] __attribute__ ((aligned (16)));
...
int main( void )
{
	...
	mvcvConvolution1x7(inLines, outLines, conv, width);
	#else
	#ifdef MOVICOMPILE_OPTIMIZED
		mvcvConvolution1x7_opt(inLines, outLines, conv, width);
		#else 
		mvcvConvolution1x7_asm(inLines, outLines, conv, width);
		#endif
	#endif
