...
///
/// @brief     convolution5x5Fp16ToFp16 kernel function call for unitary test
///
...
u32 width;
half conv[25] __attribute__ ((aligned (16)));
...
int main( void )
{
	...
	mvcvConvolution5x5Fp16ToFp16(inLines, outLines, conv, width);
	#else
		#ifdef MOVICOMPILE_OPTIMIZED 
    	mvcvConvolution5x5Fp16ToFp16_opt(inLines, outLines, conv, width);
    	#else
    	mvcvConvolution5x5Fp16ToFp16_asm(inLines, outLines, conv, width);
        #endif
    #endif
