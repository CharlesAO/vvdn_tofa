...
u8 __attribute__ ((aligned (16))) penaltyP2;
...
int main( void )
{
	...
	//printf("%x %x \n", in1,out);
		...
		mvcvAggregateCostSGBM64(input1, input2, out, min2, penaltyP2);
	#else
		mvcvAggregateCostSGBM64_asm(input1, input2, out, min2, penaltyP2);
	#endif
