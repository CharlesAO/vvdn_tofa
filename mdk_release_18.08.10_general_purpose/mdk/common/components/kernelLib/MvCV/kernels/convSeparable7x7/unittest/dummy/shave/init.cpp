...
///
/// @brief     convSeparable7x7 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvSeparable7x7(outLines, inLines, conv, width);
	#else
	mvcvConvSeparable7x7_asm(outLines, inLines, conv, width);
	#endif
