...
///
/// @brief    sumOfSquaredDiff11x11 kernel function call for unitary test
///
...
int main( void )
{
//	void sumOfSquaredDiff11x11(u8** in1, u8** in2, u8** out, u32 width)
	...
	mvcvSumOfSquaredDiff11x11(inLines1, inLines2, outLines, width);
	#else
		#ifdef MOVICOMPILE_OPTIMIZED
		mvcvSumOfSquaredDiff11x11_opt(inLines1, inLines2, outLines, width);
		#else
		mvcvSumOfSquaredDiff11x11_asm(inLines1, inLines2, outLines, width);
		#endif
	#endif
