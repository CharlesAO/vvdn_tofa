...
///
/// @brief     Convolution1x15 kernel function call for unitary test
///
...
u32 width;
half conv[15] __attribute__ ((aligned (16)));
...
int main( void )
{
	...
	mvcvConvolution1x15(inLines, outLines, conv, width);
	#else
	mvcvConvolution1x15_asm(inLines, outLines, conv, width);
	#endif
