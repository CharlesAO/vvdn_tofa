...
#include "censusMin65_asm_test.h"
...
class mvcvCensusMin65KernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(mvcvCensusMin65KernelTest, TestWidth16All0)
{
	width = 16;
	disparities = 65;
	...
	mvcvCensusMin65(inLine1, outLineC + 16, width);
	mvcvCensusMin65_asm_test(inLine1 , outLineAsm , width);
	
	RecordProperty("CyclePerPixel", mvcvCensusMin65CycleCount / (width ));
...
TEST_F(mvcvCensusMin65KernelTest, TestWidth16AllMAX)
{
	width = 16;
	disparities = 65;
	inputGen.SelectGenerator("uniform");
...
TEST_F(mvcvCensusMin65KernelTest, TestRandomDATARandomWidth)
{
    disparities = 65;
...
TEST_F(mvcvCensusMin65KernelTest, TestRandomDATARandomWidth2)
{
    disparities = 65;
