...
///
/// @brief     Convolution3x3s2hhhh kernel function call for unitary test
///
...
int main( void )
{
    ...
    outLines    = (half**)outLine;
        ...
        mvcvConvolution3x3s2hhhh(inLines, outLines, conv, width);
   #else
        mvcvConvolution3x3s2hhhh_asm(inLines, outLines, conv, width);
    #endif
