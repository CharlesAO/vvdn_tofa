...
///
/// @brief     medianFilter7x7 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvMedianFilter7x7(widthLine, outLines, inLines);
	#else
	mvcvMedianFilter7x7_asm(widthLine, outLines, inLines);
	#endif
