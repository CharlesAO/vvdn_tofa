#ifndef __CENSUS_MATCHING_PYRONEPOS_H__
#define __CENSUS_MATCHING_PYRONEPOS_H__
...
MVCV_FUNC(void, mvcvCensusMatchingPyrOnePos, u32 *in1, u32 *in2, u8 *predicted, u8 *out, u32 width)
//!@}
	
#endif //__CENSUS_MATCHING_PYRONEPOS_H__