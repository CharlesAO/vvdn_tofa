...
.type mvcvConvolution11x11s1xxhx_asm,@function
.version 00.51.05

.code .text.convolution11x11s1xxhx

//void Convolution11x11s1xxhx_asm(u8** in(i18), u8** out(i17), u8 conv[121](i16), u32 inWidth(i15))
mvcvConvolution11x11s1xxhx_asm:
 ...
 .nowarnend
	...
	VAU.MACP.f16  v30 v22 	|| LSU0.SWZV8 [77777777]	|| CMU.ALIGNVEC v22 v10 v21 10
        ...
        nop 13
        LSU0.STi.128.f16.u8f v23 i17	|| IAU.SUB i15 i15 8
	CMU.CMZ.i32 i15 
	PEU.PC1C NEQ || BRU.BRA convolution11x11s1xxhx_loop
        iau.incs i16 -64
        LSU1.LDi.128.u8.f16 v30 i16
	LSU1.LDi.128.u8.f16 v31 i16
...
.size mvcvConvolution11x11s1xxhx_asm,.-mvcvConvolution11x11s1xxhx_asm
.end
