...
///
/// @brief     Convolution5x5s3hhhh kernel function call for unitary test
///
...
int main( void )
{
    ...
    mvcvConvolution5x5s3hhhh(inLines, outLines, conv, width);
    #else
    mvcvConvolution5x5s3hhhh_asm(inLines, outLines, conv, width);
    #endif
