...
.type mvcvMinMaxPos_asm,@function
.version 00.51.04
...
.align 4
.code .text.minMaxPos
//void mvcvMinMaxLocat_asm(u8** in, u32 width, u8* minVal, u8* maxVal, u32* minPos, u32* maxPos, u8* maskAddr)//
//                      i18        i17          i16        i15          i14           i13         i12
.lalign
mvcvMinMaxPos_asm:
.nowarn
IAU.SUB i19 i19 4 // save i20, i21 to stack
LSU0.ST.32 i20 i19 || IAU.SUB i19 i19 4 || LSU1.LDIL i0 0x0
LSU0.ST.32 i21 i19 || IAU.SUB i19 i19 4 || LSU1.LDIL i2 0xFF
LSU0.ST.32 i22 i19 || IAU.XOR i10 i10 i10 || CMU.CPIVR.x8 v1 i0
 
LSU0.LD.32 i18 i18 || IAU.XOR i11 i11 i11 || CMU.CPIVR.x8 v2 i2            // loads input img
LSU0.LDIL i3 0x000f
CMU.CMII.u32 i17, i3
PEU.PC1C LTE || BRU.BRA minMaxPos_compensation || LSU0.LDIL i4 0xff || IAU.XOR i5 i5 i5
IAU.AND i6 i17 i3   
...
IAU.XOR i1 i1 i1
IAU.XOR i5 i5 i5
LSU0.LDIL i4 minMaxPos_min_max_loop || LSU1.LDIH i4 minMaxPos_min_max_loop
LSU1.LDIL i1 0x1 // minVal copied in vec.

 .lalign
 minMaxPos_min_max_loop_head:
...
nop 2
 ...
 minMaxPos_compensation:
        LSU0.ST.8 i5 i15 || LSU1.ST.8 i0 i14 //stores the smallest value found in the img
        LSU0.ST.8 i4 i16 || LSU1.ST.8 i0 i13 // stores the highest value found in the img
	
    	CMU.CMZ.i8 i6       || LSU0.LDIL i7 minMaxPos_compensation_end || LSU1.LDIH i7 minMaxPos_compensation_end
    	PEU.PC1C EQ         || BRU.BRA minMaxPos_min_max_calc
        IAU.ADD i0 i8 0     || SAU.XOR i9 i9 i9 // min position counter
     	SAU.XOR i22 i22 i22 // max position counter
		nop 4
...
nop 5
 ...
 minMaxPos_compensation_end:
	    PEU.PC1C EQ || LSU0.LDIL i1 0xFF || IAU.XOR i3 i3 i3
	    CMU.CMII.u8 i1 i4        
        PEU.PC1C LT ||  CMU.CPII i4 i1 || IAU.ADD i10 i0 0 || SAU.ADD.i8 i9 i9 1
        CMU.CMII.u8 i3 i5
        PEU.PC1C GT ||  CMU.CPII i5 i3 || IAU.ADD i11 i0 0 || SAU.ADD.i8 i22 i22 1
        IAU.ADD i0 i0 1
		nop	

	LSU0.ST.8 i5 i15  || LSU1.ST.8 i4 i16 //stores the smallest and highest values found in the img
	CMU.CMZ.i8 i9 || IAU.XOR i1 i1 i1
	PEU.PC1C NEQ      || LSU0.ST.32 i10 i14 || IAU.ADD i1 i1 1 // min pos
	PEU.PC1C EQ		  || BRU.BRA minMaxPos_min_max_calc
	nop 4	
	CMU.CMZ.i8 i22 || LSU0.LDIL i8 0x02
	PEU.PC1C NEQ	  || LSU1.ST.32 i11 i13 || IAU.ADD i1 i1 1 // max pos
	PEU.PC1C EQ		  || BRU.BRA minMaxPos_max_pos_start
	nop 5 
	// both min max are in the last 16 pixels:
	CMU.CMII.i8 i8 i1
	PEU.PC1C EQ      || BRU.BRA minMaxPos_restore_stack  
 minMaxPos_min_max_calc:
//-----------------------------------------------------------------------------------------------
...
IAU.XOR i10 i10 i10 || LSU0.LDIL i6 minMaxPos_min_pos_loop || LSU1.LDIH i6 minMaxPos_min_pos_loop
IAU.XOR i11 i11 i11 || CMU.CPVI i2 v2.0
CMU.CMZ.i8 i2       || IAU.ADD i7 i7 1
PEU.PC1C EQ         || CMU.CPIVR.x8 v3 i7

.lalign
 minMaxPos_min_pos_loop:
...
nop 6
 CMU.CMZ.i8 i22
 PEU.PC1C NEQ || BRU.BRA minMaxPos_restore_stack

 //-----------------------------------------------------------------------------------------------
// starts looping for position of maximum elements from each line
 minMaxPos_max_pos_start:

CMU.CPII i18 i21
LSU0.LDIL i6 minMaxPos_maxim_pos_loop || LSU1.LDIH i6 minMaxPos_maxim_pos_loop
...
IAU.XOR i8  i8  i8 || SAU.SHR.u32 i3 i17 4
IAU.XOR i1  i1  i1
IAU.XOR i4  i4  i4
IAU.XOR i9  i9  i9
IAU.XOR i10 i10 i10
...
.nowarnend
.size mvcvMinMaxPos_asm,.-mvcvMinMaxPos_asm
.end
