...
protected:
    ...
    unsigned char *mask;
    unsigned int width;
	unsigned int pixelPositionAsm;
	unsigned int pixelPositionC;
...
TEST_F(PixelPosTest, TestUniformInputLine)
{
      ...
      mvcvPixelPos(inLines, mask, width, 3, &pixelPositionC, &statusC);

      RecordProperty("CycleCount", PixelPosCycleCount);
      
      EXPECT_EQ((unsigned int)0x11, statusAsm);
      EXPECT_EQ((unsigned int)4, pixelPositionAsm);

      EXPECT_EQ((unsigned int)0x11, statusC);
      EXPECT_EQ((unsigned int)4, pixelPositionC);
}
...
TEST_F(PixelPosTest, TestMaxWidth)
{
      ...
      EXPECT_EQ((unsigned int)0x11, statusAsm);
      EXPECT_EQ((unsigned int)50, pixelPositionAsm);

      EXPECT_EQ((unsigned int)0x11, statusC);
      EXPECT_EQ((unsigned int)50, pixelPositionC);
}
...
TEST_F(PixelPosTest, TestMinWidth)
{
      ...
      EXPECT_EQ((unsigned int)0x11, statusAsm);
      EXPECT_EQ((unsigned int)5, pixelPositionAsm);

      EXPECT_EQ((unsigned int)0x11, statusC);
      EXPECT_EQ((unsigned int)5, pixelPositionC);
}
...
TEST_F(PixelPosTest, TestFirstPixel)
{
      ...
      EXPECT_EQ((unsigned int)0x11, statusAsm);
      EXPECT_EQ((unsigned int)0, pixelPositionAsm);

      EXPECT_EQ((unsigned int)0x11, statusC);
      EXPECT_EQ((unsigned int)0, pixelPositionC);
}
...
TEST_F(PixelPosTest, TestLastPixel)
{
      ...
      mvcvPixelPos(inLines, mask, width, 27, &pixelPositionC, &statusC);

      RecordProperty("CycleCount", PixelPosCycleCount);

      EXPECT_EQ((unsigned int)0x11, statusAsm);
      EXPECT_EQ((unsigned int)31, pixelPositionAsm);

      EXPECT_EQ((unsigned int)0x11, statusC);
      EXPECT_EQ((unsigned int)31, pixelPositionC);
}
...
TEST_F(PixelPosTest, TestSearchedPixelMasked)
{
      ...
      mvcvPixelPos(inLines, mask, width, 125, &pixelPositionC, &statusC);

      RecordProperty("CycleCount", PixelPosCycleCount);

      EXPECT_EQ((unsigned int)0, statusAsm);
      EXPECT_EQ((unsigned int)0, pixelPositionAsm);

      EXPECT_EQ((unsigned int)0, statusC);
      EXPECT_EQ((unsigned int)0, pixelPositionC);
}
...
TEST_F(PixelPosTest, TestOnlySearchedPixelNotMasked)
{
      ...
      mvcvPixelPos(inLines, mask, width, 255, &pixelPositionC, &statusC);
...
TEST_F(PixelPosTest, TestSamePixelOnMultiplePositions)
{
      ...
      mvcvPixelPos(inLines, mask, width, 25, &pixelPositionC, &statusC);

      RecordProperty("CycleCount", PixelPosCycleCount);
      
      EXPECT_EQ((unsigned int)0x11, statusAsm);
      EXPECT_EQ((unsigned int)55, pixelPositionC);
      EXPECT_EQ((unsigned int)0x11, statusC);
      EXPECT_EQ((unsigned int)55, pixelPositionAsm);
}
...
TEST_F(PixelPosTest, TestTwoPixelsSameValue)
{
      ...
      EXPECT_EQ((unsigned int)0x11, statusAsm);
      EXPECT_EQ((unsigned int)32, pixelPositionAsm);
      EXPECT_EQ((unsigned int)0x11, statusC);
      EXPECT_EQ((unsigned int)32, pixelPositionC);
}
...
TEST_F(PixelPosTest, TestUniformInputRandomMask)
{
      ...
      mvcvPixelPos(inLines, mask, width, 4, &pixelPositionC, &statusC);
      RecordProperty("CycleCount", PixelPosCycleCount);

      EXPECT_EQ((unsigned int)statusC, statusAsm);
      EXPECT_EQ((unsigned int)pixelPositionC, pixelPositionAsm);
}
...
TEST_F(PixelPosTest, TestRandomInputRandomMaskWidth8)
{
      ...
      mvcvPixelPos(inLines, mask, width, searchedPixel, &pixelPositionC, &statusC);
      RecordProperty("CycleCount", PixelPosCycleCount);
...
TEST_F(PixelPosTest, TestMorePixelsSameValueAllMasked)
{
      ...
      mvcvPixelPos(inLines, mask, width, 7, &pixelPositionC, &statusC);
...
//      mask[17] = 0;
      ...
      mvcvPixelPos(inLines, mask, width, 0, &pixelPositionC, &statusC);
...
TEST_F(PixelPosTest, TestSearchForPixel0Compensation)
{
      ...
      EXPECT_EQ((unsigned int)0x11, statusAsm);
      EXPECT_EQ((unsigned int)18, pixelPositionAsm);

      EXPECT_EQ((unsigned int)0x11, statusC);
      EXPECT_EQ((unsigned int)18, pixelPositionC);
}
