...
.type mvcvPixelPos_asm,@function
.version 00.51.04
...
.code .text.pixelPos
//void mvcvPixelPos_asm(u8** srcAddr, u8* maskAddr, u32 width, u8 pixelValue, u32* pixelPosition, u8 status)
...
LSU0.LDIL i1 pixelPos_pixelPositionLoop || LSU1.LDIH i1 pixelPos_pixelPositionLoop //address for loop to exe
...
PEU.PC1C EQ  || BRU.BRA pixelPos_compensation || IAU.SUB i11 i11 16
CMU.CPIVR.x8 v3 i8
...
//Disable PEU.PVV warning since we are using it on purpose
        ...
        CMU.CMII.u8 i0 i7
        PEU.PC1C EQ || LSU0.ST.32 i12 i14 || LSU1.ST.8 i4 i13 || IAU.ADD i16 i16 0xff || SAU.XOR i6 i6 i6
        IAU.ADD     i10 i10 1
        IAU.ADD i16 i16 1
        CMU.CMII.u32 i16 i2
...
nop 6
 ...
 pixelPos_compensation:
        IAU.ADD i11 i11 16
        CMU.CMZ.i8 i6 || IAU.XOR i1 i1 i1 || SAU.XOR i2, i2, i2 || LSU0.LDIL i5 pixelPos_compensation_loop_end || LSU1.LDIH i5 pixelPos_compensation_loop_end
...
.nowarnend
.size mvcvPixelPos_asm,.-mvcvPixelPos_asm
.end
