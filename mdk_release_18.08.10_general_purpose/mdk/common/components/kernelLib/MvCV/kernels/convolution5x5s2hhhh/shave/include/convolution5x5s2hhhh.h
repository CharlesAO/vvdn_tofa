#ifndef __CONVOLUTION5x5S2hhhh_H__
#define __CONVOLUTION5x5S2hhhh_H__
#include <mv_types.h>
...
MVCV_FUNC(void, mvcvConvolution5x5s2hhhh, half** in, half** out, half conv[25], u32 inWidth)
//!@}

#endif //__CONVOLUTION5x5S2hhhh_H__