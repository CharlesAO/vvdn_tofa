...
TEST_F(AbsoluteDiffTest , TestDebugBoardConection)
{
    int width = 16;
	inputGen.SelectGenerator("uniform");
	inLines1 = inputGen.GetLines(width, 1, 1);
	inLines2 = inputGen.GetLines(width, 1, 4);
	...
	AbsoluteDiff_asm_test( inLines1, inLines2, outLinesASM, width);
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, width);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);

	arrCheck.CompareArrays(outLinesASM[0],outLinesC[0],width);
}
...
TEST_F(AbsoluteDiffTest , TestUniformInputLineNegDiff)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 328);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);
...
TEST_F(AbsoluteDiffTest , TestUniformInputLinePosDiff)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 640);
...
TEST_F(AbsoluteDiffTest , TestUniformInputLineNumMinusZero)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 960);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);
...
TEST_F(AbsoluteDiffTest , TestUniformInputLineZeroDiff)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 8);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);
...
TEST_F(AbsoluteDiffTest , TestAlterInputLineNumMinusNum)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 32);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);
...
TEST_F(AbsoluteDiffTest , TestUniformInputLineMaxMinusZeroDiff)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 1744);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);
...
TEST_F(AbsoluteDiffTest , TestUniformInputLineNumMinusMaxDiff)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 104);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);
...
TEST_F(AbsoluteDiffTest , TestUniformInputLineMaxMinusMaxDiff)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 256);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);
...
TEST_F(AbsoluteDiffTest , TestZeroMiusZeroDiff)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 512);
	RecordProperty("CycleCount", AbsoluteDiffCycleCount);
...
TEST_F(AbsoluteDiffTest , TestAlterDiffMaxMinusZeroAndMax)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 1024);
...
TEST_F(AbsoluteDiffTest , TestAlterDiffZeroAndMaxMinusMax)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 16);
...
TEST_F(AbsoluteDiffTest , TestAlterDiffNumAndMaxMinusMax)
{
	...
	mvcvAbsoluteDiff( inLines1, inLines2, outLinesC, 224);
