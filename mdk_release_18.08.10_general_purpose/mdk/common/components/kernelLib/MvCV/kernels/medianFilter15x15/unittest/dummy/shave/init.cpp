...
///
/// @brief     medianFilter15x15 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvMedianFilter15x15(widthLine, outLines, inLines);
	#else
	mvcvMedianFilter15x15_asm(widthLine, outLines, inLines);
	#endif
