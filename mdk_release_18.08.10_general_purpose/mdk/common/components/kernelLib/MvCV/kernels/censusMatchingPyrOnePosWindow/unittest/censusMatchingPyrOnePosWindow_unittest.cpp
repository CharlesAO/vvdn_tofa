...
#include "censusMatchingPyrOnePosWindow_asm_test.h"
...
class mvcvCensusMatchingPyrOnePosWindowKernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(mvcvCensusMatchingPyrOnePosWindowKernelTest, TestWidth16All0)
{
    disparities = 5;
    width = 16;
    ...
    mvcvCensusMatchingPyrOnePosWindow(inLine1 + PADDING, inLine2 + PADDING, predicted, outLineC + PADDING/2, width);
    mvcvCensusMatchingPyrOnePosWindow_asm_test(inLine1 , inLine2, predicted , outLineAsm , width);
    
    RecordProperty("CyclePerPixel", mvcvCensusMatchingPyrOnePosWindowCycleCount / (width * disparities));
...
TEST_F(mvcvCensusMatchingPyrOnePosWindowKernelTest, TestWidth16AllMAX)
{
    disparities = 5;
    width = 16;
...
TEST_F(mvcvCensusMatchingPyrOnePosWindowKernelTest, TestRandomDATARandomWidth)
{
    disparities = 5;
...
TEST_F(mvcvCensusMatchingPyrOnePosWindowKernelTest, TestRandomDATARandom1Width)
{
    disparities = 5;
