...
#include "censusMatchingPyr_asm_test.h"
...
class mvcvCensusMatchingPyrKernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(mvcvCensusMatchingPyrKernelTest, TestWidth16All0)
{
    disparities = 7;
	width = 16;
	...
	mvcvCensusMatchingPyr(inLine1 + PADDING, inLine2 + PADDING, predicted, outLineC + PADDING/2, width);
	mvcvCensusMatchingPyr_asm_test(inLine1 , inLine2, predicted , outLineAsm , width);
	
	RecordProperty("CyclePerPixel", mvcvCensusMatchingPyrCycleCount / (width * disparities));
...
TEST_F(mvcvCensusMatchingPyrKernelTest, TestWidth16AllMAX)
{
    disparities = 7;
	width = 16;
...
TEST_F(mvcvCensusMatchingPyrKernelTest, TestRandomDATARandomWidth)
{
    disparities = 7;
...
TEST_F(mvcvCensusMatchingPyrKernelTest, TestRandomDATARandom1Width)
{
    disparities = 7;
