...
#define SIZE 3
class Convolution3x3KernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(Convolution3x3KernelTest, TestExperimental)
{
	width = 1920;
	...
	mvcvConvolution3x3(inLines, outLinesC, convMatC, width);
...
TEST_F(Convolution3x3KernelTest, TestUniformInputLinesWidth16)
{
	...
	inLines = inputGen.GetOffsettedLines(inLines, SIZE, PADDING / 2);
	mvcvConvolution3x3(inLines, outLinesC, convC, width);
