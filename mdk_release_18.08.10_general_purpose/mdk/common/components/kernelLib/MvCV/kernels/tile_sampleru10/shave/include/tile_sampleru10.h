...
//!@{
/// tile_sampleru10 - in order to compute everything ok we need one extra pixel to the right and one extra line at the bottom for interpolation
...
MVCV_FUNC(void, mvcvtile_sampleru10, u16 *tile, u16 * out_tile, float *xcoord, float *ycoord, u32 tile_width, u32 tile_height)
