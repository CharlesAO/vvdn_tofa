...
.type mvcvfast9ScoreCv_asm,@function
.version 00.51.04
...
PEU.PC1C NEQ || bru.bra fastScore_asm ||VAU.AND v6, v1, v3  ||CMU.CPIVR.x16 v4, i12
...
lsu0.ld.32 i17 i17
nop 6
bru.bra fastExclude 	|| iau.shl i0, i14, 2 				||lsu0.ldo.32 i1, i18, 0x00	||lsu1.ldo.32 i2, i18, 0x0C// score// alocate space for posValid
...
nop
.nowarnend
.size mvcvfast9ScoreCv_asm,.-mvcvfast9ScoreCv_asm
.end
