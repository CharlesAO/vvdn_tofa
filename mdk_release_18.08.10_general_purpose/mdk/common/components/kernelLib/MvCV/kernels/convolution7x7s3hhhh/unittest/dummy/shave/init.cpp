...
///
/// @brief     Convolution7x7s3hhhh kernel function call for unitary test
///
...
u32 width;
half conv[49] __attribute__ ((aligned (16)));
...
int main( void )
{
    ...
    mvcvConvolution7x7s3hhhh(inLines, outLines, conv, width);
    #else
    mvcvConvolution7x7s3hhhh_asm(inLines, outLines, conv, width);
    #endif
