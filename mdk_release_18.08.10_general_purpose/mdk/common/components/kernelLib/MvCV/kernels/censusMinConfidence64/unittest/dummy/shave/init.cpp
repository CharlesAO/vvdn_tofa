...
int main( void )
{
		...
		mvcvCensusMinConfidence64((unsigned char *)&input[16], (unsigned char *)&minimumPosition[16], (unsigned char *)&minimumValue[16], width);
	#else                                                                                                                           
		mvcvCensusMinConfidence64_asm((unsigned char *)&input[16], (unsigned char *)&minimumPosition[16], (unsigned char *)&minimumValue[16], width);
	#endif
	SHAVE_HALT; 
    return 0;
}
