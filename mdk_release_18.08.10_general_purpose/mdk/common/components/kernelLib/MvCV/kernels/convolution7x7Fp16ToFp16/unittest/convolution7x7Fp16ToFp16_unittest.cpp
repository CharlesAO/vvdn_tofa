...
//     void Convolution7x7Fp16ToFp16_asm(half** in, half** out, half conv[49], u32 inWidth);
//
//Asm test function prototype:
//     void Convolution7x7Fp16ToFp16_asm(half** in, half** out, half conv[49], unsigned int inWidth);
//
//C function prototype:
//     void Convolution7x7Fp16ToFp16(half** in, half** out, half conv[49], u32 inWidth);
//
...
#include "convolution7x7Fp16ToFp16_asm_test.h"
...
TEST_F(Convolution7x7KernelTest, TestRandomInputLinesRandomConvMatrix)
{
	...
	mvcvConvolution7x7Fp16ToFp16(inLinesOffseted, outLinesC, convMat, width);
	Convolution7x7Fp16ToFp16_asm_test(inLines, outLinesAsm, convMat, width);
	RecordProperty("CyclePerPixel", convolution7x7Fp16ToFp16CycleCount / width);
