...
.type mvcvConvolution7x7Fp16ToFp16_asm,@function
.version 00.51.04

.data .data.convolution7x7Fp16ToFp16
.align 16
 convolution7x7Fp16ToFp16_clampVal:
        .float16 255.0
...
mvcvConvolution7x7Fp16ToFp16_asm:

    LSU0.LDi.64  i0  i18        ||LSU1.LDO.64.L v14 i16 0x00 
	LSU0.LDi.64  i2  i18        ||LSU1.LDO.64.H v14 i16 0x08 ||cmu.cpii i12, i15
...
.nowarnend
	...
	VAU.MACPW.f16 v23, v20,  v22  ||lsu1.swzv8 [00000000] 	||cmu.cmii.i32 i15, i12
	peu.pc1c NEQ ||LSU0.STXV v23, i17 || iau.add i17, i17, 0x10
	IAU.SUBSU i15,  i15,  0x08
	PEU.PC1I NEQ || BRU.BRA _loopStartConv7x7Fp16ToFp16
    ...
    cmu.alignvec v22, v0 , v7, 10 
//end loop	
	LSU0.STXV v23, i17 || iau.add i17, i17, 0x10
.size mvcvConvolution7x7Fp16ToFp16_asm,.-mvcvConvolution7x7Fp16ToFp16_asm
.end
