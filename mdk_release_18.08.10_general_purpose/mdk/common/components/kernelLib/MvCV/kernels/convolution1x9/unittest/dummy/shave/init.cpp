...
///
/// @brief     Convolution1x9 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvcvConvolution1x9(inLines, outLines, conv, width);
	#else
	mvcvConvolution1x9_asm(inLines, outLines, conv, width);
	#endif
