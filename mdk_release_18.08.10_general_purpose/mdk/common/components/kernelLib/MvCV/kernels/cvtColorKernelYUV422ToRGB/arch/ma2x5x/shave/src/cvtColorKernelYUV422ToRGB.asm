...
.type mvcvCvtColorKernelYUV422ToRGB_asm,@function
.version 00.51.05
//-------------------------------------------------------------------------------
.data .rodata.cvtColorKernelYUV422ToRGB
.align 16
 cvtColorKernelYUV422ToRGB_YUV2RGB_coefs:
	.float16 1.402f16, 0.344f16, 0.714f16, 1.772f16

 cvtColorKernelYUV422ToRGB_minusUV:
    .float16 128.0

 cvtColorKernelYUV422ToRGB_clampVal:
    .float16 255.0
	
.code .text.cvtColorKernelYUV422ToRGB
mvcvCvtColorKernelYUV422ToRGB_asm:
	...
	LSU0.LDIL i12, cvtColorKernelYUV422ToRGB_YUV2RGB_coefs || LSU1.LDIH i12, cvtColorKernelYUV422ToRGB_YUV2RGB_coefs 	
	LSU0.LD.32 i18 i18 				|| LSU1.LD.32 i17 i17				
	LSU0.LD.32 i16 i16		        || LSU1.LD.32 i15 i15      
	LSU0.LDIL i13, cvtColorKernelYUV422ToRGB_minusUV  		|| LSU1.LDIH i13, cvtColorKernelYUV422ToRGB_minusUV
	LSU0.LDIL i11, cvtColorKernelYUV422ToRGB_clampVal 		|| LSU1.LDIH i11, cvtColorKernelYUV422ToRGB_clampVal
	LSU0.LD.16R v2, i13 				|| LSU1.LD.16R v10, i11
NOP 3
	LSU0.LD.64.L v0 i12 
	LSU0.LDIL i6, cvtColorKernelYUV422ToRGB_loop 			|| LSU1.LDIH i6, cvtColorKernelYUV422ToRGB_loop || IAU.SHR.u32 i7 i14 3 || VAU.XOR v11, v11, v11 
...
NOP 5
 ...
 cvtColorKernelYUV422ToRGB_loop:
 .nowarn 10
...
.nowarnend
	...
	BRU.jmp i30
NOP 6
.size mvcvCvtColorKernelYUV422ToRGB_asm,.-mvcvCvtColorKernelYUV422ToRGB_asm
.end
