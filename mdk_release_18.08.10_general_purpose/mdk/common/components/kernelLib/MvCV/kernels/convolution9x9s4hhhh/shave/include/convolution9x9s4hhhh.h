#ifndef __CONVOLUTION9x9S4HHHH_H__
#define __CONVOLUTION9x9S4HHHH_H__
#include <mv_types.h>
...
MVCV_FUNC(void, mvcvConvolution9x9s4hhhh, half** in, half** out, half conv[81], u32 inWidth)
//!@}

#endif //__CONVOLUTION9x9S4HHHH_H__
