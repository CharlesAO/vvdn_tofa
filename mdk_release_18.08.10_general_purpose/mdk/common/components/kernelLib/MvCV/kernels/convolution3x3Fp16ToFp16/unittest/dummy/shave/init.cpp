...
///
/// @brief     Convolution3x3Fp16ToFp16 kernel function call for unitary test
///
...
int main( void )
{
	...
	outLines 	= (half**)outLine;
		...
		mvcvConvolution3x3Fp16ToFp16(inLines, outLines, conv, width);
   #else
		mvcvConvolution3x3Fp16ToFp16_asm(inLines, outLines, conv, width);
	#endif
