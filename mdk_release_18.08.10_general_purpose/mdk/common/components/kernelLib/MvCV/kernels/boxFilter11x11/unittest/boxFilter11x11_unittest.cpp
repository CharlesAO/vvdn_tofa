...
//     void boxfilter11x11_asm(u8** in, u8** out, u8 normalize, u32 width);
//
//Asm test function prototype:
//     void boxfilter11x11_asm_test(u8** in, u8** out, u8 normalize, u32 width);
//
...
#include "boxFilter11x11_asm_test.h"
...
class BoxFilter11x11KernelTest : public ::testing::TestWithParam< unsigned int > {
protected:
...
TEST_F(BoxFilter11x11KernelTest, TestUniformInputLines32)
{
	width = 32;
	...
	mvcvBoxfilter11x11(inLinesOffseted, outLinesC, 1, width);
	boxfilter11x11_asm_test(inLines, outLinesAsm, 1, width);
	RecordProperty("CyclePerPixel", boxFilter11x11CycleCount / width);

	outputChecker.CompareArrays(outLinesC[0], outLinesAsm[0], width);
}

TEST_F(BoxFilter11x11KernelTest, TestAllValuesZero)
{
	width = 320;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
...
TEST_F(BoxFilter11x11KernelTest, TestAllValues255)
{
	width = 320;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
...
TEST_F(BoxFilter11x11KernelTest, TestMinimumWidthSize)
{
	width = 16;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
...
TEST_F(BoxFilter11x11KernelTest, TestSimpleNotEqualInputLines)
{
	width = 320;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
...
TEST_F(BoxFilter11x11KernelTest, TestRandomWidthRandomData)
{
	unsigned char **inLinesOffseted;
...
TEST_F(BoxFilter11x11KernelTest, TestUniformInputLines32Unnormalized)
{
	width = 32;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
	...
	inLinesOffseted = inputGen.GetOffsettedLines(inLines, 11, 8);
	mvcvBoxfilter11x11(inLinesOffseted, outLinesC, 0, width);
	boxfilter11x11_asm_test(inLines, outLinesAsm, 0, width);
	RecordProperty("CyclePerPixel", boxFilter11x11CycleCount / width);

	outputChecker.CompareArrays((unsigned short*)outLinesC[0], (unsigned short*)outLinesAsm[0], width);
}

TEST_F(BoxFilter11x11KernelTest, TestAllValuesZeroUnnormalized)
{
	width = 320;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
...
TEST_F(BoxFilter11x11KernelTest, TestAllValues255Unnormalized)
{
	width = 320;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
...
TEST_F(BoxFilter11x11KernelTest, TestMinimumWidthSizeUnnormalized)
{
	width = 16;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
...
TEST_F(BoxFilter11x11KernelTest, TestSimpleNotEqualInputLinesUnnormalized)
{
	width = 320;
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("uniform");
...
TEST_F(BoxFilter11x11KernelTest, TestRandomWidthRandomDataUnnormalized)
{
	unsigned char **inLinesOffseted;
...
INSTANTIATE_TEST_CASE_P(RandomInputsUnnormalized, BoxFilter11x11KernelTest,
...
TEST_P(BoxFilter11x11KernelTest, TestWidthRandomData)
{
	width = GetParam();
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("random");
...
TEST_P(BoxFilter11x11KernelTest, TestWidthRandomDataUnnormalized)
{
	width = GetParam();
	unsigned char **inLinesOffseted;
	inputGen.SelectGenerator("random");
