...
/*output data marker*/
half __attribute__((section(".kept.data"))) output[1][TEST_FRAME_WIDTH/2]__attribute__ ((aligned (16)));
...
int main( void )
{
    ...
    mvcvConvolution7x7s2hhhh(inLines, outLines, conv, width);
    #else
    mvcvConvolution7x7s2hhhh_asm(inLines, outLines, conv, width);
    #endif
