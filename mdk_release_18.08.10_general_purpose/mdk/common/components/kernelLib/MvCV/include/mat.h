...
public:
	...
	/** Constructs 2D matrix of the specified size and type */
	Mat(s32 _rows, s32 _cols, s32 _type, mvScalar s, u8* _data = 0, bool allocate = true);
	/** Constructs 2D matrix of the specified size and type */
	Mat(const Mat&, const mvRange& rowRange, const mvRange& colRange);
	...
	Mat operator () (const mvRange& rowRange, const mvRange& colRange);
...
/*! 
	...
	\overload Mat(const Mat&, const mvRange& rowRange, const mvRange& colRange);
*/
