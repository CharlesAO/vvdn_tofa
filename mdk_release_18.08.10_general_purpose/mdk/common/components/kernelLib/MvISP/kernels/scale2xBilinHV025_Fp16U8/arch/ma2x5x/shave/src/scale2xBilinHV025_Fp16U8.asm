...
//--------------------------------------------------------------------------------------------------------------
.type mvispScale2xBilinHV025_Fp16U8_asm,@function
.version 00.50.0
.data .rodata.mvispScale2xBilinHV025_Fp16U8_asm 
.align 16
...
//void mvispScale2xBilinHV025_Fp16U8_asm(half** in, u8** out, u32 inWidth)//
//                          		             i18        i17        i16       
	
.code .text.scale2xBilinHV025_Fp16U8_asm 
mvispScale2xBilinHV025_Fp16U8_asm:
	.nowarn 10
...
.nowarnend
	bru.jmp i30
        nop 6
	nop 6
.size mvispScale2xBilinHV025_Fp16U8_asm,.-mvispScale2xBilinHV025_Fp16U8_asm
.end
