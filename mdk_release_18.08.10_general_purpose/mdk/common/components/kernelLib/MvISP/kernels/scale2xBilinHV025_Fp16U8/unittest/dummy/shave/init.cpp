...
///
/// @brief    	scale2xBilinHV025_Fp16U8 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvispScale2xBilinHV025_Fp16U8(inLines, outLines, width);
#else
	mvispScale2xBilinHV025_Fp16U8_asm(inLines, outLines, width);
#endif
