...
/*output data marker*/
u32 __attribute__((section(".kept.data"))) output[MAX_NUMBERS_OF_PAXEL * 4] __attribute__ ((aligned (16))) = {
...
int main( void )
{
	...
	mvispStatsAWBSatPixelsU32(output, in, nPaxelX, gapPaxelX, widthPaxelX, satPaxelX);
	#else
    mvispStatsAWBSatPixelsU32_asm(output, in, nPaxelX, gapPaxelX, widthPaxelX, satPaxelX);
	#endif
