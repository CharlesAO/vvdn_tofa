...
int main( void )
{
  // for(int i = 0; i <  TEST_FRAME_WIDTH/2 + PADDING; i++)
  // {
     // input[0][i] = i;
     // input[1][i] = i+100;
  // }
...
// width = 64;
	...
	mvispScale2xBilinHV025_Fp16ToFp16(inLines, outLines, width);
#else
	mvispScale2xBilinHV025_Fp16ToFp16_asm(inLines, outLines, width);
#endif 
