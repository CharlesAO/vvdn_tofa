...
///
/// @brief    	scale2xBilinHV075_U8ToU8 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvispScale2xBilinHV075_U8ToU8(inLines, outLines, width);
#else
	mvispScale2xBilinHV075_U8ToU8_asm(inLines, outLines, width);
#endif
