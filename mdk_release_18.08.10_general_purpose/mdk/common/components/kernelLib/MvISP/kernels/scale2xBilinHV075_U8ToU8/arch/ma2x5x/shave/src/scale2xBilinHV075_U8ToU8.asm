...
//--------------------------------------------------------------------------------------------------------------
.type mvispScale2xBilinHV075_U8ToU8_asm,@function
.version 00.50.0
.data .rodata.mvispScale2xBilinHV075_U8ToU8_asm 
.align 16
...
//void mvispScale2xBilinHV075_U8ToU8_asm(u8** in, u8** out, u32 inWidth)//
//                          		             i18        i17        i16       
	
.code .text.scale2xBilinHV075_U8ToU8_asm 
mvispScale2xBilinHV075_U8ToU8_asm:
.nowarn 10	
...
nop 6
	nop 6
.nowarnend
.size mvispScale2xBilinHV075_U8ToU8_asm,.-mvispScale2xBilinHV075_U8ToU8_asm
.end
