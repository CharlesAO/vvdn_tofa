...
#ifndef __PIXELUNPACKERWB_H__
#define __PIXELUNPACKERWB_H__
#include <mv_types.h>
#include <mvcv_macro.h>

//!@{ 
/// @brief pixelUnpackerWB 10b -> 16b/15b/14b/13b/12b/11b/10b depending on the shift value; also aply WB
/// @detail
...
/// this kernel also apply white balance with the 'awbCoefs' depending on the line number (odd or even) given by 'line'

///ms2b_line:							a9a8c9c8e9e8g9g8 b9b8d9d8f9f8h9h8 
///ls8b_line:							A7A6A5A4A3A2A1A0B7B6B5B4B3B2B1B0C7C6C5C4C3C2C1C0D7D6D5D4D3D2D1D0 ... 	
///outputUnpacker without WB(shift0):	000000a9a8A7A6A5A4A3A2A1A0 000000b9b8B7B6B5B4B3B2B1B0 000000c9c8C7C6C5C4C3C2C1C0 ... 
///outputUnpacker without WB(shift4):	00a9a8A7A6A5A4A3A2A1A00000 00b9b8B7B6B5B4B3B2B1B00000 00c9c8C7C6C5C4C3C2C1C00000 ...
...
MVCV_FUNC(void, mvispPixelUnpackerWB, u32 *ms8b, u8 *ls2b, u16 *output, u32 width, u8 shift, u16 *awbCoef, u32 line_no)
//!@}

#endif // __PIXELUNPACKERWB_H__
