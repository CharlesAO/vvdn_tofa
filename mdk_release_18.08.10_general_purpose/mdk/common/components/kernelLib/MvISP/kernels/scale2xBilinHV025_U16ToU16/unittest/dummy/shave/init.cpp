...
///
/// @brief    	scale2xBilinHV025_U16ToU16 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvispScale2xBilinHV025_U16ToU16(inLines, outLines, width);
#else
	mvispScale2xBilinHV025_U16ToU16_asm(inLines, outLines, width);
#endif 
