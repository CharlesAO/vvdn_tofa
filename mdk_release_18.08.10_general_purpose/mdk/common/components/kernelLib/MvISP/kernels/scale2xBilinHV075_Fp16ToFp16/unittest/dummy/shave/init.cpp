...
///
/// @brief    	scale2xBilinHV075_Fp16ToFp16 kernel function call for unitary test
///
...
int main( void )
{
	...
	mvispScale2xBilinHV075_Fp16ToFp16(inLines, outLines, width);
#else
	mvispScale2xBilinHV075_Fp16ToFp16_asm(inLines, outLines, width);
#endif 
