...
//#define EIGEN_UNALIGNED_VECTORIZE 0 //Disable vectorization
//#define EIGEN_UNALIGNED_VECTORIZE 1 //Enable vectorization
using namespace std;
...
static long int nb_temporaries=0;
...
template<> inline double test_precision<double>() { return 1e-2; }
...
template<> inline std::string type_name<long double>()                 { return "long double"; }
template<> inline std::string type_name<int>()                         { return "int"; }
template<> inline std::string type_name<std::complex<float> >()        { return "complex<float>"; }
template<> inline std::string type_name<std::complex<double> >()       { return "complex<double>"; }
template<> inline std::string type_name<std::complex<long double> >()  { return "complex<long double>"; }
template<> inline std::string type_name<std::complex<int> >()          { return "complex<int>"; }
...
{
  errno = 0;
  printf("main.h - g repeat - set_repeat_from_string \n");
...
inline int maineigen(int argc, char *argv[])
{
    g_has_set_repeat = true;
    g_has_set_seed = true;
    bool need_help = true;
argc=5;
printf("hello from maineigen !\n");
//int i=1;
argv[1][0]='r';
