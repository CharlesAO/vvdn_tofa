...
void test_nullary()
{
   ...
   CALL_SUBTEST_1( testMatrixType(Matrix2d()) );
     ...
     tick = swcReadPC3();
     #endif  
   CALL_SUBTEST_2( testMatrixType(MatrixXcf(internal::random<int>(1,37),internal::random<int>(1,300))) ); // (1,300)
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count = " << tick << endl;
     tick = swcReadPC3();
     #endif  
   CALL_SUBTEST_3( testMatrixType(MatrixXf(internal::random<int>(1,53),internal::random<int>(1,53))) );
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count = " << tick << endl;
     #endif  
