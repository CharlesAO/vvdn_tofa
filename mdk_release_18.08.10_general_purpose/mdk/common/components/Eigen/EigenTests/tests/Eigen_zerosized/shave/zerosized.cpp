...
void test_zerosized()
{
  ...
  zeroSizedMatrix<Matrix2d>();
     ...
     cout << "Cycles count [zeroSizedMatrix<Matrix2d>()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<Matrix3i>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedMatrix<Matrix3i>()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<Matrix<float, 2, Dynamic> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedMatrix<Matrix<float, 2, Dynamic> >()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<MatrixXf>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [ zeroSizedMatrix<MatrixXf>()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<Matrix<float, 0, 0> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedMatrix<Matrix<float, 0, 0> >()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<Matrix<float, Dynamic, 0, 0, 0, 0> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [ zeroSizedMatrix<Matrix<float, Dynamic, 0, 0, 0, 0> >()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<Matrix<float, 0, Dynamic, 0, 0, 0> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedMatrix<Matrix<float, 0, Dynamic, 0, 0, 0> >()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<Matrix<float, Dynamic, Dynamic, 0, 0, 0> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedMatrix<Matrix<float, Dynamic, Dynamic, 0, 0, 0> >()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<Matrix<float, 0, 4> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedMatrix<Matrix<float, 0, 4> >()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedMatrix<Matrix<float, 4, 0> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedMatrix<Matrix<float, 4, 0> >()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  ...
  zeroSizedVector<Vector2d>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedVector<Vector2d>()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedVector<Vector3i>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedVector<Vector3i>()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedVector<VectorXf>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [ zeroSizedVector<VectorXf>()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedVector<Matrix<float, 0, 1> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [ zeroSizedVector<Matrix<float, 0, 1> >()] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  zeroSizedVector<Matrix<float, 1, 0> >();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [zeroSizedVector<Matrix<float, 1, 0> >()] = " << tick << endl;
     #endif  
}
