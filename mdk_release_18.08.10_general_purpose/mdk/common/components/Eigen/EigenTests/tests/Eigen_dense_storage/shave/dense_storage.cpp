...
void test_dense_storage()
{
  ...
  dense_storage_copy<int,Dynamic,Dynamic>();  
     ...
     cout << "Cycles count [dense_storage_copy<int,Dynamic,Dynamic>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  dense_storage_copy<int,Dynamic,3>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_copy<int,Dynamic,3>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  dense_storage_copy<int,4,Dynamic>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_copy<int,4,Dynamic>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  dense_storage_copy<int,4,3>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_copy<int,4,3>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif
  ...
  dense_storage_copy<float,Dynamic,Dynamic>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_copy<float,Dynamic,Dynamic>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif
  dense_storage_copy<float,Dynamic,3>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_copy<float,Dynamic,3>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  dense_storage_copy<float,4,Dynamic>();  
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_copy<float,4,Dynamic>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  dense_storage_copy<float,4,3>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_copy<float,4,3>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  ...
  dense_storage_assignment<int,Dynamic,Dynamic>();  
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_assignment<int,Dynamic,Dynamic>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif
  dense_storage_assignment<int,Dynamic,3>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_assignment<int,Dynamic,3>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif
  dense_storage_assignment<int,4,Dynamic>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_assignment<int,4,Dynamic>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  dense_storage_assignment<int,4,3>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_assignment<int,4,3>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  ...
  dense_storage_assignment<float,Dynamic,Dynamic>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_assignment<float,Dynamic,Dynamic>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  ...
  dense_storage_assignment<float,Dynamic,3>();
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_assignment<float,Dynamic,3>();] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  dense_storage_assignment<float,4,Dynamic>();  
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_assignment<float,4,Dynamic>(); ] = " << tick << endl;
     tick = swcReadPC3();
     #endif 
  dense_storage_assignment<float,4,3>();  
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count [dense_storage_assignment<float,4,3>(); ] = " << tick << endl;
     #endif 
