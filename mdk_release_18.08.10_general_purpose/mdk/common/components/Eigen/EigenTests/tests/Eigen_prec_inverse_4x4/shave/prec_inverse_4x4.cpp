...
void test_prec_inverse_4x4()
{
  ...
  CALL_SUBTEST_1((inverse_permutation_4x4<Matrix4f>()));
     ...
     tick = swcReadPC3();
     #endif  
  CALL_SUBTEST_1(( inverse_general_4x4<Matrix4f>(200 * g_repeat) ));
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  CALL_SUBTEST_1(( inverse_general_4x4<Matrix<float,4,4,RowMajor> >(200 * g_repeat) ));
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count = " << tick << endl;
     tick = swcReadPC3();
  ...
  CALL_SUBTEST_2((inverse_permutation_4x4<Matrix<double,4,4,RowMajor> >()));
     ...
     tick = swcReadPC3();
     #endif  
  CALL_SUBTEST_2(( inverse_general_4x4<Matrix<double,4,4,ColMajor> >(200 * g_repeat) ));
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count = " << tick << endl;
     tick = swcReadPC3();
     #endif  
  CALL_SUBTEST_2(( inverse_general_4x4<Matrix<double,4,4,RowMajor> >(200 * g_repeat) ));
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count = " << tick << endl;
     tick = swcReadPC3();
  ...
  CALL_SUBTEST_3((inverse_permutation_4x4<Matrix4cf>()));
     ...
     tick = swcReadPC3();
     #endif  
  CALL_SUBTEST_3((inverse_general_4x4<Matrix4cf>(50 * g_repeat)));
     #ifdef CYCLESCOUNT
     tick = swcReadPC3()-tick;
     cout << "Cycles count = " << tick << endl;
     #endif  
