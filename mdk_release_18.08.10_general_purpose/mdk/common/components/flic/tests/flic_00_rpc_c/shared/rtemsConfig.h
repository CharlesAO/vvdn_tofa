...
#define CONFIGURE_MICROSECONDS_PER_TICK         80
...
//L2 config
//BSP_SET_L2C_CONFIG(0, L2C_REPL_LRU, 0, L2C_MODE_COPY_BACK,     0, NULL); //PASS (disabled)
//BSP_SET_L2C_CONFIG(1, L2C_REPL_LRU, 0, L2C_MODE_WRITE_THROUGH, 0, NULL); //PASS (WR_THR)
  BSP_SET_L2C_CONFIG(1, L2C_REPL_LRU, 0, L2C_MODE_COPY_BACK,     0, NULL); //PASS
