...
void Entry(frameBuffer *imginfo, shaveinfotype *shaveInfo, u8 *output,
          u32 *outputSize, u32 imgWidth, u32 imgHeight, formatSpecific *formatS)
{
    ...
    dmaTransactionList_t *task1=shaveInfo->task1;
    dmaTransactionList_t *task2=shaveInfo->task2;
    dmaTransactionList_t *task3=shaveInfo->task3;
    volatile dmaTransactionList_t* *ref1=shaveInfo->ref1;
    volatile dmaTransactionList_t* *ref2=shaveInfo->ref2;
    volatile dmaTransactionList_t* *ref3=shaveInfo->ref3;


    u32 huffOutputPos = 0;
    frameBuffer imginfoLocal;

    uncachedSize=(u32*)((u32)outputSize | 0x08000000);
