//
// 30fps full live images at 2600x1952 pixels, sent on 2 MIPI lanes at 1000 Mbps

//HEADER_FORMAT = V2.1

#ifndef _VD6955_2L_2600x1952_RAW10_30HZ_MODE1_H_
#define _VD6955_2L_2600x1952_RAW10_30HZ_MODE1_H_

#include "CameraDefines.h"
#include "mv_types.h"

#define VD6955_2L_2600x1952_RAW10_30HZ_MODE1_I2C_CONFIG_STEPS (4)
...
const u16 vd6955_2L_2600x1952_RAW10_30Hz_mode1_I2Cregs[][2] =
{
...
//configuration step 1
   ...
   {0x0202, 0x07},
   {0x0203, 0xad}, // Coarse Integration Time 1965
   {0x0204, 0x00},
   {0x0205, 0xF0}, // Analogue Gain (max, 24 dB)
   {0x0600, 0x00},
...
I2CConfigDescriptor vd6955_2L_2600x1952_RAW10_30Hz_mode1_I2CConfigSteps[VD6955_2L_2600x1952_RAW10_30HZ_MODE1_I2C_CONFIG_STEPS] =
{
      { .numberOfRegs = 769,
        .delayMs = 100
      },
...
const mipiSpec vd6955_2L_2600x1952_RAW10_30Hz_mode1_mipiCfg =
{
...
GenericCamSpec vd6955_2L_2600x1952_RAW10_30Hz_mode1_camCfg =
{
      .frameWidth            = 2600,
      .frameHeight           = 1952,
      .hBackPorch            = 0,
      ...
      .mipiCfg               = &vd6955_2L_2600x1952_RAW10_30Hz_mode1_mipiCfg,
      .idealRefFreq          = 16,
      .sensorI2CAddress1     = (0x36>>1),
      .sensorI2CAddress2     = (0x36>>1),
      .nbOfI2CConfigSteps    = VD6955_2L_2600x1952_RAW10_30HZ_MODE1_I2C_CONFIG_STEPS,
      .i2cConfigSteps        = vd6955_2L_2600x1952_RAW10_30Hz_mode1_I2CConfigSteps,
      .regSize               = 1, //data register size (register address size always on 2 bytes)
      .regValues             = vd6955_2L_2600x1952_RAW10_30Hz_mode1_I2Cregs,
};


#endif //_VD6955_2L_2600x1952_RAW10_30HZ_MODE1_H_
