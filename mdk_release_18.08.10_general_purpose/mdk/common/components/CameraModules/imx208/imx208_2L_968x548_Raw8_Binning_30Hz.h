...
#ifndef _IMX208_2L_968x548_RAW8_30HZ_BINNING_H_
#define _IMX208_2L_968x548_RAW8_30HZ_BINNING_H_

#include "CameraDefines.h"
#include "mv_types.h"

#define IMX208_2L_968x548_RAW8_30HZ_BINNING_I2C_CONFIG_STEPS (3)
...
const u16 imx208_2L_968x548_RAW8_30Hz_binning_I2Cregs[][2] =
{
...
I2CConfigDescriptor imx208_2L_968x548_RAW8_30Hz_binning_I2CConfigSteps[IMX208_2L_968x548_RAW8_30HZ_BINNING_I2C_CONFIG_STEPS] =
{
      { .numberOfRegs = (sizeof(imx208_2L_968x548_RAW8_30Hz_binning_I2Cregs)/sizeof(imx208_2L_968x548_RAW8_30Hz_binning_I2Cregs[0])) - 2,
        .delayMs = 0
      },
...
const mipiSpec imx208_2L_968x548_RAW8_30Hz_binning_mipiCfg =
{
...
GenericCamSpec imx208_2L_968x548_RAW8_30Hz_binning_camCfg =
{
      .frameWidth            = 968,
      .frameHeight           = 548,
      .hBackPorch            = 0,
      ...
      .mipiCfg               = &imx208_2L_968x548_RAW8_30Hz_binning_mipiCfg,
      .idealRefFreq          = 24,
      .sensorI2CAddress1     = (0x6C >> 1),
      .sensorI2CAddress2     = (0x6E >> 1),
      .nbOfI2CConfigSteps    = IMX208_2L_968x548_RAW8_30HZ_BINNING_I2C_CONFIG_STEPS,
      .i2cConfigSteps        = imx208_2L_968x548_RAW8_30Hz_binning_I2CConfigSteps,
      .regSize               = 1, //data register size (register address size always on 2 bytes)
      .regValues             = imx208_2L_968x548_RAW8_30Hz_binning_I2Cregs,
};



#endif /* _IMX208_2L_968x548_RAW8_30HZ_BINNING_H_ */
