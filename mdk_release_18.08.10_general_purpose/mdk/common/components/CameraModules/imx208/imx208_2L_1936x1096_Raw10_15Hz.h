//
// 15fps full live images at 1936x1096 pixels, sent on 2 MIPI lanes at 811MHz (811 Mbps per lane);

//HEADER_FORMAT = V2.1

#ifndef _IMX208_2L_1936x1096_RAW10_15HZ_H_
#define _IMX208_2L_1936x1096_RAW10_15HZ_H_

#include "CameraDefines.h"
#include "mv_types.h"

#define IMX208_2L_1936x1096_RAW10_15HZ_I2C_CONFIG_STEPS (3)
...
const u16 imx208_2L_1936x1096_RAW10_15Hz_I2Cregs[][2] =
{
...
{0x0307, 0x87},
{0x303C, 0x4B},
{0x30A4, 0x01},  // 0x02->60fps, 0x00->30fps, 0x01->15fps
//Mode setting
{0x0112, 0x0A},
{0x0113, 0x0A},
{0x0340, 0x04},
...
I2CConfigDescriptor imx208_2L_1936x1096_RAW10_15Hz_I2CConfigSteps[IMX208_2L_1936x1096_RAW10_15HZ_I2C_CONFIG_STEPS] =
{
      { .numberOfRegs = (sizeof(imx208_2L_1936x1096_RAW10_15Hz_I2Cregs)/sizeof(imx208_2L_1936x1096_RAW10_15Hz_I2Cregs[0])) - 2,
        .delayMs = 0
      },
...
const mipiSpec imx208_2L_1936x1096_RAW10_15Hz_mipiCfg =
{
...
GenericCamSpec imx208_2L_1936x1096_RAW10_15Hz_camCfg =
{
      .frameWidth            = 1936,
      .frameHeight           = 1096,
      .hBackPorch            = 0,
      ...
      .mipiCfg               = &imx208_2L_1936x1096_RAW10_15Hz_mipiCfg,
      .idealRefFreq          = 24,
      .sensorI2CAddress1     = (0x6C >> 1),
      .sensorI2CAddress2     = (0x6E >> 1),
      .nbOfI2CConfigSteps    = IMX208_2L_1936x1096_RAW10_15HZ_I2C_CONFIG_STEPS,
      .i2cConfigSteps        = imx208_2L_1936x1096_RAW10_15Hz_I2CConfigSteps,
      .regSize               = 1, //data register size (register address size always on 2 bytes)
      .regValues             = imx208_2L_1936x1096_RAW10_15Hz_I2Cregs,
};



#endif /* _IMX208_2L_1936x1096_RAW10_15HZ_H_ */
