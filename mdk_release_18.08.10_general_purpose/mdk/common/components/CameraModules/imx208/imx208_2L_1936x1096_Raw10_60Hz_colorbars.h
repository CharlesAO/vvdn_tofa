//
// 60fps full colorbar images at 1936x1096 pixels, sent on 2 MIPI lanes at 811MHz (811 Mbps per lane);
// need a system clock/aux clock of at least 360 Mhz
//

//HEADER_FORMAT = V2.1

#ifndef _IMX208_2L_1936x1096_RAW10_60HZ_COLORBARS_H_
#define _IMX208_2L_1936x1096_RAW10_60HZ_COLORBARS_H_

#include "CameraDefines.h"
#include "mv_types.h"

#define IMX208_2L_1936x1096_RAW10_60HZ_CB_I2C_CONFIG_STEPS (3)
...
const u16 imx208_2L_1936x1096_RAW10_60Hz_cbars_I2Cregs[][2] =
{
...
I2CConfigDescriptor imx208_2L_1936x1096_RAW10_60Hz_cbars_I2CConfigSteps[IMX208_2L_1936x1096_RAW10_60HZ_CB_I2C_CONFIG_STEPS] =
{
      { .numberOfRegs = (sizeof(imx208_2L_1936x1096_RAW10_60Hz_cbars_I2Cregs)/sizeof(imx208_2L_1936x1096_RAW10_60Hz_cbars_I2Cregs[0])) - 2,
        .delayMs = 0
      },
...
const mipiSpec imx208_2L_1936x1096_RAW10_60Hz_cbars_mipiCfg =
{
...
GenericCamSpec imx208_2L_1936x1096_RAW10_60Hz_cbars_camCfg =
{
      .frameWidth            = 1936,
      .frameHeight           = 1096,
      .hBackPorch            = 0,
      ...
      .mipiCfg               = &imx208_2L_1936x1096_RAW10_60Hz_cbars_mipiCfg,
      .idealRefFreq          = 24,
      .sensorI2CAddress1     = (0x6C >> 1),
      .sensorI2CAddress2     = (0x6E >> 1),
      .nbOfI2CConfigSteps    = IMX208_2L_1936x1096_RAW10_60HZ_CB_I2C_CONFIG_STEPS,
      .i2cConfigSteps        = imx208_2L_1936x1096_RAW10_60Hz_cbars_I2CConfigSteps,
      .regSize               = 1, //data register size (register address size always on 2 bytes)
      .regValues             = imx208_2L_1936x1096_RAW10_60Hz_cbars_I2Cregs,
};



#endif /* _IMX208_2L_1936x1096_RAW10_60HZ_COLORBARS_H_ */
