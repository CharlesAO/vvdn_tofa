//
// 30fps full live images at 1936x1096 pixels, sent on 2 MIPI lanes at 811MHz (811 Mbps per lane);
// need a system clock/aux clock of at least 360 Mhz
//

//HEADER_FORMAT = V2.1

#ifndef _IMX208_2L_1936x1096_RAW10CONV8_30HZ_H_
#define _IMX208_2L_1936x1096_RAW10CONV8_30HZ_H_

#include "CameraDefines.h"
#include "mv_types.h"


#define IMX208_2L_1936x1096_RAW10CONV8_30HZ_I2C_CONFIG_STEPS (3)
...
const u16 imx208_2L_1936x1096_RAW10CONV8_30Hz_I2Cregs[][2] =
{
...
{0x0203, 0xcb}, //
{0x0205, 0xD0}, //analog gain
{0x020E, 0x02}, //digital gain
{0x0210, 0x02}, //
{0x0212, 0x02}, //
{0x0214, 0x02}, //
// -----------End of offical config from spreadsheet ------------
...
I2CConfigDescriptor imx208_2L_1936x1096_RAW10CONV8_30Hz_I2CConfigSteps[IMX208_2L_1936x1096_RAW10CONV8_30HZ_I2C_CONFIG_STEPS] =
{
    { .numberOfRegs = sizeof(imx208_2L_1936x1096_RAW10CONV8_30Hz_I2Cregs)/sizeof(imx208_2L_1936x1096_RAW10CONV8_30Hz_I2Cregs[0]) - 2,
      .delayMs = 0
    },
...
const mipiSpec imx208_2L_1936x1096_RAW10CONV8_30Hz_mipiCfg =
{
...
GenericCamSpec imx208_2L_1936x1096_RAW10CONV8_30Hz_camCfg =
{
      .frameWidth            = 1936,
      .frameHeight           = 1096,
      .hBackPorch            = 0,
      ...
      .mipiCfg               = &imx208_2L_1936x1096_RAW10CONV8_30Hz_mipiCfg,
      .idealRefFreq          = 24,
      .sensorI2CAddress1     = (0x6C >> 1),
      .sensorI2CAddress2     = (0x6E >> 1),            //only used for stereo cameras
      .nbOfI2CConfigSteps    = IMX208_2L_1936x1096_RAW10CONV8_30HZ_I2C_CONFIG_STEPS,
      .i2cConfigSteps        = imx208_2L_1936x1096_RAW10CONV8_30Hz_I2CConfigSteps,
      .regSize               = 1,
      .regValues             = imx208_2L_1936x1096_RAW10CONV8_30Hz_I2Cregs,
};


#endif /* _IMX208_2L_1936x1096_RAW10CONV8_30HZ_H_ */
