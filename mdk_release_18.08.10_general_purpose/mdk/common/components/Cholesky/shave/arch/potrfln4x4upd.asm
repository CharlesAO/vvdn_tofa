...
potrfln4x4upd:
  ...
  .ifdef ma2480
  iau.shr.u32     m,  m 2    || lsu0.cp.32    i0, C
  bru.bra      .Ltrsm        || peu.pc1i  lte
    lsu1.ldi.128   C0, i0 wCEA || lsu0.cp.32    i2, A
    lsu0.ldi.64 a10,  D wBD     // this really loads n00// a10 will be reloaded shortly
    lsu1.ldi.128   C1, i0 wCEA || lsu0.cp.32    i3, B
    lsu0.ld.32  a10,  D
    lsu1.ld.128    C2, i0      || iau.add    i0, i0 wCEA
    lsu0.ld.128    C3, i0
  lsu1.ldi.128     A0, i2 wCEA
  lsu0.ldi.128     B0, i3 wBD
  lsu1.ldi.128     A1, i2 wCEA
  lsu0.ldi.128     B1, i3 wBD  || iau.xor    i0, i0 i0
  lsu1.ldi.128     A2, i2 wCEA || iau.incs    A, 16
  lsu0.ldi.128     B2, i3 wBD  || iau.incs    B, 16
  lsu1.ldi.64   a30, i2      || iau.incs    m, -1
  lsu0.ld.128      B3, i3      || sau.or     i3, B B
  lsu1.ld.64    a32, i2      || cmu.cp.32   i2, A
  bru.bra    __mul_loop_last || peu.pc1i   eq
    vau.xor      v7, v7 v7   || lsu0.ldil  i1, __mul_loop_end
    vau.accpz.f32    C3 V_ACC0   || lsu0.ldih  i1, __mul_loop_end
    nop 3
    cmu.tp4r    tB0, B0
  vau.mul.f32    v7, A0  B0  || bru.rpl      i1  m                           || lsu1.ldi.128   A0, i2 wCEA
  vau.mul.f32    v7, A0  B1  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v2.0, i0
  vau.mul.f32    v7, A0  B2                         || lsu0.cp.32     v2.1, i0  || lsu1.ldi.128  tB0, i3 wBD
  vau.mul.f32    v7, A0  B3  || sau.sumx.f32 i0, v7 || cmu.cp.128.32.r a3 a30
  vau.macn.f32       a3 tB0 V_ACC0   || sau.sumx.f32 i0, v7 || lsu0.cp.32     v2.2, i0  || lsu1.ldi.128   A1, i2 wCEA
  vau.mul.f32    v7, A1  B0  || sau.sumx.f32 i1, v7 || cmu.cp.128.32.r a3, a31 || iau.incs      A, 16
  vau.mul.f32    v7, A1  B1  || sau.sumx.f32 i0, v7                          || lsu1.ldi.128   B1, i3 wBD
  vau.macn.f32       a3 tB1   V_ACC0                      || lsu0.cp.32     v2.3, i0  || iau.incs      B, 16
  vau.mul.f32    v7, A1  B2  || sau.sumx.f32 i1, v7 || lsu0.cp.32     v0.0, i0  || lsu1.ldi.128   B2, i3 wBD
  vau.mul.f32    v7, A1  B3  || sau.sumx.f32 i0, v7 || cmu.cp.128.32.r a3, a32
  vau.macn.f32       a3 tB2  V_ACC0                        || lsu0.cp.32     v0.1, i0  || lsu1.ldi.128   B3, i3 wBD
  vau.mul.f32    v7, A2  B0  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v0.2, i1
__mul_loop_end:
    vau.mul.f32  v7, A2  B1  || sau.sumx.f32 i0, v7 || cmu.cp.128.32.r a3, a33 || iau.or       i3,  B B
    vau.macn.f32    a3 tB3    V_ACC0                      || lsu0.cp.32     v0.3, i0  || lsu1.ldi.128   A2, i2 wCEA
    vau.mul.f32  v7, A2  B2  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v1.0, i1  || cmu.cp.128     B0, tB0
    vau.mul.f32  v7, A2  B3                         || lsu0.cp.32     v1.1, i0  || lsu1.ldi.64 a30, i2
    vau.sub.f32  C2, C2 v2   || sau.sumx.f32 i0, v7 || lsu0.cp.32     v1.2, i0  || lsu1.ld.64  a32, i2
    vau.sub.f32  C0, C0 v0   || sau.sumx.f32 i0, v7 || lsu0.cp.32     v1.3, i0  || iau.or       i2,  A A
    vau.sub.f32  C1, C1 v1                          || cmu.tp4r     tB0, B0
__mul_loop_last:
  // last iteration
  vau.mul.f32    v7, A0  B0
  vau.mul.f32    v7, A0  B1  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v2.0, i0
  vau.mul.f32    v7, A0  B2                         || lsu0.cp.32     v2.1, i0
  vau.mul.f32    v7, A0  B3  || sau.sumx.f32 i0, v7 || cmu.cp.128.32.r a3, a30
  vau.macn.f32       a3 tB0  V_ACC0 || sau.sumx.f32 i0, v7 || lsu0.cp.32     v2.2, i0
  vau.mul.f32    v7, A1  B0  || sau.sumx.f32 i0, v7 || cmu.cp.128.32.r a3, a31
  vau.mul.f32    v7, A1  B1  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v2.3, i0
  vau.macn.f32       a3 tB1   V_ACC0                      || cmu.cp.128.32.r a3, a32
  vau.mul.f32    v7, A1  B2  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v0.0, i0
  vau.mul.f32    v7, A1  B3  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v0.1, i0
  vau.macn.f32       a3 tB2    V_ACC0                     || lsu0.cp.32     v0.2, i0
  vau.mul.f32    v7, A2  B0  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v0.3, i0
  vau.mul.f32    v7, A2  B1  || sau.sumx.f32 i0, v7
  vau.mul.f32    v7, A2  B2                         || lsu0.cp.32     v1.0, i0
  vau.mul.f32    v7, A2  B3  || sau.sumx.f32 i0, v7 || lsu0.cp.32     v1.1, i0
  vau.sub.f32    C2, C2 v2   || sau.sumx.f32 i0, v7 || cmu.cp.128.32.r a3, a33
  vau.sub.f32    C0, C0 v0   || sau.sumx.f32 i0, v7 || lsu0.cp.32     v1.2, i0
  vau.macnw.f32  C3, a3 tB3   V_ACC0 || sau.sumx.f32 i0, v7 || lsu0.cp.32     v1.3, i0
...
.Ltrsm:
                               iau.add   i1, D 8   || lsu0.cp.32     v2.3, i0
...
.endif
  ...
  lsu1.ldi.64   a30,  D
.ifdef ma2480
  lsu1.ld.64    a32,  D     || cmu.cp.128.32.r  A0, n00
  cmu.tp4r       C0, C0
  vau.mul.f32    C0, C0 A0  || cmu.cp.128.32.r  B0, a10
  nop 2
  vau.mul.f32    B0, C0 B0  || cmu.cp.128.32.r  B1, a20
  vau.mul.f32    B1, C0 B1  || cmu.cp.128.32.r  B2, a30
  vau.mul.f32    B2, C0 B2  || sau.div.f32   a33,  i1 a33
  vau.sub.f32    C1, C1 B0  || lsu0.cp.32        i0,  E
  vau.sub.f32    C2, C2 B1  || lsu1.ldi.32   n00,  i0 wCEA
  vau.sub.f32    C3, C3 B2  || cmu.cp.128.32.r  A1, n11
  vau.mul.f32    C1, C1 A1  || cmu.cp.128.32.r  B0, a21
  nop 2
  vau.mul.f32    B0, C1 B0  || cmu.cp.128.32.r  B1, a31
  vau.mul.f32    B1, C1 B1  || lsu1.ldi.64   a20,  i0 wCEA
  nop
  vau.sub.f32    C2, C2 B0  || lsu1.ldi.128     B2,  i0 wCEA
  vau.sub.f32    C3, C3 B1  || cmu.cp.128.32.r  A2, n22
  nop
  vau.mul.f32    C2, C2 A2  || cmu.cp.128.32.r  B0, a32
  nop 2
  vau.mul.f32    B0, C2 B0  || lsu0.cp.32        i1, i0
  nop 2
  vau.sub.f32    C3, C3 B0  || cmu.cp.128.32.r  a3, a33
  nop 2
  vau.mul.f32    C3, C3 a3  || lsu1.ld.128      B3, i0
  nop
  nop
  cmu.tp4r       C0, C0
  vau.mul.f32    v7, C3 C0  || lsu1.sti.128     C0, C wCEA
  vau.mul.f32    v7, C3 C1
  vau.mul.f32    v7, C3 C2  || lsu1.sti.128     C1, C wCEA
  vau.mul.f32    v7, C3 C3  || sau.sumx.f32   i0, v7
  vau.mul.f32    v7, C2 C0  || sau.sumx.f32   i0, v7     || lsu1.sti.128 C2, C wCEA
  vau.mul.f32    v7, C2 C1  || sau.sumx.f32   i0, v7
  vau.mul.f32    v7, C2 C2  || sau.sumx.f32   i0, v7     || lsu1.st.128  C3, C
  vau.mul.f32    v7, C0 C0  || sau.sumx.f32   i0, v7
  vau.mul.f32    v7, C1 C0  || sau.sumx.f32   i0, v7     || lsu0.cp.32 v23.0, i0 // v23:=a3
  vau.mul.f32    v7, C1 C1  || sau.sumx.f32   i0, v7     || lsu0.cp.32 v23.1, i0
                               sau.sumx.f32   i0, v7     || lsu0.cp.32 v23.2, i0
                               sau.sumx.f32   i0, v7     || lsu0.cp.32 v23.3, i0
                               sau.sumx.f32   i0, v7     || lsu0.cp.32 v22.0, i0
                                                            lsu0.cp.32 v22.1, i0
  vau.sub.f32    B3, B3 a3                               || lsu0.cp.32 v22.2, i0
                               sau.sub.f32   n00, n00 i0        // e00 in n00
  bru.jmp       i30         || sau.sub.f32   a20, a20 i0        // e10, e11 in a20, a21
    lsu1.st.128    B3, i1     || sau.sub.f32   a21, a21 i0
