...
.ifdef ma2480
  ...
  lsu1.ldi.128    L2, L wL
  lsu0.ldih    one, 1.0f32
  lsu1.ldi.128    L3, L wL
  nop
  lsu1.cp.32       x0, v2.0    || lsu0.cp.32   x1, v2.1 // x1 = b1//   x0 = b0
  sau.div.f32   x0, x0 l00  || cmu.cp.32  x2, v2.2 // x2 = b2//   x0 = b0 / l00
  sau.div.f32  n11, one n11 || lsu0.cp.32   x3, v2.3 // x3 = b3//  n11 = 1 / n11
                               lsu0.cp.32   i1, v0.0 // i1 = l20//
  lsu0.cp.32      n22, v0.2
  sau.div.f32  n22, one n22 || lsu0.cp.32   i2, v1.0 // n22 = 1 / l22// i2 = l30
  lsu0.cp.32      n33, v1.3
.else
  lsu1.ldxv     b_, b
  lsu0.ldil    one, 1.0f32
...
.ifdef ma2480
  sau.mul.f32   x1, x1 n11  || lsu0.cp.32   i0, v0.1 // x1 =(b1 - l00*x0)/ l11// i0 = l21
  nop
  sau.sub.f32   x3, x3 i2   || lsu0.cp.32   i1, v1.1 // x3 = b3 - l30*x0//       i1 = l31
.else
...
.endif
  ...
  nop
.ifdef ma2480
  sau.mul.f32   x2, x2 n22  || lsu0.cp.32   i0, v1.2 // x2 =( b2 - l20*x0 - l21*x1 )/ l22// i0 = l32
.else
