...
.ifdef ma2480
  lsu1.ldi.128    L2, L w     || lsu0.ldih one, 1.0f32
  lsu0.ld.128     b_, b
  lsu1.ld.128     L3, L
.else
...
.ifdef ma2480
  lsu0.cp.32      n22, v0.2    || lsu1.cp.32    x1, v2.1 //; x1 = b1
  sau.div.f32  n22, one n22 || lsu0.cp.32    x3, v2.3 //; x3 = b3
  lsu0.cp.32      l33, v1.3    || lsu1.cp.32    x2, v2.2 //; x2 = b2
  sau.div.f32   x3, x3 l33  || lsu0.cp.32    x0, v2.0 //; x0 = b0
  lsu0.cp.32       i0, v1.2    || lsu1.cp.32    i1, v1.1 //; i0 = l32; i1 = l31
  lsu0.cp.32       i2, v0.1    || lsu1.cp.32    i3, v1.0 //; i2 = l21; i3 = l30
  lsu0.cp.32       i4, v0.0                           //; i4 = l20
.else
