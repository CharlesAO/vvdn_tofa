...
potrfln4x4:
  ...
  .set l33 v23.3
.ifdef ma2480
  lsu0.ldil      i30, .Lsqrtf || lsu1.ldih  i30, .Lsqrtf || cmu.cp.32 i11, i30
// l00 = A[0][0]//
// l00 = sqrtf( l00 )//
  lsu1.ld.32     i18, L       || bru.swp    i30          || iau.add   i0,  L w
    lsu1.ld.64  v21.0 i0      || lsu0.ldil   i8, 1.0f32  || iau.add   i0, i0 w
    lsu1.ldi.64 v22.0 i0      || lsu0.ldih   i8, 1.0f32  || iau.add   i1, i0 w
    lsu1.ld.64  v22.1 i0      || lsu0.ldil   i7, 0xFFFF
    lsu1.ldi.64 v23.0 i1      || lsu0.ldih   i7, 0x807F
    lsu1.ld.64  v23.1 i1      || lsu0.cp.32    i13, L
    cmu.cpzv    L0  1         || lsu0.cp.32    i12, w
.else
...
// l33  = A[3][3]//
.ifdef ma2480
  sau.div.f32  i0, i8 i18  || lsu0.cp.32          l00, i18     // i0 = 1.0f / l00
  lsu0.ldil   i30, .Lsqrtf || lsu1.ldih        i30, .Lsqrtf
  lsu0.cp.32      i1, l10     || lsu1.cp.32           i2, l20
  lsu0.cp.32      i3, l30     || lsu1.cp.32           i4, l11
  iau.xor      i0, i0 i0   || vau.xor           v0, v0 v0
  lsu0.cp.32   v22.3, i0      // cleanup L[2].3
  nop 6
  // here, i0 is 1/L[0][0]
  sau.mul.f32     i1, i1 i0   || lsu0.cp.32       l01, i0
  sau.mul.f32     i2, i2 i0
  sau.mul.f32     i3, i3 i0   || bru.swp       i30
// L2 -= l20 * { 0 l10 l20 0 }
// L3 -= l30 * { 0 l10 l20 l30 }
// l11  = sqrtf( l11 - l10*l10 )//
    sau.mul.f32   i5, i1 i1   || lsu0.cp.32      v0.1, i1
    lsu1.cp.32     v0.2, i2      || cmu.cp.128.32.r  v1, i2
    vau.mul.f32   v1, v0 v1   || cmu.cp.128.32.r v2, i3
    sau.sub.f32  i18, i4 i5   || lsu0.cp.32      v0.3, i3      || lsu1.cp.32       l10, i1
    vau.mul.f32   v2, v0 v2   || lsu0.cp.32       l20, i2
    vau.sub.f32   L2, L2 v1   || lsu0.cp.32       l30, i3
  // here: i18 = sqrtf(l11)

// // L[1]: all done
// l21 /= l11//
// l31 /= l11//
  sau.div.f32     i0, i8 i18  || lsu0.cp.32      l11, i18
  vau.sub.f32     L3, L3 v2   || lsu1.cp.32      i4, l22
  vau.xor         v0, v0 v0   || lsu0.cp.32       i1, l21
  lsu0.ldil      i30, .Lsqrtf || lsu1.ldih    i30, .Lsqrtf
  lsu0.cp.32         i2, l31
  nop 7
  // here, i0 is 1/L[1][1]
  sau.mul.f32     i1, i1 i0   || lsu0.cp.32       l12, i0
  sau.mul.f32     i2, i2 i0
  bru.swp i30
// L3 -= l31 * { 0 0 l21 l31 }
// l22  = sqrtf( l22 - l21*l21 )//
    sau.mul.f32   i3, i1 i1   || lsu0.cp.32     v0.2, i1
    cmu.cp.128.32.r v1, i2      || lsu0.cp.32     v0.3, i2
    vau.mul.f32   v1, v1 v0   || lsu0.cp.32      l21, i1
    sau.sub.f32  i18, i4 i3   || lsu0.cp.32     l31, i2
    nop
...
// // L[2]: all done
// l32 /= l22//
  sau.div.f32     i0, i8 i18  || lsu0.cp.32      l22, i18
  lsu0.ldil      i30, .Lsqrtf || lsu1.ldih    i30, .Lsqrtf
  lsu0.cp.32         i1, l32     || cmu.cp.32      i3, l33
  nop 9
  // here, i0 is 1/L[2][2]
  sau.mul.f32     i1, i1 i0  || lsu0.cp.32       l23, i0
  nop
  bru.swp        i30
// l33 = sqrtf( l33 - l32*l32 )//
    sau.mul.f32   i2, i1 i1   || lsu0.cp.32      l32, i1
    nop 2
  ...
  // all done - return
  bru.jmp      i11
    lsu1.sti.64 v20.0, L w     || iau.add       i0,   L w
    lsu1.sti.64 v21.0, L w     || lsu0.sto.64 v21.1,  i0 8
    lsu1.sti.128    L2, L w     || lsu0.cp.32      l33, i18
    nop
    lsu1.st.128     L3, L
    nop
.else
...
.Lsqrtf:
  ...
  sau.add.f32   y, y i2
.ifdef ma2480
  lsu1.cp.32     nex, exp    || lsu0.ldil i2, .L.hlast
.else
