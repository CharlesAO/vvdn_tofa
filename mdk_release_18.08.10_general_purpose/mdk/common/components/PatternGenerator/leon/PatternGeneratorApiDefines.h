...
///
/// @defgroup PatternGeneratorApiDefines Pattern Generator API Defines
/// @ingroup  PatternGenerator
/// @{
/// @brief    Pattern Generator Defines
///
/// This file contains all the definitions of constants, typedefs,
/// structures, enums and exported variables for the Pattern Generator component
///
