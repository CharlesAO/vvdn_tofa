...
/*
 * The 'setjmp' and 'longjmp' functionality on the SHAVE
 * architecture is not surrently supported.
 */
#error 'setjmp' and 'longjmp' are not currently supported on the Movidius SHAVE CPU
#endif
