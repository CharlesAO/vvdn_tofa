 ...
 */
  ...
  #else
    // #define SPARC_USE_LAZY_FP_SWITCH - TODO:remove this until lazy_fp_switch is full testes
    #define SPARC_USE_SYNCHRONOUS_FP_SWITCH
  #endif
#endif
...
/* Myriad2 systems use L2 cache line size of 64 */
...
#define CPU_MAXIMUM_PROCESSORS 2
