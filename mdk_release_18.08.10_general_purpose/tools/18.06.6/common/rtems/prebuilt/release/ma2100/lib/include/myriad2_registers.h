...
// ----------------------------------------- End of Myriad 2, version 2 only --
...
//#define CSS_DSS_APB_PHY                (    32 ) // DEPRECATED, and incorrect, these two are switched. Please use the alternatives below.
