...
#define MOVIDEBUG_OPT_CACHE_AWARE "cacheAware"

#define MOVIDEBUG_OPT_NO_AUTO_DDR_INIT "no-auto-ddr-init"
...
MOVIDEBUG_DLLAPI int   DllMoviDebugParseString(const char *inputLine);
